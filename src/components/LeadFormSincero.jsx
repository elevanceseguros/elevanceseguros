      ...
      <AnimatePresence mode="wait">
        {!enviado ? (
          ...
          >
            <form onSubmit={handleSubmit} className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
              ...
              <div className="w-full md:w-auto md:min-w-[150px] text-center md:text-left mb-2 md:mb-0">
                <h3 className="text-[#0d1f3c] font-bold text-xl md:text-lg leading-tight">Cotação Rápida</h3>
              ...
              <div className="w-full md:w-auto pt-2 md:pt-4">
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full md:w-[180px] bg-[#0d1f3c] hover:bg-[#244b69] text-white font-bold h-[52px] md:h-[60px] rounded-xl md:rounded-2xl flex items-center justify-center gap-2 transition-all shadow-lg active:scale-95"
                >
                  {loading ? (
          ...
          >
            ...
            <h3 className="text-[#0d1f3c] text-xl font-bold">Solicitação Enviada!</h3>
