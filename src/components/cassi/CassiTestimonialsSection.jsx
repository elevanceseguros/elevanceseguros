...
const testimonials = [
  {
    ...
    text: "Estava apavorada com a ideia de não ter um bom suporte médico para meus filhos. A equipe da Cassi me atendeu em minutos e encontrou um plano perfeito para nosso orçamento. Hoje durmo tranquila!"
  },
  {
    name: "João Ferreira",
...
const CassiTestimonialsSection = () => {
  return (
...
export default CassiTestimonialsSection;