      ...
      return (
        <div style={{minHeight:'100vh',display:'flex',alignItems:'center',justifyContent:'center',padding:'16px',background:'#f8fafc'}}>
          <div style={{textAlign:'center',maxWidth:'400px'}}>
            ...
            <h2 style={{fontSize:'24px',fontWeight:'900',color:'#0d1f3c',marginBottom:'12px'}}>Algo deu errado</h2>
            <p style={{color:'#64748b',marginBottom:'24px',fontSize:'14px'}}>
              Ocorreu um erro nesta página. Tente recarregar ou volte ao início.
            </p>
            <div style={{display:'flex',flexDirection:'column',gap:'12px'}}>
              <button onClick={() => window.location.reload()}
                style={{background:'#0d1f3c',color:'white',padding:'12px 24px',borderRadius:'16px',border:'none',fontWeight:'900',cursor:'pointer',fontSize:'12px',textTransform:'uppercase'}}>
                Recarregar
              </button>
              <a href="/" style={{background:'#f1f5f9',color:'#0d1f3c',padding:'12px 24px',borderRadius:'16px',fontWeight:'900',fontSize:'12px',textTransform:'uppercase',textDecoration:'none'}}>
                Início
              </a>
