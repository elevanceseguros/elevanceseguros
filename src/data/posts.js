export const postsData = [
  {
    ...
    content: `
      ...
      <h2 class="text-[#114d8e] font-black mt-8 mb-4 text-2xl">1. O que é o Seguro Auto Tradicional?</h2>
      ...
      <h2 class="text-[#114d8e] font-black mt-8 mb-4 text-2xl">2. O que é a Proteção Veicular (APVS)?</h2>
      ...
      <h2 class="text-[#114d8e] font-black mt-8 mb-4 text-2xl">Conclusão: Qual escolher?</h2>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#114d8e] font-black mt-8 mb-4 text-2xl">Autônomo pode ter plano de saúde?</h2>
      ...
      <h2 class="text-[#114d8e] font-black mt-8 mb-4 text-2xl">Individual vs MEI: qual sai mais barato?</h2>
      ...
      <h2 class="text-[#114d8e] font-black mt-8 mb-4 text-2xl">O que considerar na hora de escolher?</h2>
      ...
      <h2 class="text-[#114d8e] font-black mt-8 mb-4 text-2xl">Quanto custa um plano para autônomo em SP?</h2>
      ...
      <h2 class="text-[#114d8e] font-black mt-8 mb-4 text-2xl">Como contratar?</h2>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#114d8e] font-black mt-8 mb-4 text-2xl">O que é coparticipação?</h2>
      ...
      <h2 class="text-[#114d8e] font-black mt-8 mb-4 text-2xl">Com coparticipação vs. sem coparticipação</h2>
      <div class="overflow-x-auto mb-6">
        <table class="w-full text-sm border-collapse">
          <thead>
            <tr class="bg-[#114d8e] text-white">
      ...
      <h2 class="text-[#114d8e] font-black mt-8 mb-4 text-2xl">Coparticipação em internações: cuidado!</h2>
      ...
      <h2 class="text-[#114d8e] font-black mt-8 mb-4 text-2xl">Como escolher?</h2>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#114d8e] font-black mt-8 mb-4 text-2xl">O que cobre um seguro de vida?</h2>
      <ul class="list-none space-y-3 mb-6">
      ...
      <h2 class="text-[#114d8e] font-black mt-8 mb-4 text-2xl">Quanto custa em 2026?</h2>
      ...
      <h2 class="text-[#114d8e] font-black mt-8 mb-4 text-2xl">Para quem vale a pena?</h2>
      <ul class="list-none space-y-3 mb-6">
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#114d8e] font-black mt-8 mb-4 text-2xl">Qual é o teto de reajuste em 2026?</h2>
      ...
      <h2 class="text-[#114d8e] font-black mt-8 mb-4 text-2xl">Por que os planos reajustam tanto?</h2>
      ...
      <h2 class="text-[#114d8e] font-black mt-8 mb-4 text-2xl">O que você pode fazer?</h2>
      <ul class="list-none space-y-3 mb-6">
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#114d8e] font-black mt-8 mb-4 text-2xl">Por que MEI tem acesso a planos empresariais?</h2>
      ...
      <h2 class="text-[#114d8e] font-black mt-8 mb-4 text-2xl">Qual a diferença na prática?</h2>
      <div class="overflow-x-auto mb-6">
        <table class="w-full text-sm border-collapse">
          <thead>
            <tr class="bg-[#114d8e] text-white">
      ...
      <h2 class="text-[#114d8e] font-black mt-8 mb-4 text-2xl">Quais operadoras aceitam MEI em SP?</h2>
