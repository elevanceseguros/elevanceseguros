export const postsData = [
  {
    ...
    title: "Seguro Auto ou Proteção Veicular: Qual a melhor escolha em 2026?",
    date: "23 Abr, 2026",
    ...
    content: `
      <p class="mb-4">Você já deve ter passado por isso: cotou o seguro do seu carro e o valor quase te derrubou da cadeira. Logo depois, apareceu uma oferta de "Proteção Veicular" pela metade do preço. A dúvida é imediata: "Vale a pena? É a mesma coisa?". Como consultor na Elevance Seguros, eu recebo essa pergunta todos os dias.</p>
      
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">1. O que é o Seguro Auto Tradicional?</h2>
      <p class="mb-4">O seguro é um contrato (apólice) garantido por uma Seguradora e fiscalizado pela <strong>SUSEP</strong> (Superintendência de Seguros Privados). É um produto financeiro sólido, ideal para quem busca segurança jurídica máxima e não quer correr o risco de "rateio" de prejuízos.</p>

      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">2. O que é a Proteção Veicular (APVS)?</h2>
      <p class="mb-4">Diferente do seguro, a proteção veicular funciona através de uma associação de ajuda mútua. Na Elevance, somos parceiros oficiais da <strong>APVS Brasil</strong>, a maior da América Latina. O custo é reduzido porque não há análise de perfil rigorosa (como a idade do condutor, que costuma encarecer o seguro tradicional).</p>

      <div class="my-10 bg-blue-50 p-8 rounded-3xl border border-blue-100 shadow-sm text-[#0d1f3c]">
        <h3 class="font-bold mb-2">Dica do Rodrigo:</h3>
        <p class="text-sm italic font-medium">A Proteção Veicular é uma excelente alternativa para carros que as seguradoras recusam (como modelos mais antigos ou modificados) ou para quem quer economizar sem abrir mão de assistência 24h completa.</p>
      </div>

      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Conclusão: Qual escolher?</h2>
      <p class="mb-4">Não existe uma resposta única. O <strong>Seguro Auto</strong> é um produto de alta garantia bancária. A <strong>Proteção Veicular</strong> é uma solução inteligente de economia compartilhada. Na Elevance, nós analisamos seu caso individualmente e indicamos o melhor caminho para o seu bolso.</p>
      
      <p class="mt-8 font-bold text-blue-600">Dúvida sobre qual cabe no seu bolso? Chame agora no WhatsApp e receba um comparativo real!</p>
    `
  }
  ,
  {
    id: 2,
    slug: "plano-de-saude-para-autonomo-sp",
    title: "Plano de Saúde para Autônomo em SP: Como Contratar Sem CNPJ em 2026",
    date: "24 Abr, 2026",
    category: "Planos de Saúde",
    readTime: "6 min",
    image: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&q=80&w=800",
    excerpt: "Ser autônomo não significa abrir mão de um bom plano de saúde. Veja as melhores opções para quem trabalha por conta própria em São Paulo.",
    content: `
      <p class="mb-4">Se você trabalha por conta própria, já sabe que um dos maiores desafios é ter acesso a um plano de saúde de qualidade sem depender de um empregador. A boa notícia é que existem ótimas opções — e eu, como corretor especializado aqui na Elevance Seguros, vou te mostrar o caminho mais inteligente.</p>

      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Autônomo pode ter plano de saúde?</h2>
      <p class="mb-4">Sim, com certeza. A ANS (Agência Nacional de Saúde Suplementar) regulamenta planos para pessoas físicas, mesmo sem vínculo empregatício. As opções disponíveis para autônomos em São Paulo são:</p>
      <ul class="list-none space-y-2 mb-6">
        <li class="flex items-start gap-2"><span class="text-blue-600 font-black mt-0.5">→</span><span><strong>Plano Individual/Familiar:</strong> contratado diretamente com a operadora. Hoje em dia, por determinação da ANS, as operadoras são obrigadas a aceitar qualquer pessoa — sem exigência de CNPJ.</span></li>
        <li class="flex items-start gap-2"><span class="text-blue-600 font-black mt-0.5">→</span><span><strong>Plano por Adesão:</strong> ligado a sindicatos ou associações profissionais. Pode ser uma opção com preços competitivos para categorias específicas.</span></li>
        <li class="flex items-start gap-2"><span class="text-blue-600 font-black mt-0.5">→</span><span><strong>Plano PME com MEI:</strong> se você tem um CNPJ MEI, já pode acessar planos empresariais, que costumam ter preços melhores que os individuais.</span></li>
      </ul>

      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Individual vs MEI: qual sai mais barato?</h2>
      <p class="mb-4">Na prática, planos PME com CNPJ MEI costumam sair <strong>20% a 40% mais baratos</strong> que planos individuais equivalentes — porque o risco é diluído entre mais pessoas. Se você ainda não tem MEI, pode valer a pena abrir só para acessar esses planos.</p>

      <div class="my-10 bg-blue-50 p-8 rounded-3xl border border-blue-100 shadow-sm text-[#0d1f3c]">
        <h3 class="font-bold mb-2">Dica do Rodrigo:</h3>
        <p class="text-sm italic font-medium">Operadoras como Amil, Bradesco Saúde e SulAmérica têm planos individuais robustos para SP. Já a Alice e a Sagrada Família têm opções muito competitivas para MEI/PME. O melhor caminho depende da sua idade, cidade e perfil de uso. Por isso vale uma cotação personalizada.</p>
      </div>

      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O que considerar na hora de escolher?</h2>
      <p class="mb-4">Antes de fechar qualquer plano, avalie:</p>
      <ul class="list-none space-y-2 mb-6">
        <li class="flex items-start gap-2"><span class="text-blue-600 font-black mt-0.5">1.</span><span><strong>Rede credenciada:</strong> os hospitais e clínicas da sua região estão cobertos?</span></li>
        <li class="flex items-start gap-2"><span class="text-blue-600 font-black mt-0.5">2.</span><span><strong>Coparticipação:</strong> você paga uma taxa por consulta ou é livre? Quem usa pouco o plano pode preferir coparticipação para pagar mensalidade menor.</span></li>
        <li class="flex items-start gap-2"><span class="text-blue-600 font-black mt-0.5">3.</span><span><strong>Carências:</strong> planos novos têm períodos de carência. Para cirurgias eletivas, pode chegar a 180 dias.</span></li>
        <li class="flex items-start gap-2"><span class="text-blue-600 font-black mt-0.5">4.</span><span><strong>Reajuste anual:</strong> pergunte o histórico de reajuste da operadora nos últimos 3 anos.</span></li>
      </ul>

      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Quanto custa um plano para autônomo em SP?</h2>
      <p class="mb-4">Em 2026, os valores variam bastante conforme a operadora, tipo de acomodação (enfermaria ou apartamento) e coparticipação:</p>
        ...
        <table class="w-full text-sm border-collapse">
          <thead>
            <tr class="bg-[#0d1f3c] text-white">
              ...
              <th class="p-3 text-left rounded-tr-xl">Faixa de preço/mês</th>
            </tr>
          </thead>
          <tbody>
            <tr class="bg-slate-50 border-b border-slate-100">
              <td class="p-3 font-medium">25 anos</td>
              <td class="p-3">Individual enfermaria</td>
              <td class="p-3 font-bold text-blue-600">R$ 180 – R$ 380</td>
            </tr>
            <tr class="bg-white border-b border-slate-100">
              <td class="p-3 font-medium">35 anos</td>
              <td class="p-3">Individual apartamento</td>
              <td class="p-3 font-bold text-blue-600">R$ 320 – R$ 620</td>
            </tr>
            <tr class="bg-slate-50 border-b border-slate-100">
              <td class="p-3 font-medium">45 anos</td>
              <td class="p-3">Individual apartamento</td>
              <td class="p-3 font-bold text-blue-600">R$ 480 – R$ 950</td>
            </tr>
            <tr class="bg-white">
              <td class="p-3 font-medium">MEI</td>
              <td class="p-3">PME enfermaria</td>
              <td class="p-3 font-bold text-blue-600">R$ 150 – R$ 300</td>
            </tr>
          </tbody>
        </table>
      </div>
      <p class="text-xs text-slate-400 italic mb-6">*Valores aproximados para São Paulo em 2026. Sujeitos a variação por operadora e perfil.</p>

      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Como contratar?</h2>
      <p class="mb-4">O processo é simples: você me passa seu perfil (idade, cidade, se tem MEI ou não, e quanto quer investir por mês), eu faço uma comparação entre as operadoras disponíveis para o seu caso e apresento as melhores opções. Sem burocracia, sem custo de consultoria.</p>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Com coparticipação vs. sem coparticipação</h2>
      <div class="overflow-x-auto mb-6">
        <table class="w-full text-sm border-collapse">
          <thead>
            <tr class="bg-[#0d1f3c] text-white">
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Coparticipação em internações: cuidado!</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Como escolher?</h2>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O que cobre um seguro de vida?</h2>
      <ul class="list-none space-y-3 mb-6">
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Quanto custa em 2026?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Para quem vale a pena?</h2>
      <ul class="list-none space-y-3 mb-6">
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Qual é o teto de reajuste em 2026?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Por que os planos reajustam tanto?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O que você pode fazer?</h2>
      <ul class="list-none space-y-3 mb-6">
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Por que MEI tem acesso a planos empresariais?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Qual a diferença na prática?</h2>
      <div class="overflow-x-auto mb-6">
        <table class="w-full text-sm border-collapse">
          <thead>
            <tr class="bg-[#0d1f3c] text-white">
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Quais operadoras aceitam MEI em SP?</h2>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O que é franquia no seguro auto?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Tipos de franquia</h2>
      <ul class="list-none space-y-3 mb-6">
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Franquia reduzida vale a pena?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Franquia em roubo e furto</h2>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Como funciona cada um?</h2>
      <ul class="list-none space-y-3 mb-6">
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Comparativo real: imóvel de R$ 400.000</h2>
      <div class="overflow-x-auto mb-6">
        <table class="w-full text-sm border-collapse">
          <thead>
            <tr class="bg-[#0d1f3c] text-white">
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Quando escolher financiamento?</h2>
      <ul class="list-none space-y-2 mb-6">
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Quando escolher consórcio?</h2>
      <ul class="list-none space-y-2 mb-6">
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O que é seguro residencial?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O que o seguro residencial cobre?</h2>
      <ul class="list-none space-y-3 mb-6">
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Quanto custa o seguro residencial em 2026?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Seguro residencial para quem mora de aluguel</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Assistência 24h: o benefício mais subestimado</h2>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O que é o Seguro D&O?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O que o D&O cobre?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Quem precisa contratar o D&O?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">D&O x RC Profissional: qual a diferença?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Como contratar o D&O?</h2>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O que é portabilidade de plano de saúde?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Quais são as regras para fazer a portabilidade?</h2>
      <ul class="mb-6 space-y-3 list-none">
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Portabilidade especial: quando o reajuste é abusivo</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O que NÃO é portabilidade</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Como a Elevance pode ajudar</h2>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O que é plano individual?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O que é plano familiar?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Comparativo direto</h2>
      <div class="overflow-x-auto mb-6">
        <table class="w-full text-sm border-collapse">
          <thead>
            <tr class="bg-[#0d1f3c] text-white">
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">E os dependentes? Há limite de idade?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Quando o plano individual ainda vale a pena?</h2>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O que é consórcio de imóvel?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Passo a passo: como funciona na prática</h2>
      <ul class="mb-6 space-y-4 list-none">
        <li class="flex items-start gap-3"><span class="bg-[#0d1f3c] text-white font-black text-xs rounded-full w-6 h-6 flex items-center justify-center shrink-0 mt-0.5">1</span><span><strong>Escolha do plano:</strong> você define o valor da carta de crédito (ex: R$ 300.000), o prazo (ex: 200 meses) e a administradora. Isso determina o valor da sua parcela mensal.</span></li>
        <li class="flex items-start gap-3"><span class="bg-[#0d1f3c] text-white font-black text-xs rounded-full w-6 h-6 flex items-center justify-center shrink-0 mt-0.5">2</span><span><strong>Pagamento das parcelas:</strong> você passa a pagar mensalmente. Esse valor compõe o fundo comum do grupo, que é usado para contemplar os participantes.</span></li>
        <li class="flex items-start gap-3"><span class="bg-[#0d1f3c] text-white font-black text-xs rounded-full w-6 h-6 flex items-center justify-center shrink-0 mt-0.5">3</span><span><strong>Contemplação por sorteio:</strong> todo mês, a administradora realiza sorteios entre todos os participantes adimplentes. Quem é sorteado recebe a carta de crédito.</span></li>
        <li class="flex items-start gap-3"><span class="bg-[#0d1f3c] text-white font-black text-xs rounded-full w-6 h-6 flex items-center justify-center shrink-0 mt-0.5">4</span><span><strong>Contemplação por lance:</strong> você pode oferecer um lance — um valor adicional — para antecipar sua contemplação. Quem oferece o maior lance percentual é contemplado.</span></li>
        <li class="flex items-start gap-3"><span class="bg-[#0d1f3c] text-white font-black text-xs rounded-full w-6 h-6 flex items-center justify-center shrink-0 mt-0.5">5</span><span><strong>Uso da carta de crédito:</strong> ao ser contemplado, você recebe a carta e pode usá-la para comprar o imóvel que quiser — novo, usado, terreno ou até reformar.</span></li>
      </ul>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Posso usar o FGTS no consórcio?</h2>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">A realidade do autônomo sem proteção</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O que o seguro de vida cobre para autônomos?</h2>
      <ul class="mb-6 space-y-3 list-none">
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Seguro de vida é dedutível do Imposto de Renda?</h2>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O que é DIH?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O que é DIT?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Existe limite para DIT e DIH?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Como saber se meu plano tem DIT e DIH?</h2>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">1. Defina o que você precisa cobrir</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">2. Entenda as coberturas disponíveis</h2>
      <ul class="mb-6 space-y-3 list-none">
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">3. Franquia: menor nem sempre é melhor</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Seguro auto vs proteção veicular: qual escolher?</h2>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O que é seguro garantia?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Seguro garantia é obrigatório?</h2>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">A ANS proíbe recusa por idade</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Carências para idosos: o que muda?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Vale incluir como dependente no plano dos filhos?</h2>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O que é o SPVAT?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O que o SPVAT cobre?</h2>
      <ul class="mb-6 space-y-3 list-none">
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Como acionar o SPVAT?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">SPVAT substitui o seguro auto?</h2>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Como funciona o consórcio de veículo?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Consórcio vs financiamento: a diferença real</h2>
      <div class="overflow-x-auto mb-6">
        <table class="w-full text-sm border-collapse">
          <thead>
            <tr class="bg-[#0d1f3c] text-white">
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Simulação prática: carro de R$ 80.000</h2>
      <div class="overflow-x-auto mb-6">
        <table class="w-full text-sm border-collapse">
          <thead>
            <tr class="bg-[#0d1f3c] text-white">
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Posso usar o FGTS no consórcio de veículo?</h2>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O que é consórcio de serviços?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Para quais serviços posso usar?</h2>
      <ul class="mb-6 space-y-3 list-none">
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Como funciona o pagamento ao prestador?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Consórcio de serviços vale a pena?</h2>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O que é um lance no consórcio?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Tipos de lance</h2>
      <ul class="mb-6 space-y-4 list-none">
        <li class="flex items-start gap-3"><span class="bg-[#0d1f3c] text-white font-black text-xs rounded-full w-6 h-6 flex items-center justify-center shrink-0 mt-0.5">1</span><span><strong>Lance livre:</strong> você oferta qualquer percentual com recursos próprios. O maior percentual vence. É o tipo mais comum.</span></li>
        <li class="flex items-start gap-3"><span class="bg-[#0d1f3c] text-white font-black text-xs rounded-full w-6 h-6 flex items-center justify-center shrink-0 mt-0.5">2</span><span><strong>Lance embutido:</strong> você usa parte da própria carta de crédito como lance. Não precisa ter o dinheiro em mãos — mas recebe um crédito menor. Exemplo: carta de R$ 300.000, lance embutido de R$ 60.000, você recebe R$ 240.000.</span></li>
        <li class="flex items-start gap-3"><span class="bg-[#0d1f3c] text-white font-black text-xs rounded-full w-6 h-6 flex items-center justify-center shrink-0 mt-0.5">3</span><span><strong>Lance fixo:</strong> a administradora define um percentual fixo (ex: 25%) e sorteia entre todos que ofertaram aquele valor.</span></li>
        <li class="flex items-start gap-3"><span class="bg-[#0d1f3c] text-white font-black text-xs rounded-full w-6 h-6 flex items-center justify-center shrink-0 mt-0.5">4</span><span><strong>Lance com FGTS:</strong> exclusivo para consórcios imobiliários. Você usa o saldo do FGTS como lance, sem desembolso próprio.</span></li>
      </ul>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Quanto dar de lance para ser contemplado?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O lance não venceu. E o dinheiro?</h2>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O que o seguro viagem cobre?</h2>
      <ul class="mb-6 space-y-3 list-none">
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Quando o seguro viagem é obrigatório?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Meu cartão de crédito já inclui seguro viagem — preciso contratar?</h2>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Opção 1 — Plano Individual</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Opção 2 — Plano Coletivo por Adesão</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Opção 3 — Plano PME pelo MEI</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">E se eu for autônomo sem MEI?</h2>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Quem pode ser dependente no plano de saúde?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Plano individual vs. plano familiar: qual é mais barato?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Como funciona a carência para dependentes incluídos depois?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Filho universitário perde o plano aos 21 anos?</h2>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O que é a DPS?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O que acontece se eu omitir informações?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">A seguradora pode investigar minha saúde após o sinistro?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">E doenças que descobri após contratar o seguro?</h2>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Por que o seguro tradicional não cobre motoristas de app?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O que as plataformas cobrem?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Quais seguros aceitam motoristas de aplicativo?</h2>
      <ul class="mb-6 space-y-3 list-none">
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">E o carro financiado pode fazer seguro para app?</h2>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">O que acontece imediatamente após a contemplação?</h2>
      <ol class="mb-6 space-y-4 list-none">
        <li class="flex items-start gap-3"><span class="bg-[#0d1f3c] text-white font-black text-xs rounded-full w-6 h-6 flex items-center justify-center shrink-0 mt-0.5">1</span><span><strong>Comunicação oficial:</strong> a administradora envia carta ou e-mail confirmando a contemplação e solicitando documentos.</span></li>
        <li class="flex items-start gap-3"><span class="bg-[#0d1f3c] text-white font-black text-xs rounded-full w-6 h-6 flex items-center justify-center shrink-0 mt-0.5">2</span><span><strong>Análise de crédito:</strong> mesmo sendo consórcio, a administradora faz análise cadastral. Restrições no CPF podem travar a liberação.</span></li>
        <li class="flex items-start gap-3"><span class="bg-[#0d1f3c] text-white font-black text-xs rounded-full w-6 h-6 flex items-center justify-center shrink-0 mt-0.5">3</span><span><strong>Oferta de bem:</strong> você indica o imóvel, veículo ou serviço que deseja adquirir.</span></li>
        <li class="flex items-start gap-3"><span class="bg-[#0d1f3c] text-white font-black text-xs rounded-full w-6 h-6 flex items-center justify-center shrink-0 mt-0.5">4</span><span><strong>Avaliação e liberação:</strong> a administradora avalia o bem escolhido e libera a carta diretamente ao vendedor.</span></li>
      </ol>

      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Quanto tempo tenho para usar a carta de crédito?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Posso escolher qualquer imóvel ou veículo?</h2>
      ...
      <h2 class="text-[#0d1f3c] font-black mt-8 mb-4 text-2xl">Posso usar o FGTS junto com a carta de consórcio imobiliário?</h2>
  ...
  {
    id: 115,
    slug: "seguro-clinica-odontologica-empresarial-rc-profissional",
    title: "Seguro para Clínica Odontológica: Empresarial ou RC Profissional?",
    date: "14 Ago, 2026",
    category: "Seguro Empresarial",
    readTime: "11 min",
    image: "https://images.unsplash.com/photo-1606811971618-4486d14f3f99?auto=format&fit=crop&q=80&w=800",
    excerpt: "Entenda por que patrimônio, equipamentos, paralisação e responsabilidade profissional exigem coberturas diferentes.",
    content: "\n      <p class=\"mb-4\">Uma clínica odontológica reúne pelo menos dois grupos de risco: o patrimônio usado para funcionar e a responsabilidade ligada ao atendimento profissional. Por isso, contratar apenas um seguro empresarial ou somente responsabilidade civil profissional pode deixar uma parte importante da operação sem a proteção esperada.</p>\n\n      <p class=\"mb-4\">A comparação correta começa separando consultório, equipamentos e paralisação de eventuais reclamações relacionadas a procedimentos. Depois, é preciso verificar limites, franquias, exclusões e quem efetivamente aparece como segurado.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Seguro empresarial ou RC profissional?</h2>\n      <div class=\"overflow-x-auto mb-6\">\n        <table class=\"w-full border-collapse text-sm\">\n          <thead><tr class=\"bg-slate-100\"><th class=\"border border-slate-200 p-3 text-left\">Situação</th><th class=\"border border-slate-200 p-3 text-left\">Seguro empresarial</th><th class=\"border border-slate-200 p-3 text-left\">RC profissional</th></tr></thead>\n          <tbody>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Incêndio no consultório</td><td class=\"border border-slate-200 p-3\">Pode proteger imóvel, instalações e conteúdo declarado</td><td class=\"border border-slate-200 p-3\">Não é sua finalidade principal</td></tr>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Equipamento danificado</td><td class=\"border border-slate-200 p-3\">Pode haver cobertura compatível, conforme evento e contratação</td><td class=\"border border-slate-200 p-3\">Não substitui cobertura patrimonial</td></tr>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Reclamação de paciente</td><td class=\"border border-slate-200 p-3\">RC operacional pode não alcançar o ato odontológico</td><td class=\"border border-slate-200 p-3\">Pode abranger reclamações profissionais cobertas e custos previstos</td></tr>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Queda na recepção</td><td class=\"border border-slate-200 p-3\">Pode ser tratada pela RC da operação, se contratada</td><td class=\"border border-slate-200 p-3\">Depende do escopo; não deve ser presumida</td></tr>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Clínica temporariamente fechada</td><td class=\"border border-slate-200 p-3\">Lucros cessantes pode ser relevante após evento coberto</td><td class=\"border border-slate-200 p-3\">Não protege automaticamente a paralisação patrimonial</td></tr>\n          </tbody>\n        </table>\n      </div>\n\n      <p class=\"mb-4\">Na prática, as duas proteções são complementares. O seguro empresarial olha para a estrutura e a continuidade do negócio; a responsabilidade civil profissional considera reclamações decorrentes da atividade técnica, dentro das condições contratadas.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">O que avaliar no patrimônio da clínica</h2>\n      <p class=\"mb-4\">Cadeiras odontológicas, autoclaves, compressores, aparelhos de raio X, scanners, computadores e sistemas de climatização podem representar uma parcela relevante do investimento. A proposta deve informar tipo de equipamento, valores, local de uso e características do imóvel.</p>\n\n      <p class=\"mb-4\">Incêndio costuma integrar a cobertura básica dos seguros compreensivos, mas danos elétricos, subtração de bens, quebra de vidros, vendaval, vazamento e equipamentos eletrônicos podem depender de coberturas adicionais. Desgaste, manutenção inadequada e defeito interno não devem ser confundidos com sinistro coberto.</p>\n\n      <div class=\"bg-blue-50 border-l-4 border-blue-500 p-5 my-6 rounded-r-xl\">\n        <p class=\"font-bold text-[#0d1f3c] mb-2\">Equipamento financiado ou alugado exige atenção</p>\n        <p class=\"text-slate-700\">Confirme interesse segurável, propriedade, cláusulas do contrato e forma de indenização. Declarar apenas o valor contábil pode não refletir o custo real de reposição.</p>\n      </div>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">RC operacional não é igual a RC profissional</h2>\n      <p class=\"mb-4\">Uma pessoa pode escorregar na recepção sem que exista erro odontológico. Em outro cenário, um paciente pode alegar dano ligado a diagnóstico, procedimento ou orientação. São naturezas diferentes de reclamação e podem exigir coberturas distintas.</p>\n\n      <p class=\"mb-4\">Na responsabilidade civil profissional, confira quais atividades e especialidades estão declaradas, período de cobertura, data retroativa quando aplicável, território, custos de defesa, acordos e limites agregados. O seguro não elimina o dever de prontuário, consentimento e protocolos profissionais.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">A apólice deve estar no nome da clínica ou do dentista?</h2>\n      <p class=\"mb-4\">Isso depende da estrutura. Uma clínica pode ter CNPJ, sócios, dentistas empregados e profissionais parceiros. A proposta precisa identificar quem presta o serviço e quem pode ser responsabilizado. Presumir que uma apólice individual protege automaticamente a pessoa jurídica — ou o contrário — cria uma lacuna perigosa.</p>\n\n      <p class=\"mb-4\">Informe vínculo dos profissionais, especialidades realizadas e uso compartilhado da estrutura. Quando necessário, compare proteção para a empresa e para os responsáveis técnicos ou prestadores.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Implantes, cirurgias e procedimentos estéticos</h2>\n      <p class=\"mb-4\">Atividades de maior complexidade devem ser declaradas com precisão. Aceitação, franquia, limites e exclusões podem variar conforme especialidade e procedimento. O nome genérico “clínica odontológica” não substitui a descrição do risco.</p>\n\n      <p class=\"mb-4\">Também é importante informar sedação, exames de imagem, laboratório próprio, estoque de materiais, atendimento infantil e qualquer atividade complementar oferecida no local.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Lucros cessantes: quando pode ajudar?</h2>\n      <p class=\"mb-4\">Se um evento patrimonial coberto impedir o funcionamento, a cobertura de lucros cessantes pode ajudar com perdas financeiras previstas na apólice durante o período de interrupção. Ela normalmente depende da ocorrência de um dano material coberto e de documentação contábil.</p>\n\n      <p class=\"mb-4\">Por isso, compare período indenitário, carência, despesas fixas consideradas e forma de comprovação. Uma clínica dependente de equipamentos específicos pode precisar de prazo maior para reposição e retomada.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para pedir propostas comparáveis</h2>\n      <ol class=\"list-decimal pl-6 mb-6 space-y-2\">\n        <li>Informe área, tipo de imóvel, localização e medidas de segurança.</li>\n        <li>Faça inventário de equipamentos, móveis e eletrônicos com valores atualizados.</li>\n        <li>Descreva especialidades, procedimentos e faturamento da clínica.</li>\n        <li>Liste sócios, responsáveis técnicos, empregados e profissionais parceiros.</li>\n        <li>Compare RC operacional e profissional sem tratar uma como substituta da outra.</li>\n        <li>Revise franquias, limites por cobertura, exclusões e custos de defesa.</li>\n        <li>Guarde notas, contratos, laudos de manutenção e registros profissionais.</li>\n      </ol>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Qual combinação faz sentido?</h2>\n      <p class=\"mb-4\">Uma clínica pequena pode precisar de limites diferentes de uma operação com várias cadeiras, imagem e múltiplas especialidades. A solução costuma começar pelo seguro empresarial compatível com o patrimônio e ser complementada pelas responsabilidades operacional e profissional adequadas ao modelo de atendimento.</p>\n\n      <p class=\"mb-4\">O objetivo não é contratar o maior número de coberturas, mas fazer cada risco relevante encontrar uma resposta contratual clara.</p>\n\n      <div class=\"bg-[#0d1f3c] text-white p-7 rounded-2xl mt-8\">\n        <h3 class=\"text-xl font-black mb-3\">Quer comparar o seguro da sua clínica odontológica?</h3>\n        <p class=\"mb-5 text-slate-200\">A Elevance organiza patrimônio, equipamentos, atividades e responsabilidades para buscar propostas comparáveis, sem misturar coberturas diferentes.</p>\n        <a href=\"https://wa.me/5511920144864?text=Olá%2C%20quero%20cotar%20seguro%20para%20minha%20clínica%20odontológica\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#22c55e] hover:bg-[#16a34a] text-white font-black px-6 py-3 rounded-xl transition-colors\">Solicitar cotação no WhatsApp</a>\n      </div>\n\n      <p class=\"text-xs text-slate-500 mt-6\">Conteúdo informativo. Coberturas, atividades aceitas, limites, franquias, período de cobertura, exclusões e critérios de indenização variam conforme seguradora e condições contratuais.</p>"
  },

  {
    id: 116,
    slug: "seguro-residencial-vazamento-vizinho-rc-familiar",
    title: "Seguro Residencial Cobre Vazamento no Vizinho? Entenda a RC Familiar",
    date: "15 Ago, 2026",
    category: "Seguro Residencial",
    readTime: "10 min",
    image: "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?auto=format&fit=crop&q=80&w=800",
    excerpt: "Veja a diferença entre danos no próprio imóvel, reparo da tubulação e prejuízos causados ao apartamento vizinho.",
    content: "\n      <p class=\"mb-4\">Um vazamento começa no seu apartamento, atravessa a laje e mancha o teto do vizinho. A primeira dúvida costuma ser “quem paga?”. A segunda deveria ser “qual cobertura foi contratada?”. O seguro residencial pode reunir proteções diferentes para o seu imóvel e para danos involuntários causados a terceiros.</p>\n\n      <p class=\"mb-4\">Danos por água, ruptura de tubulação e responsabilidade civil familiar não são sinônimos. Cada cobertura tem evento, limite, franquia e exclusões próprios. Entender essa separação evita descobrir a lacuna somente depois que o vizinho apresenta o orçamento.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">O seguro residencial paga o prejuízo do vizinho?</h2>\n      <p class=\"mb-4\">Pode pagar quando a apólice inclui responsabilidade civil familiar compatível e a reclamação decorre de um evento involuntário coberto. A cobertura normalmente analisa a responsabilidade do segurado e os danos materiais ou corporais reclamados por terceiros, respeitando o contrato.</p>\n\n      <p class=\"mb-4\">Isso não significa que qualquer infiltração será indenizada. Origem, causa, manutenção, momento em que o problema foi percebido e medidas tomadas para reduzir o dano fazem diferença na regulação.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Três prejuízos que não devem ser misturados</h2>\n      <div class=\"overflow-x-auto mb-6\">\n        <table class=\"w-full border-collapse text-sm\">\n          <thead><tr class=\"bg-slate-100\"><th class=\"border border-slate-200 p-3 text-left\">Prejuízo</th><th class=\"border border-slate-200 p-3 text-left\">Cobertura a verificar</th><th class=\"border border-slate-200 p-3 text-left\">Exemplo</th></tr></thead>\n          <tbody>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Dano no seu apartamento</td><td class=\"border border-slate-200 p-3\">Danos por água ou cobertura patrimonial específica</td><td class=\"border border-slate-200 p-3\">Piso, armário ou parede atingidos</td></tr>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Reparo da origem</td><td class=\"border border-slate-200 p-3\">Depende expressamente da assistência ou cobertura</td><td class=\"border border-slate-200 p-3\">Tubulação, conexão ou equipamento que vazou</td></tr>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Dano ao vizinho</td><td class=\"border border-slate-200 p-3\">Responsabilidade civil familiar</td><td class=\"border border-slate-200 p-3\">Teto, pintura, móveis ou eletrônicos de terceiro</td></tr>\n          </tbody>\n        </table>\n      </div>\n\n      <p class=\"mb-4\">Uma apólice pode conter uma dessas respostas e não as outras. Por isso, “tenho seguro residencial” não basta: é necessário conferir as coberturas e os limites efetivamente contratados.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Vazamento, infiltração e alagamento são iguais?</h2>\n      <p class=\"mb-4\">Não. Vazamento pode estar ligado a tubulação ou equipamento; infiltração costuma envolver passagem gradual de água; alagamento pode decorrer de água externa acumulada. Os contratos podem tratar cada evento de maneira diferente.</p>\n\n      <p class=\"mb-4\">Problemas graduais, desgaste, falta de conservação, impermeabilização deficiente e vícios construtivos frequentemente recebem tratamento distinto de uma ruptura súbita e acidental. A causa precisa ser apurada, não presumida.</p>\n\n      <div class=\"bg-blue-50 border-l-4 border-blue-500 p-5 my-6 rounded-r-xl\">\n        <p class=\"font-bold text-[#0d1f3c] mb-2\">Assistência 24 horas não é indenização</p>\n        <p class=\"text-slate-700\">O envio de encanador pode ajudar a localizar ou conter o problema, mas não significa automaticamente que todos os danos serão pagos. Assistência, cobertura patrimonial e responsabilidade civil têm regras próprias.</p>\n      </div>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">E quando a tubulação é do condomínio?</h2>\n      <p class=\"mb-4\">A responsabilidade pode mudar conforme a origem esteja em uma prumada comum, em ramal da unidade ou em equipamento particular. Condomínio, proprietário, inquilino e prestador também podem discutir quem tinha dever de manutenção.</p>\n\n      <p class=\"mb-4\">Comunique o síndico e registre o local da origem antes de iniciar obras extensas, quando for seguro aguardar. O seguro condominial e o residencial não devem ser tratados como substitutos automáticos; cada um protege interesses e responsabilidades definidos.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Inquilino ou proprietário: quem aciona o seguro?</h2>\n      <p class=\"mb-4\">Depende da causa e de quem pode ser responsabilizado. O inquilino pode ter responsabilidade por um evento ligado ao uso ou a um equipamento próprio; o proprietário pode responder por questões estruturais; o condomínio pode estar envolvido quando a origem é comum.</p>\n\n      <p class=\"mb-4\">A apólice deve identificar corretamente segurado, imóvel, ocupação e interesse protegido. Um seguro contratado pelo proprietário para a estrutura não protege automaticamente os bens do inquilino nem toda responsabilidade de quem mora no local.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">O que fazer assim que perceber o vazamento</h2>\n      <ol class=\"list-decimal pl-6 mb-6 space-y-2\">\n        <li>Se for possível e seguro, interrompa a água e reduza o agravamento.</li>\n        <li>Avise o vizinho, o síndico ou a administradora imediatamente.</li>\n        <li>Fotografe origem, áreas afetadas e evolução do dano.</li>\n        <li>Guarde mensagens, laudos, notas, orçamentos e dados dos envolvidos.</li>\n        <li>Comunique a seguradora ou corretora antes de reconhecer responsabilidade ou fechar acordo.</li>\n        <li>Siga as orientações para vistoria e reparos emergenciais.</li>\n      </ol>\n\n      <p class=\"mb-4\">Não deixe o dano aumentar esperando autorização quando houver risco à segurança. Ao mesmo tempo, preserve evidências e comprovantes para que a causa e os prejuízos possam ser analisados.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quanto contratar de responsabilidade civil?</h2>\n      <p class=\"mb-4\">Considere o padrão do prédio, unidades vizinhas, móveis, eletrônicos e possibilidade de o evento atingir mais de um apartamento. Um limite simbólico pode se esgotar rapidamente em imóveis de maior padrão ou quando há danos sucessivos.</p>\n\n      <p class=\"mb-4\">Compare também franquia, danos materiais e corporais, composição familiar, empregados domésticos, imóveis cobertos e exclusões. O menor prêmio não é necessariamente a proposta mais econômica quando os limites são muito diferentes.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist antes de contratar ou renovar</h2>\n      <ul class=\"list-disc pl-6 mb-6 space-y-2\">\n        <li>Responsabilidade civil familiar aparece expressamente?</li>\n        <li>Qual é o limite para danos materiais a terceiros?</li>\n        <li>Danos por água no próprio imóvel estão contratados?</li>\n        <li>Há franquia e quais causas estão excluídas?</li>\n        <li>A assistência inclui encanador e quais serviços ou materiais ficam de fora?</li>\n        <li>Proprietário, inquilino e endereço estão corretamente informados?</li>\n      </ul>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Conclusão</h2>\n      <p class=\"mb-4\">O seguro residencial pode ajudar quando um vazamento causa prejuízo ao vizinho, mas a resposta costuma estar na responsabilidade civil familiar — não apenas na cobertura básica do imóvel. Origem, responsabilidade, manutenção e limites precisam ser analisados.</p>\n\n      <div class=\"bg-[#0d1f3c] text-white p-7 rounded-2xl mt-8\">\n        <h3 class=\"text-xl font-black mb-3\">Seu seguro cobre danos causados ao vizinho?</h3>\n        <p class=\"mb-5 text-slate-200\">A Elevance compara responsabilidade civil, danos por água, assistências, limites e franquias para montar uma proteção residencial coerente com o seu imóvel.</p>\n        <a href=\"https://wa.me/5511920144864?text=Olá%2C%20quero%20comparar%20seguro%20residencial%20com%20responsabilidade%20civil\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#22c55e] hover:bg-[#16a34a] text-white font-black px-6 py-3 rounded-xl transition-colors\">Solicitar cotação no WhatsApp</a>\n      </div>\n\n      <p class=\"text-xs text-slate-500 mt-6\">Conteúdo informativo. Coberturas, assistências, limites, franquias, exclusões, responsabilidades e critérios de indenização variam conforme seguradora, causa do evento e condições contratuais.</p>"
  },

  {
    id: 117,
    slug: "seguro-de-vida-entra-inventario-beneficiarios",
    title: "Seguro de Vida Entra no Inventário? Beneficiários, Herdeiros e Pagamento",
    date: "16 Ago, 2026",
    category: "Seguro de Vida",
    readTime: "11 min",
    image: "https://images.unsplash.com/photo-1511895426328-dc8714191300?auto=format&fit=crop&q=80&w=800",
    excerpt: "Entenda por que o capital por morte não é considerado herança, quem pode ser beneficiário e como evitar problemas no pagamento.",
    content: "\n      <p class=\"mb-4\">Seguro de vida entra no inventário? Em regra, o capital segurado devido por morte não é considerado herança. A Lei nº 15.040/2024, que disciplina os contratos de seguro, estabelece isso expressamente e também permite a livre indicação de beneficiários.</p>\n\n      <p class=\"mb-4\">Essa característica torna o seguro de vida uma ferramenta útil de proteção familiar, mas não dispensa planejamento. Beneficiários desatualizados, dados incompletos, capital insuficiente ou coberturas mal escolhidas podem dificultar justamente o momento em que a família precisa de liquidez.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Seguro de vida entra no inventário?</h2>\n      <p class=\"mb-4\">O artigo 116 da Lei nº 15.040/2024 determina que o capital segurado devido em razão de morte não é considerado herança para nenhum efeito. Portanto, quando existe cobertura válida e sinistro coberto, o pagamento segue as regras do contrato e da indicação de beneficiários, sem se confundir com a partilha dos bens deixados.</p>\n\n      <p class=\"mb-4\">Isso não significa pagamento instantâneo ou automático. A seguradora precisa receber o aviso, os documentos e as informações necessárias para regular e liquidar o sinistro. Divergências cadastrais ou dúvidas sobre a indicação podem exigir análise adicional.</p>\n\n      <div class=\"bg-blue-50 border-l-4 border-blue-500 p-5 my-6 rounded-r-xl\">\n        <p class=\"font-bold text-[#0d1f3c] mb-2\">Seguro de vida não substitui planejamento sucessório</p>\n        <p class=\"text-slate-700\">Ele pode fornecer capital diretamente conforme as regras securitárias, mas imóveis, participações empresariais, dívidas, testamento e demais bens continuam exigindo organização própria.</p>\n      </div>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quem pode ser beneficiário?</h2>\n      <p class=\"mb-4\">A legislação permite a livre indicação de beneficiário nos seguros sobre a vida e a integridade física. É possível indicar uma ou mais pessoas e definir percentuais, respeitando as regras aplicáveis e a aceitação cadastral da seguradora.</p>\n\n      <p class=\"mb-4\">Beneficiário não precisa ser necessariamente herdeiro. Por isso, a indicação deve refletir a intenção real do segurado e ser revisada após casamento, separação, nascimento de filhos, falecimento de pessoa indicada ou mudança relevante na família.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">O que acontece se não houver beneficiário indicado?</h2>\n      <p class=\"mb-4\">Na falta de indicação válida, a Lei nº 15.040/2024 prevê que o capital seja pago por metade ao cônjuge, se houver, e o restante aos demais herdeiros do segurado. A lei também trata da situação de companheiro quando há separação, ainda que de fato, e de outras hipóteses excepcionais.</p>\n\n      <p class=\"mb-4\">Não indicar beneficiários pode gerar necessidade de documentos adicionais para comprovar quem tem direito. Uma designação clara e atualizada costuma reduzir incertezas, embora a seguradora sempre aplique a legislação e o contrato ao caso concreto.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Seguro de vida, previdência e seguro prestamista são iguais?</h2>\n      <div class=\"overflow-x-auto mb-6\">\n        <table class=\"w-full border-collapse text-sm\">\n          <thead><tr class=\"bg-slate-100\"><th class=\"border border-slate-200 p-3 text-left\">Produto</th><th class=\"border border-slate-200 p-3 text-left\">Objetivo principal</th><th class=\"border border-slate-200 p-3 text-left\">Ponto de atenção</th></tr></thead>\n          <tbody>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Seguro de vida</td><td class=\"border border-slate-200 p-3\">Pagar capital nas coberturas contratadas</td><td class=\"border border-slate-200 p-3\">Capital, beneficiários, vigência e exclusões</td></tr>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Previdência com risco de morte</td><td class=\"border border-slate-200 p-3\">Combinar características previdenciárias e garantias específicas</td><td class=\"border border-slate-200 p-3\">Plano, regime tributário, resgate e beneficiários</td></tr>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Seguro prestamista</td><td class=\"border border-slate-200 p-3\">Quitar ou amortizar dívida vinculada, conforme cobertura</td><td class=\"border border-slate-200 p-3\">Credor beneficiário, saldo e riscos cobertos</td></tr>\n          </tbody>\n        </table>\n      </div>\n\n      <p class=\"mb-4\">O prestamista protege uma obrigação financeira específica e não substitui necessariamente o capital que a família precisará para moradia, renda, educação ou reorganização da vida.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">A indenização pode ser usada para qualquer finalidade?</h2>\n      <p class=\"mb-4\">Quando o capital é pago ao beneficiário em seguro de vida, a destinação normalmente não fica vinculada a uma despesa específica. Isso é diferente do seguro prestamista, estruturado para uma dívida ou compromisso determinado.</p>\n\n      <p class=\"mb-4\">Na prática, famílias podem precisar do valor para despesas imediatas, manutenção da renda, educação, aluguel, financiamento ou reorganização patrimonial. O dimensionamento deve olhar para essas necessidades, não apenas para o custo do funeral.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quanto de capital contratar?</h2>\n      <p class=\"mb-4\">Uma análise básica considera renda mensal que precisa ser substituída, tempo de proteção, dívidas, dependentes, educação dos filhos, despesas imediatas e reservas já disponíveis. Quem possui empresa ou atua como principal gerador de renda pode precisar de uma avaliação específica.</p>\n\n      <p class=\"mb-4\">Não existe um múltiplo universal. Um capital aparentemente alto pode ser insuficiente quando dividido por vários anos; outro pode estar acima da necessidade quando há patrimônio líquido e poucos dependentes.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quando revisar beneficiários e coberturas</h2>\n      <ul class=\"list-disc pl-6 mb-6 space-y-2\">\n        <li>Casamento, união estável, separação ou divórcio.</li>\n        <li>Nascimento, adoção ou independência financeira de filhos.</li>\n        <li>Compra de imóvel ou contratação de financiamento relevante.</li>\n        <li>Abertura, venda ou mudança na participação de uma empresa.</li>\n        <li>Alteração importante de renda ou patrimônio.</li>\n        <li>Falecimento de beneficiário indicado.</li>\n      </ul>\n\n      <p class=\"mb-4\">A lei permite substituir o beneficiário, salvo renúncia do segurado, mas a seguradora precisa ser cientificada. Se não for informada, poderá realizar pagamento válido ao beneficiário anterior, conforme a regra legal.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quais documentos a família deve conhecer?</h2>\n      <p class=\"mb-4\">Além dos documentos exigidos no sinistro, é útil que uma pessoa de confiança saiba que o seguro existe, qual é a seguradora ou corretora e onde encontrar apólice, certificado ou número da proposta. Não é necessário compartilhar senhas.</p>\n\n      <p class=\"mb-4\">Dados de identificação dos beneficiários devem estar completos e atualizados. A família também precisa comunicar o sinistro dentro dos procedimentos indicados e responder às solicitações necessárias à análise.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist antes de contratar</h2>\n      <ol class=\"list-decimal pl-6 mb-6 space-y-2\">\n        <li>Calcule necessidades imediatas e de longo prazo dos dependentes.</li>\n        <li>Compare morte natural e acidental sem olhar apenas o maior número.</li>\n        <li>Revise invalidez, doenças graves e demais coberturas oferecidas.</li>\n        <li>Entenda carência, vigência, exclusões e atualização do capital.</li>\n        <li>Indique beneficiários com dados completos e percentuais claros.</li>\n        <li>Informe saúde, profissão e hábitos com precisão na contratação.</li>\n        <li>Reavalie a proteção sempre que a vida financeira mudar.</li>\n      </ol>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Conclusão</h2>\n      <p class=\"mb-4\">O capital do seguro de vida devido por morte não é considerado herança e segue a indicação de beneficiários e as regras legais. Essa vantagem só funciona bem quando contrato, capital e cadastro acompanham a realidade da família.</p>\n\n      <div class=\"bg-[#0d1f3c] text-white p-7 rounded-2xl mt-8\">\n        <h3 class=\"text-xl font-black mb-3\">Seu seguro de vida está atualizado?</h3>\n        <p class=\"mb-5 text-slate-200\">A Elevance compara coberturas, capitais e perfis de contratação para montar uma proteção compatível com dependentes, renda e compromissos financeiros.</p>\n        <a href=\"https://wa.me/5511920144864?text=Olá%2C%20quero%20comparar%20opções%20de%20seguro%20de%20vida\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#22c55e] hover:bg-[#16a34a] text-white font-black px-6 py-3 rounded-xl transition-colors\">Solicitar cotação no WhatsApp</a>\n      </div>\n\n      <p class=\"text-xs text-slate-500 mt-6\">Conteúdo informativo, não constitui orientação jurídica. Coberturas, capitais, beneficiários, carências, exclusões, documentos e critérios de pagamento variam conforme legislação aplicável, seguradora e condições contratuais.</p>"
  },

  {
    id: 118,
    slug: "plano-saude-apos-demissao-continuar-quanto-tempo",
    title: "Plano de Saúde Após Demissão: Quem Pode Continuar e Por Quanto Tempo?",
    date: "17 Ago, 2026",
    category: "Plano de Saúde",
    readTime: "11 min",
    image: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?auto=format&fit=crop&q=80&w=800",
    excerpt: "Entenda os requisitos, o prazo de 30 dias, o custo integral e quando comparar permanência, portabilidade ou nova contratação.",
    content: "\n      <p class=\"mb-4\">Quem é demitido pode continuar no plano de saúde da empresa? Em algumas situações, sim. A manutenção depende do tipo de desligamento, da contribuição do trabalhador para a mensalidade e do cumprimento dos prazos previstos nas regras da saúde suplementar.</p>\n\n      <p class=\"mb-4\">A decisão costuma ser urgente porque o ex-empregado precisa comparar três caminhos: assumir integralmente o plano empresarial, usar a portabilidade de carências para outro produto compatível ou contratar uma nova opção. Rede, preço, acomodação e continuidade de tratamentos devem entrar na análise.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quem pode continuar no plano após a demissão?</h2>\n      <p class=\"mb-4\">Segundo a ANS, o empregado demitido sem justa causa pode ter direito à manutenção quando contribuía para o pagamento mensal do plano, assume o custo integral depois do desligamento e a empresa mantém o benefício para os empregados ativos. Também é necessário respeitar o prazo de opção informado pelo empregador.</p>\n\n      <div class=\"overflow-x-auto mb-6\">\n        <table class=\"w-full border-collapse text-sm\">\n          <thead><tr class=\"bg-slate-100\"><th class=\"border border-slate-200 p-3 text-left\">Situação</th><th class=\"border border-slate-200 p-3 text-left\">O que verificar</th><th class=\"border border-slate-200 p-3 text-left\">Próximo passo</th></tr></thead>\n          <tbody>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Demissão sem justa causa</td><td class=\"border border-slate-200 p-3\">Contribuição mensal, plano ativo e prazo de opção</td><td class=\"border border-slate-200 p-3\">Solicitar valores e condições por escrito</td></tr>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Pedido de demissão ou justa causa</td><td class=\"border border-slate-200 p-3\">A manutenção legal não se aplica da mesma forma</td><td class=\"border border-slate-200 p-3\">Avaliar portabilidade ou nova contratação</td></tr>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Novo emprego com acesso a plano</td><td class=\"border border-slate-200 p-3\">Pode encerrar o direito de permanência</td><td class=\"border border-slate-200 p-3\">Comparar redes e datas antes da mudança</td></tr>\n          </tbody>\n        </table>\n      </div>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Coparticipação conta como contribuição?</h2>\n      <p class=\"mb-4\">Não necessariamente. A ANS diferencia a contribuição regular para custear a mensalidade do pagamento de coparticipação ou franquia quando o beneficiário usa um serviço. Quem pagava apenas consultas, exames ou procedimentos utilizados pode não preencher o requisito de contribuição.</p>\n      <p class=\"mb-4\">Como holerites e políticas internas nem sempre deixam essa distinção clara, peça ao RH o histórico de contribuição e a comunicação formal sobre o direito de permanência.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Qual é o prazo para escolher?</h2>\n      <p class=\"mb-4\">A opção deve ser feita em até 30 dias contados da comunicação do empregador sobre o direito. Não espere o último dia: solicite mensalidade integral, rede credenciada, acomodação, abrangência, dependentes e data de início da nova cobrança.</p>\n\n      <div class=\"bg-blue-50 border-l-4 border-blue-500 p-5 my-6 rounded-r-xl\">\n        <p class=\"font-bold text-[#0d1f3c] mb-2\">A mensalidade pode subir depois do desligamento</p>\n        <p class=\"text-slate-700\">Durante o vínculo, a empresa costuma pagar parte do custo. Para permanecer, o ex-empregado assume o valor integral aplicável ao grupo, além de reajustes e coparticipações previstos no contrato.</p>\n      </div>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Por quanto tempo o demitido pode ficar?</h2>\n      <p class=\"mb-4\">Para o demitido sem justa causa, o período corresponde a um terço do tempo em que houve contribuição, respeitado o mínimo de seis e o máximo de 24 meses. Exemplo: quem contribuiu por três anos pode ter 12 meses de manutenção, desde que cumpra os demais requisitos.</p>\n      <p class=\"mb-4\">O direito pode terminar antes em situações previstas na regulamentação, como admissão em novo emprego que ofereça acesso a plano de assistência médica, ou com o encerramento do benefício para os empregados ativos.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Os dependentes podem continuar?</h2>\n      <p class=\"mb-4\">Os dependentes já inscritos podem permanecer junto com o titular nas condições aplicáveis. A composição do grupo e o preço precisam ser confirmados com RH, administradora ou operadora. Não presuma que o valor antigo será mantido.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Permanecer ou fazer portabilidade?</h2>\n      <div class=\"overflow-x-auto mb-6\">\n        <table class=\"w-full border-collapse text-sm\">\n          <thead><tr class=\"bg-slate-100\"><th class=\"border border-slate-200 p-3 text-left\">Caminho</th><th class=\"border border-slate-200 p-3 text-left\">Pode fazer sentido quando</th><th class=\"border border-slate-200 p-3 text-left\">Atenção</th></tr></thead>\n          <tbody>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Manter o empresarial</td><td class=\"border border-slate-200 p-3\">Rede e continuidade assistencial são prioritárias</td><td class=\"border border-slate-200 p-3\">Custo integral e prazo limitado</td></tr>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Portabilidade</td><td class=\"border border-slate-200 p-3\">Existe produto compatível com rede e orçamento</td><td class=\"border border-slate-200 p-3\">Regras, documentos e janela aplicável</td></tr>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Nova contratação</td><td class=\"border border-slate-200 p-3\">A pessoa quer outra segmentação ou perfil de rede</td><td class=\"border border-slate-200 p-3\">Pode haver novas carências e análise de elegibilidade</td></tr>\n          </tbody>\n        </table>\n      </div>\n\n      <p class=\"mb-4\">A portabilidade de carências pode ser uma alternativa e, em hipóteses ligadas ao fim do vínculo, há regras específicas. A compatibilidade deve ser conferida no Guia ANS de Planos de Saúde e na documentação do beneficiário. Não cancele a cobertura atual antes de confirmar por escrito a aceitação e a data de início da nova.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist antes de decidir</h2>\n      <ul class=\"list-disc pl-6 mb-6 space-y-2\">\n        <li>comunicação do RH e data final dos 30 dias;</li>\n        <li>comprovantes de contribuição mensal;</li>\n        <li>valor integral do titular e de cada dependente;</li>\n        <li>rede de hospitais, laboratórios e médicos realmente utilizados;</li>\n        <li>acomodação, abrangência, coparticipação e reembolso;</li>\n        <li>tratamentos em curso, autorizações e continuidade assistencial;</li>\n        <li>opções de portabilidade compatíveis e documentos exigidos.</li>\n      </ul>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Como a Elevance ajuda na comparação</h2>\n      <p class=\"mb-4\">A Elevance pode comparar permanência, portabilidade e nova contratação conforme o perfil familiar ou empresarial, verificando rede, regras de elegibilidade, custo e documentação. A recomendação depende das condições vigentes de cada produto e operadora.</p>\n\n      <div class=\"bg-[#0d1f3c] text-white p-7 rounded-2xl my-8\">\n        <h3 class=\"text-xl font-black mb-3\">Vai sair da empresa e precisa decidir o plano?</h3>\n        <p class=\"mb-5 text-slate-200\">Envie a comunicação do RH, o município, as idades e a rede desejada. A Elevance compara caminhos sem deixar o prazo passar.</p>\n        <a href=\"https://wa.me/5511920144864?text=Ol%C3%A1%2C%20quero%20comparar%20meu%20plano%20de%20sa%C3%BAde%20ap%C3%B3s%20a%20demiss%C3%A3o\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-6 rounded-lg\">Falar com a Elevance no WhatsApp</a>\n      </div>\n\n      <p class=\"text-sm text-slate-500 mt-8\"><strong>Fonte principal:</strong> Agência Nacional de Saúde Suplementar (ANS), página “Direitos dos aposentados e demitidos”, consultada em agosto de 2026. As condições concretas dependem da regulamentação, do contrato e dos documentos de cada beneficiário.</p>\n"
  },
  {
    id: 119,
    slug: "seguro-carro-eletrico-hibrido-bateria-assistencia",
    title: "Seguro para Carro Elétrico e Híbrido: Bateria, Recarga e Assistência",
    date: "18 Ago, 2026",
    category: "Seguro Auto",
    readTime: "11 min",
    image: "https://images.unsplash.com/photo-1592833159155-c62df1b65634?auto=format&fit=crop&q=80&w=800",
    excerpt: "Saiba o que comparar na cobertura da bateria, cabo de recarga, wallbox, assistência, vidros, franquia e indenização.",
    content: "\n      <p class=\"mb-4\">Seguro para carro elétrico ou híbrido funciona como o seguro de um veículo a combustão? A estrutura principal pode ser semelhante, mas bateria de tração, cabo de recarga, teto panorâmico, assistência e disponibilidade de peças tornam a comparação mais específica.</p>\n\n      <p class=\"mb-4\">O erro mais comum é escolher apenas pelo preço. Duas propostas podem ter casco, terceiros e assistência, mas apresentar diferenças relevantes em franquia, forma de indenização, limites de guincho e tratamento dos acessórios de recarga.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Carro elétrico precisa de um seguro específico?</h2>\n      <p class=\"mb-4\">Nem sempre existe um produto separado com esse nome. Muitas seguradoras enquadram elétricos e híbridos no seguro auto, após análise do modelo, valor, região, uso e perfil do condutor. A aceitação e as condições variam; por isso, a proposta precisa identificar corretamente a versão e a motorização.</p>\n      <p class=\"mb-4\">A Susep orienta que coberturas, riscos excluídos, franquias e critérios de indenização constem das condições contratuais. O nome comercial não substitui a leitura da proposta e das condições gerais.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">A bateria de tração está coberta?</h2>\n      <p class=\"mb-4\">Quando a bateria integra originalmente o veículo, danos decorrentes de um evento coberto — como colisão, incêndio ou alagamento, conforme as garantias contratadas — podem entrar na regulação do sinistro. Isso é diferente de defeito interno, desgaste, perda gradual de capacidade ou falha coberta pela garantia do fabricante.</p>\n\n      <div class=\"bg-blue-50 border-l-4 border-blue-500 p-5 my-6 rounded-r-xl\">\n        <p class=\"font-bold text-[#0d1f3c] mb-2\">Seguro não substitui garantia de fábrica</p>\n        <p class=\"text-slate-700\">O seguro trata eventos previstos na apólice. Defeito de fabricação, manutenção, degradação e falha puramente mecânica ou elétrica podem seguir a garantia do veículo ou permanecer excluídos.</p>\n      </div>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Cabo, carregador portátil e wallbox: é tudo a mesma coisa?</h2>\n      <div class=\"overflow-x-auto mb-6\">\n        <table class=\"w-full border-collapse text-sm\">\n          <thead><tr class=\"bg-slate-100\"><th class=\"border border-slate-200 p-3 text-left\">Item</th><th class=\"border border-slate-200 p-3 text-left\">Onde costuma estar</th><th class=\"border border-slate-200 p-3 text-left\">O que confirmar</th></tr></thead>\n          <tbody>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Cabo de recarga</td><td class=\"border border-slate-200 p-3\">Transportado no veículo</td><td class=\"border border-slate-200 p-3\">Se é acessório coberto, limites e modalidade de subtração</td></tr>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Carregador portátil</td><td class=\"border border-slate-200 p-3\">Veículo, garagem ou viagem</td><td class=\"border border-slate-200 p-3\">Vínculo com o casco e necessidade de declaração</td></tr>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Wallbox</td><td class=\"border border-slate-200 p-3\">Instalação fixa no imóvel</td><td class=\"border border-slate-200 p-3\">Se pertence ao seguro residencial, condominial ou a cobertura específica</td></tr>\n          </tbody>\n        </table>\n      </div>\n      <p class=\"mb-4\">Não presuma que um equipamento instalado na parede faz parte do seguro do automóvel. Peça confirmação expressa e informe valor, local de instalação e propriedade do equipamento.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Pane elétrica e bateria descarregada têm assistência?</h2>\n      <p class=\"mb-4\">Assistência 24 horas não é sinônimo de recarga móvel ilimitada. Algumas propostas oferecem apenas remoção até um ponto de recarga ou oficina, com limite de quilometragem; outras podem prever serviços adicionais. Confirme o que ocorre quando a carga termina, quando há falha no sistema de alta tensão e quando o veículo está longe da rede autorizada.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Elétrico, híbrido e carro a combustão: o que muda na cotação?</h2>\n      <div class=\"overflow-x-auto mb-6\">\n        <table class=\"w-full border-collapse text-sm\">\n          <thead><tr class=\"bg-slate-100\"><th class=\"border border-slate-200 p-3 text-left\">Ponto</th><th class=\"border border-slate-200 p-3 text-left\">Elétrico ou híbrido</th><th class=\"border border-slate-200 p-3 text-left\">Comparação necessária</th></tr></thead>\n          <tbody>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Reparo</td><td class=\"border border-slate-200 p-3\">Pode exigir oficina, diagnóstico e peças específicos</td><td class=\"border border-slate-200 p-3\">Rede referenciada e liberdade de escolha</td></tr>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Bateria</td><td class=\"border border-slate-200 p-3\">Componente de alto valor integrado ao veículo</td><td class=\"border border-slate-200 p-3\">Evento coberto versus defeito ou desgaste</td></tr>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Assistência</td><td class=\"border border-slate-200 p-3\">Descarga pode exigir guincho adequado</td><td class=\"border border-slate-200 p-3\">Quilometragem, destino e número de usos</td></tr>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Vidros</td><td class=\"border border-slate-200 p-3\">Alguns modelos têm teto panorâmico e peças específicas</td><td class=\"border border-slate-200 p-3\">Itens incluídos e franquia por peça</td></tr>\n          </tbody>\n        </table>\n      </div>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Valor de mercado ou valor determinado?</h2>\n      <p class=\"mb-4\">A indenização integral pode usar valor de mercado referenciado ou valor determinado, conforme a proposta. Em modelos com oscilação de preço, compare o percentual contratado, o critério da tabela e as regras para veículo zero-quilômetro. O prêmio menor não compensa uma referência incompatível com a reposição esperada.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">E se o carro carregar na garagem do condomínio?</h2>\n      <p class=\"mb-4\">Danos ao automóvel, ao ponto de recarga e ao imóvel podem envolver contratos diferentes. O seguro auto, o seguro do condomínio e eventual responsabilidade civil precisam ser analisados conforme a origem do dano e as coberturas efetivamente contratadas. Instalação elétrica e manutenção devem seguir as exigências técnicas e condominiais aplicáveis.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para comparar propostas</h2>\n      <ul class=\"list-disc pl-6 mb-6 space-y-2\">\n        <li>versão exata, ano, valor e tipo de motorização;</li>\n        <li>casco compreensivo, terceiros e acidentes pessoais;</li>\n        <li>franquia normal, reduzida ou majorada;</li>\n        <li>tratamento da bateria em eventos cobertos;</li>\n        <li>cabo, carregador portátil e demais acessórios declarados;</li>\n        <li>quilometragem e destino do guincho;</li>\n        <li>rede de oficinas e disponibilidade de peças;</li>\n        <li>vidros, faróis, lanternas e teto panorâmico;</li>\n        <li>carro reserva, número de diárias e categoria;</li>\n        <li>valor de mercado referenciado ou determinado.</li>\n      </ul>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Como a Elevance ajuda</h2>\n      <p class=\"mb-4\">A Elevance compara propostas considerando o modelo elétrico ou híbrido, uso, região, perfil dos condutores e estrutura de recarga. A análise mostra diferenças de franquia, assistência, acessórios e indenização antes da contratação.</p>\n\n      <div class=\"bg-[#0d1f3c] text-white p-7 rounded-2xl my-8\">\n        <h3 class=\"text-xl font-black mb-3\">Vai segurar um carro elétrico ou híbrido?</h3>\n        <p class=\"mb-5 text-slate-200\">Envie modelo, ano, CEP, uso e perfil dos condutores. A Elevance compara as condições que realmente mudam para esse tipo de veículo.</p>\n        <a href=\"https://wa.me/5511920144864?text=Ol%C3%A1%2C%20quero%20cotar%20seguro%20para%20carro%20el%C3%A9trico%20ou%20h%C3%ADbrido\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-6 rounded-lg\">Cotar com a Elevance no WhatsApp</a>\n      </div>\n\n      <p class=\"text-sm text-slate-500 mt-8\"><strong>Fonte principal:</strong> Superintendência de Seguros Privados (Susep), orientações sobre seguro de automóveis, consultadas em agosto de 2026. Coberturas, aceitação, franquias, serviços e exclusões variam conforme seguradora, veículo e condições contratuais.</p>\n"
  },
  {
    id: 120,
    slug: "seguro-pet-shop-clinica-veterinaria-banho-tosa",
    title: "Seguro para Pet Shop e Clínica Veterinária: Patrimônio, Animais e RC",
    date: "19 Ago, 2026",
    category: "Seguro Empresarial",
    readTime: "11 min",
    image: "https://images.unsplash.com/photo-1548199973-03cce0bbc87b?auto=format&fit=crop&q=80&w=800",
    excerpt: "Entenda como comparar proteção patrimonial, animais sob cuidados, responsabilidade civil, equipamentos e lucros cessantes.",
    content: "\n      <p class=\"mb-4\">Seguro para pet shop cobre um animal que se machuca durante o banho e tosa? Não basta contratar uma apólice empresarial genérica e presumir que sim. Patrimônio, responsabilidade por animais sob cuidados, atendimento veterinário e transporte são riscos diferentes.</p>\n\n      <p class=\"mb-4\">Pet shops, clínicas, hospitais veterinários, hotéis, creches e serviços de banho e tosa precisam comparar propostas pelo funcionamento real do negócio. Equipamentos caros e estoque importam, mas uma reclamação relacionada a fuga, queda, queimadura, briga ou erro profissional pode ser o risco mais sensível.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Seguro empresarial e responsabilidade civil são a mesma coisa?</h2>\n      <p class=\"mb-4\">Não. O seguro empresarial protege principalmente o patrimônio e a continuidade do estabelecimento conforme as coberturas contratadas. Responsabilidade civil trata reclamações de terceiros por danos atribuídos à atividade, dentro das condições e limites da apólice.</p>\n\n      <div class=\"overflow-x-auto mb-6\">\n        <table class=\"w-full border-collapse text-sm\">\n          <thead><tr class=\"bg-slate-100\"><th class=\"border border-slate-200 p-3 text-left\">Proteção</th><th class=\"border border-slate-200 p-3 text-left\">Exemplos de risco</th><th class=\"border border-slate-200 p-3 text-left\">Ponto de atenção</th></tr></thead>\n          <tbody>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Patrimonial</td><td class=\"border border-slate-200 p-3\">Incêndio, danos elétricos, vendaval, equipamentos e mercadorias</td><td class=\"border border-slate-200 p-3\">Limites por cobertura, franquias e comprovação dos bens</td></tr>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">RC operacional</td><td class=\"border border-slate-200 p-3\">Dano causado a cliente ou terceiro na operação</td><td class=\"border border-slate-200 p-3\">Atividades declaradas, defesa e exclusões</td></tr>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Animais sob cuidado</td><td class=\"border border-slate-200 p-3\">Fuga, lesão ou morte durante guarda e serviço</td><td class=\"border border-slate-200 p-3\">Precisa estar expressamente abrangido; não deve ser presumido</td></tr>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">RC profissional</td><td class=\"border border-slate-200 p-3\">Alegação de erro em ato veterinário</td><td class=\"border border-slate-200 p-3\">Profissão, retroatividade, reclamação e aceitação específica</td></tr>\n          </tbody>\n        </table>\n      </div>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Animais de clientes entram como mercadoria ou conteúdo?</h2>\n      <p class=\"mb-4\">Não é seguro tratá-los como estoque do estabelecimento. Animais pertencem a terceiros e ficam temporariamente sob guarda, controle ou custódia do negócio. A cobertura precisa mencionar esse risco ou oferecer extensão compatível.</p>\n      <p class=\"mb-4\">Pergunte por escrito como a proposta trata danos ao animal, despesas emergenciais, morte, fuga, desaparecimento, briga entre animais e limite por ocorrência. Termos, sublimites e exclusões variam entre seguradoras.</p>\n\n      <div class=\"bg-blue-50 border-l-4 border-blue-500 p-5 my-6 rounded-r-xl\">\n        <p class=\"font-bold text-[#0d1f3c] mb-2\">“Tenho responsabilidade civil” não encerra a análise</p>\n        <p class=\"text-slate-700\">Uma RC ampla no título pode excluir bens e animais sob custódia. A confirmação precisa estar na proposta e nas condições contratuais, considerando exatamente os serviços prestados.</p>\n      </div>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Banho e tosa, clínica, hotel e creche têm o mesmo risco?</h2>\n      <div class=\"overflow-x-auto mb-6\">\n        <table class=\"w-full border-collapse text-sm\">\n          <thead><tr class=\"bg-slate-100\"><th class=\"border border-slate-200 p-3 text-left\">Operação</th><th class=\"border border-slate-200 p-3 text-left\">Exposição característica</th><th class=\"border border-slate-200 p-3 text-left\">Informação essencial</th></tr></thead>\n          <tbody>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Pet shop com loja</td><td class=\"border border-slate-200 p-3\">Estoque, circulação de clientes e equipamentos</td><td class=\"border border-slate-200 p-3\">Valores, tipo de mercadoria e segurança do local</td></tr>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Banho e tosa</td><td class=\"border border-slate-200 p-3\">Contenção, secadores, lâminas, quedas e fuga</td><td class=\"border border-slate-200 p-3\">Quantidade atendida, procedimentos e animais sob cuidado</td></tr>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Clínica veterinária</td><td class=\"border border-slate-200 p-3\">Consultas, procedimentos, internação e medicamentos</td><td class=\"border border-slate-200 p-3\">Atos profissionais, responsáveis técnicos e equipamentos</td></tr>\n            <tr><td class=\"border border-slate-200 p-3 font-bold\">Hotel ou creche</td><td class=\"border border-slate-200 p-3\">Permanência prolongada, convivência e áreas externas</td><td class=\"border border-slate-200 p-3\">Capacidade, pernoite, segregação e protocolos</td></tr>\n          </tbody>\n        </table>\n      </div>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quais coberturas patrimoniais comparar?</h2>\n      <ul class=\"list-disc pl-6 mb-6 space-y-2\">\n        <li>incêndio, queda de raio e explosão;</li>\n        <li>danos elétricos em secadores, máquinas, computadores e equipamentos clínicos;</li>\n        <li>subtração de bens e mercadorias nas modalidades previstas;</li>\n        <li>quebra de vidros, fachadas e anúncios luminosos;</li>\n        <li>vendaval, impacto de veículos e danos por água, quando contratados;</li>\n        <li>deterioração de produtos que dependem de refrigeração, se aplicável;</li>\n        <li>lucros cessantes ou despesas fixas após evento coberto.</li>\n      </ul>\n      <p class=\"mb-4\">Valores baixos podem deixar equipamentos ou estoque parcialmente descobertos. Faça inventário com notas, fotos, números de série e custo atual de reposição antes da cotação.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">E os medicamentos e vacinas refrigerados?</h2>\n      <p class=\"mb-4\">A cobertura básica não garante automaticamente deterioração por variação de temperatura. Clínicas e lojas com produtos refrigerados devem informar tipo, valor máximo armazenado, equipamentos de conservação, alarmes e plano de contingência. A causa da falha também interfere na análise do sinistro.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Pet táxi e leva-e-traz entram no seguro da loja?</h2>\n      <p class=\"mb-4\">O transporte acrescenta outro risco. O veículo precisa estar segurado com uso corretamente declarado, e a responsabilidade pelos animais transportados deve ser analisada separadamente. Uma apólice do endereço não deve ser interpretada como cobertura automática para todo trajeto.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">O seguro cobre processos e honorários?</h2>\n      <p class=\"mb-4\">Coberturas de responsabilidade civil podem prever custos de defesa e acordos ou condenações, observadas autorização, limites, franquia, riscos cobertos e demais condições. A empresa deve comunicar a seguradora rapidamente e não assumir compromissos sem seguir o procedimento contratual.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para uma cotação comparável</h2>\n      <ul class=\"list-disc pl-6 mb-6 space-y-2\">\n        <li>CNPJ, endereço, faturamento e tempo de atividade;</li>\n        <li>serviços efetivamente prestados e responsáveis técnicos;</li>\n        <li>quantidade média e máxima de animais sob cuidado;</li>\n        <li>existência de hotel, creche, internação, cirurgia ou transporte;</li>\n        <li>valores de prédio, conteúdo, estoque e equipamentos;</li>\n        <li>medicamentos e produtos refrigerados;</li>\n        <li>histórico de ocorrências e reclamações;</li>\n        <li>protocolos de contenção, identificação, higiene e emergência;</li>\n        <li>limites desejados para patrimônio e responsabilidade civil.</li>\n      </ul>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Como a Elevance ajuda</h2>\n      <p class=\"mb-4\">A Elevance organiza o risco por atividade e compara propostas sem misturar proteção patrimonial, RC operacional, animais sob custódia e atos profissionais. Assim, preço, limites, franquias e exclusões ficam visíveis antes da contratação.</p>\n\n      <div class=\"bg-[#0d1f3c] text-white p-7 rounded-2xl my-8\">\n        <h3 class=\"text-xl font-black mb-3\">Seu negócio atende ou hospeda animais?</h3>\n        <p class=\"mb-5 text-slate-200\">Envie o CNPJ, endereço, serviços e valores aproximados. A Elevance verifica quais coberturas precisam aparecer expressamente na proposta.</p>\n        <a href=\"https://wa.me/5511920144864?text=Ol%C3%A1%2C%20quero%20cotar%20seguro%20para%20pet%20shop%20ou%20cl%C3%ADnica%20veterin%C3%A1ria\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-6 rounded-lg\">Cotar com a Elevance no WhatsApp</a>\n      </div>\n\n      <p class=\"text-sm text-slate-500 mt-8\"><strong>Fontes principais:</strong> Susep, orientações sobre seguros compreensivos, responsabilidade civil e dados de produtos do Open Insurance, consultadas em agosto de 2026. Aceitação, coberturas e limites dependem da seguradora, da atividade declarada e das condições contratuais.</p>\n"
  },
  {
    id: 121,
    slug: "seguro-auto-cobre-enchente-alagamento",
    title: "Seguro Auto Cobre Enchente e Alagamento? Quando Há Indenização",
    date: "20 Ago, 2026",
    category: "Seguro Auto",
    readTime: "10 min",
    image: "https://images.unsplash.com/photo-1547683905-f686c993aae5?auto=format&fit=crop&q=80&w=800",
    excerpt: "Entenda quando o seguro auto pode cobrir enchente e alagamento, quais modalidades comparar e o que conferir na apólice antes de contratar.",
    content: "\n      <p class=\"mb-4\">Depois de uma chuva forte, a água subiu e atingiu o carro. O seguro paga? A resposta correta não está apenas no nome da seguradora: depende da <strong>cobertura de casco contratada</strong>, das condições da apólice e da causa do dano. Para quem mora, trabalha ou estaciona em regiões sujeitas a alagamentos, essa verificação precisa acontecer antes do problema — não durante o sinistro.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Seguro auto cobre enchente e alagamento?</h2>\n      <p class=\"mb-4\">Pode cobrir. A Susep esclarece que as coberturas de casco podem abranger, isolada ou conjuntamente, diferentes riscos e <strong>podem incluir alagamentos e inundações</strong>. Portanto, não é seguro concluir que toda apólice cobre ou que nenhuma cobre: é necessário conferir a proposta, a apólice e as condições contratuais do produto.</p>\n      <p class=\"mb-4\">Nos planos compreensivos — frequentemente chamados de cobertura completa — danos decorrentes de eventos da natureza costumam estar entre os riscos analisados. Ainda assim, nomes comerciais variam. O documento decisivo é o contrato, incluindo riscos cobertos, exclusões, franquias e limites.</p>\n\n      <div class=\"my-10 bg-blue-50 p-8 rounded-3xl border border-blue-100 shadow-sm text-[#0d1f3c]\">\n        <h3 class=\"font-bold mb-2\">Resposta rápida</h3>\n        <p class=\"text-sm font-medium\">Se você quer proteção contra alagamento, peça uma cotação de casco compreensiva e solicite confirmação escrita de que inundação, enchente ou alagamento estão abrangidos. Compare também franquia, valor de indenização, assistência e exclusões.</p>\n      </div>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Cobertura compreensiva vs. roubo e furto</h2>\n      <div class=\"overflow-x-auto mb-6\">\n        <table class=\"w-full text-sm border-collapse\">\n          <thead><tr class=\"bg-[#0d1f3c] text-white\"><th class=\"p-3 text-left\">Opção</th><th class=\"p-3 text-left\">Foco principal</th><th class=\"p-3 text-left\">Alagamento</th><th class=\"p-3 text-left\">Perfil típico</th></tr></thead>\n          <tbody>\n            <tr class=\"bg-slate-50 border-b border-slate-100\"><td class=\"p-3 font-semibold\">Casco compreensiva</td><td class=\"p-3\">Colisão, incêndio, roubo/furto e riscos previstos no contrato</td><td class=\"p-3\">Pode estar incluído, conforme condições</td><td class=\"p-3\">Quem busca proteção patrimonial mais ampla</td></tr>\n            <tr class=\"bg-white\"><td class=\"p-3 font-semibold\">Roubo e furto</td><td class=\"p-3\">Subtração do veículo nas hipóteses contratadas</td><td class=\"p-3\">Em regra, não é o objetivo dessa modalidade</td><td class=\"p-3\">Quem prioriza custo e o risco de subtração</td></tr>\n          </tbody>\n        </table>\n      </div>\n      <p class=\"mb-4\">Uma proposta mais barata pode ser adequada, mas não é equivalente se excluir danos parciais e eventos da natureza. Compare cobertura por cobertura, e não apenas o valor mensal ou anual.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quando o dano pode gerar indenização?</h2>\n      <p class=\"mb-4\">Havendo risco coberto, o evento será regulado pela seguradora. O dano pode resultar em reparo, com aplicação da franquia prevista, ou em indenização integral quando os critérios contratuais forem atingidos. O valor e o procedimento dependem da modalidade contratada, do limite da apólice, da franquia e da avaliação do sinistro.</p>\n      <ul class=\"list-none space-y-3 mb-6\">\n        <li class=\"flex items-start gap-2\"><span class=\"text-blue-600 font-black\">→</span><span><strong>Carro estacionado:</strong> a água alcança o veículo durante uma enchente e causa danos mecânicos ou elétricos.</span></li>\n        <li class=\"flex items-start gap-2\"><span class=\"text-blue-600 font-black\">→</span><span><strong>Veículo em circulação:</strong> o motorista é surpreendido pelo avanço da água em uma via, sujeito à análise das circunstâncias.</span></li>\n        <li class=\"flex items-start gap-2\"><span class=\"text-blue-600 font-black\">→</span><span><strong>Queda de árvore ou objeto:</strong> pode ser tratada como outro evento coberto, conforme a origem do dano e o contrato.</span></li>\n      </ul>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Entrar deliberadamente em uma área alagada muda a análise?</h2>\n      <p class=\"mb-4\">Pode mudar. Em qualquer sinistro, a seguradora analisa a dinâmica, os documentos e as condições contratuais. Expor conscientemente o veículo a um risco evidente, agravar intencionalmente o risco ou tentar ligar o motor repetidas vezes após a entrada de água pode trazer consequências técnicas e contratuais. Não há uma resposta automática aplicável a todas as apólices.</p>\n      <p class=\"mb-4\">Na prática, diante de uma via inundada, não tente atravessar. Se a água atingir o veículo, priorize a segurança das pessoas, procure um local protegido e acione a assistência ou a seguradora. Evite dar partida: isso pode ampliar o dano ao motor.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">O que conferir antes de contratar</h2>\n      <ol class=\"list-decimal pl-6 space-y-3 mb-6\">\n        <li><strong>Descrição dos riscos cobertos:</strong> procure termos como alagamento, inundação e enchente e leia suas definições.</li>\n        <li><strong>Riscos excluídos:</strong> confirme situações que o produto não cobre e obrigações do segurado.</li>\n        <li><strong>Franquia:</strong> entenda quando ela se aplica e qual valor você assumirá em um reparo parcial.</li>\n        <li><strong>Indenização:</strong> compare valor de mercado referenciado e valor determinado, quando disponíveis.</li>\n        <li><strong>Assistência 24 horas:</strong> verifique guincho, limite de quilometragem, carro reserva e canais de atendimento.</li>\n        <li><strong>Acessórios e adaptações:</strong> confirme como carregadores, blindagem, equipamentos e modificações são tratados.</li>\n      </ol>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Para quem essa proteção pesa mais na decisão?</h2>\n      <p class=\"mb-4\">Vale dar atenção especial ao tema se o veículo dorme em garagem subterrânea, circula em vias com histórico de alagamento, fica estacionado perto de córregos ou é essencial para trabalho e renda. Carros elétricos e híbridos também exigem comparação cuidadosa de rede de reparo, bateria, recarga e assistência — veja nosso guia sobre <a href=\"/blog/seguro-carro-eletrico-hibrido-bateria-recarga\" class=\"text-blue-600 font-bold hover:underline\">seguro para carros elétricos e híbridos</a>.</p>\n      <p class=\"mb-4\">Se o veículo é financiado, confira também como funciona a liquidação em caso de perda total no artigo sobre <a href=\"/blog/seguro-auto-para-carro-financiado-indenizacao\" class=\"text-blue-600 font-bold hover:underline\">indenização de carro financiado</a>.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Documentos úteis em um sinistro</h2>\n      <p class=\"mb-4\">Assim que for seguro, registre fotos e vídeos do local e do veículo, guarde protocolos, informe data e horário, reúna documentos solicitados e siga as orientações da seguradora. Não autorize desmontagem ou reparo antes de entender o procedimento de regulação, salvo medidas emergenciais necessárias para proteger pessoas ou evitar agravamento imediato.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Conclusão: a apólice certa é a que confirma o risco que você quer proteger</h2>\n      <p class=\"mb-4\">Seguro auto pode cobrir enchente e alagamento, mas a confirmação precisa estar nas condições contratadas. A melhor comparação reúne preço, franquia, forma de indenização, assistência, exclusões e exposição real do seu trajeto e estacionamento.</p>\n\n      <div class=\"mt-10 bg-[#0d1f3c] text-white p-8 rounded-3xl shadow-xl\">\n        <h3 class=\"text-xl font-black mb-3\">Compare o seguro auto com quem lê os detalhes por você</h3>\n        <p class=\"mb-5 text-slate-200\">A Elevance compara opções adequadas ao seu veículo e perfil, explicando cobertura de alagamento, franquias e assistência antes da contratação.</p>\n        <a href=\"https://wa.me/5511920144864?text=Quero%20comparar%20seguro%20auto%20com%20cobertura%20para%20alagamento\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-green-500 hover:bg-green-400 text-white font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a>\n      </div>\n\n      <p class=\"mt-6 text-xs text-slate-500 italic\">Conteúdo informativo. Coberturas, franquias, limites, aceitação e exclusões variam conforme seguradora e produto. Consulte a proposta, a apólice e as condições contratuais.</p>\n"
  },

  {
    id: 122,
    slug: "seguro-padaria-confeitaria-fornos-camara-fria",
    title: "Seguro para Padaria e Confeitaria: Fornos, Câmara Fria e RC",
    date: "21 Ago, 2026",
    category: "Seguro Empresarial",
    readTime: "11 min",
    image: "https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&q=80&w=800",
    excerpt: "Veja como proteger fornos, câmaras frias, estoque, faturamento e responsabilidade civil de padarias e confeitarias.",
    content: "\n      <p class=\"mb-4\">Fornos ligados por horas, câmaras frias cheias, estoque de insumos, atendimento ao público e entregas: uma padaria reúne riscos bem diferentes no mesmo endereço. Por isso, contratar apenas a cobertura básica do imóvel pode deixar justamente os equipamentos e a continuidade da operação sem a proteção esperada.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">O que o seguro para padaria pode proteger?</h2>\n      <p class=\"mb-4\">O ponto de partida costuma ser um seguro empresarial patrimonial. A cobertura básica e as adicionais variam conforme seguradora, atividade declarada, imóvel, equipamentos e limites escolhidos. A Susep explica que seguros compreensivos indenizam perdas e danos aos bens segurados quando decorrentes de risco coberto.</p>\n      <p class=\"mb-4\">Para uma padaria ou confeitaria, a análise normalmente passa por imóvel, benfeitorias, mobiliário, estoque, máquinas, instalações elétricas, responsabilidade perante terceiros e perda de receita após um evento coberto.</p>\n\n      <div class=\"my-10 bg-blue-50 p-8 rounded-3xl border border-blue-100 shadow-sm text-[#0d1f3c]\">\n        <h3 class=\"font-bold mb-2\">O erro mais caro na cotação</h3>\n        <p class=\"text-sm font-medium\">Informar apenas “comércio” e escolher o menor preço. A seguradora precisa conhecer a atividade real, os processos de cocção, a potência dos equipamentos, o estoque refrigerado, o sistema de gás e as entregas. Uma proposta barata com enquadramento incorreto não é uma comparação válida.</p>\n      </div>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Coberturas que merecem comparação</h2>\n      <div class=\"overflow-x-auto mb-6\">\n        <table class=\"w-full text-sm border-collapse\">\n          <thead>\n            <tr class=\"bg-[#0d1f3c] text-white\">\n              <th class=\"p-3 text-left\">Cobertura</th>\n              <th class=\"p-3 text-left\">Que risco atende</th>\n              <th class=\"p-3 text-left\">O que confirmar</th>\n            </tr>\n          </thead>\n          <tbody>\n            <tr class=\"bg-slate-50 border-b border-slate-100\"><td class=\"p-3 font-semibold\">Incêndio, raio e explosão</td><td class=\"p-3\">Danos ao patrimônio por eventos previstos</td><td class=\"p-3\">Bens incluídos, limite e exigências de segurança</td></tr>\n            <tr class=\"bg-white border-b border-slate-100\"><td class=\"p-3 font-semibold\">Danos elétricos</td><td class=\"p-3\">Curto-circuito e variações anormais em instalações e equipamentos</td><td class=\"p-3\">Idade dos equipamentos, franquia e exclusões</td></tr>\n            <tr class=\"bg-slate-50 border-b border-slate-100\"><td class=\"p-3 font-semibold\">Quebra de máquinas</td><td class=\"p-3\">Danos acidentais a máquinas nas condições contratadas</td><td class=\"p-3\">Fornos, masseiras, cilindros, batedeiras e manutenção</td></tr>\n            <tr class=\"bg-white border-b border-slate-100\"><td class=\"p-3 font-semibold\">Deterioração de mercadorias</td><td class=\"p-3\">Perda de produtos refrigerados após evento coberto</td><td class=\"p-3\">Causa aceita, tempo mínimo, mercadorias e limite</td></tr>\n            <tr class=\"bg-slate-50 border-b border-slate-100\"><td class=\"p-3 font-semibold\">Lucros cessantes</td><td class=\"p-3\">Impacto financeiro da paralisação decorrente de sinistro coberto</td><td class=\"p-3\">Período indenitário, despesas fixas e documentação</td></tr>\n            <tr class=\"bg-white\"><td class=\"p-3 font-semibold\">Responsabilidade civil</td><td class=\"p-3\">Danos involuntários a terceiros nas situações previstas</td><td class=\"p-3\">Produtos, operações, empregador, entregas e limites</td></tr>\n          </tbody>\n        </table>\n      </div>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Danos elétricos e quebra de máquinas são a mesma coisa?</h2>\n      <p class=\"mb-4\">Não necessariamente. Danos elétricos são ligados a fenômenos como curto-circuito, arco voltaico e variações anormais de tensão, conforme as condições contratadas. Quebra de máquinas pode tratar outros danos súbitos e acidentais, também sujeitos a definições e exclusões próprias.</p>\n      <p class=\"mb-4\">Um forno que para por desgaste, falta de manutenção ou defeito progressivo pode não se enquadrar como evento coberto. Já um equipamento danificado por curto-circuito será analisado conforme a cobertura elétrica. A causa do dano importa tanto quanto o equipamento atingido.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">A câmara fria parou: o seguro paga o estoque?</h2>\n      <p class=\"mb-4\">Somente se houver cobertura compatível e o evento estiver dentro das condições. A proteção para deterioração de mercadorias em ambiente frigorificado pode exigir que a paralisação decorra de causa coberta e pode trazer franquia, carência horária, limite próprio e regras sobre os produtos armazenados.</p>\n      <p class=\"mb-4\">Liste manteiga, leite, frios, fermentos, recheios, massas, congelados e produtos acabados pelo valor de reposição real. Subestimar o estoque para reduzir prêmio pode gerar um limite insuficiente justamente quando a perda acontece.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Responsabilidade civil: balcão, produto e entrega</h2>\n      <p class=\"mb-4\">A cobertura patrimonial protege bens; a responsabilidade civil trata danos causados a terceiros nas hipóteses contratadas. Em uma padaria, a exposição pode envolver queda de cliente no salão, dano durante uma entrega, acidente operacional ou alegação relacionada a produto vendido.</p>\n      <p class=\"mb-4\">Nem toda RC empresarial inclui automaticamente produtos, empregador ou veículos. Essas frentes precisam ser declaradas e comparadas. Motocicletas e automóveis usados no delivery também exigem análise própria: a apólice do estabelecimento não substitui automaticamente o seguro do veículo.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Seguro do prédio vs. seguro do negócio</h2>\n      <p class=\"mb-4\">Se o imóvel é alugado, o seguro exigido no contrato de locação pode proteger apenas interesses definidos pelo proprietário ou a edificação. Isso não significa que estoque, equipamentos do inquilino, responsabilidade civil e perda de receita estejam contemplados.</p>\n      <p class=\"mb-4\">Se a padaria é proprietária do imóvel, edificação e conteúdo também precisam ter limites separados e coerentes. Reformas, coifas, câmaras frias, balcões planejados e instalações incorporadas merecem ser declarados corretamente.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quanto contratar de limite?</h2>\n      <ul class=\"list-none space-y-3 mb-6\">\n        <li class=\"flex items-start gap-2\"><span class=\"text-blue-600 font-black\">→</span><span><strong>Edificação e benfeitorias:</strong> estime o custo de reconstrução e reposição, não apenas o valor de mercado do endereço.</span></li>\n        <li class=\"flex items-start gap-2\"><span class=\"text-blue-600 font-black\">→</span><span><strong>Máquinas e mobiliário:</strong> relacione marca, modelo, ano, valor e nota fiscal quando disponível.</span></li>\n        <li class=\"flex items-start gap-2\"><span class=\"text-blue-600 font-black\">→</span><span><strong>Estoque:</strong> considere o pico de compras e períodos sazonais, não somente a média mensal.</span></li>\n        <li class=\"flex items-start gap-2\"><span class=\"text-blue-600 font-black\">→</span><span><strong>Lucros cessantes:</strong> reúna faturamento, margem, despesas fixas e tempo provável para retomada.</span></li>\n        <li class=\"flex items-start gap-2\"><span class=\"text-blue-600 font-black\">→</span><span><strong>Responsabilidade civil:</strong> avalie fluxo de clientes, produção, delivery e número de funcionários.</span></li>\n      </ul>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para receber propostas comparáveis</h2>\n      <ol class=\"list-decimal pl-6 space-y-3 mb-6\">\n        <li>CNPJ, endereço e descrição exata das atividades.</li>\n        <li>Tipo de construção, área, ocupação e relação com o imóvel.</li>\n        <li>Sistema elétrico, gás, coifa, exaustão, extintores e medidas de prevenção.</li>\n        <li>Relação de fornos, masseiras, cilindros, câmaras, freezers e demais máquinas.</li>\n        <li>Valor máximo de estoque seco, refrigerado e congelado.</li>\n        <li>Faturamento, despesas fixas e tempo necessário para retomar a operação.</li>\n        <li>Atendimento no local, delivery próprio ou terceirizado e quantidade de funcionários.</li>\n        <li>Histórico de sinistros e reformas realizadas.</li>\n      </ol>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Padaria, confeitaria e restaurante contratam igual?</h2>\n      <p class=\"mb-4\">Existem riscos parecidos, mas a proporção muda. Uma confeitaria sob encomenda pode concentrar valor em equipamentos e interrupção. Uma padaria 24 horas soma grande fluxo de público, produção contínua e estoque. Um restaurante pode ter exposição diferente em salão, cozinha e bebidas. Veja também nosso guia de <a href=\"/blog/seguro-empresarial-para-restaurante-coberturas\" class=\"text-blue-600 font-bold hover:underline\">seguro empresarial para restaurante</a>.</p>\n      <p class=\"mb-4\">Para negócios com medicamentos ou produtos sensíveis à temperatura, a lógica de estoque muda; explicamos isso no artigo sobre <a href=\"/blog/seguro-empresarial-para-farmacia-coberturas\" class=\"text-blue-600 font-bold hover:underline\">seguro empresarial para farmácia</a>.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Conclusão: o seguro precisa refletir a operação real</h2>\n      <p class=\"mb-4\">Uma boa proposta para padaria não é apenas “incêndio + menor preço”. Ela deve mostrar claramente quais bens estão protegidos, como danos elétricos e quebra de máquinas se diferenciam, quando o estoque refrigerado entra, quanto tempo de paralisação foi considerado e quais responsabilidades perante terceiros foram incluídas.</p>\n\n      <div class=\"mt-10 bg-[#0d1f3c] text-white p-8 rounded-3xl shadow-xl\">\n        <h3 class=\"text-xl font-black mb-3\">Peça uma comparação para sua padaria ou confeitaria</h3>\n        <p class=\"mb-5 text-slate-200\">A Elevance organiza os dados do negócio e compara coberturas, limites, franquias e exclusões para você decidir com clareza.</p>\n        <a href=\"https://wa.me/5511920144864?text=Quero%20cotar%20seguro%20para%20padaria%20ou%20confeitaria\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-green-500 hover:bg-green-400 text-white font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a>\n      </div>\n\n      <p class=\"mt-6 text-xs text-slate-500 italic\">Conteúdo informativo. Coberturas, aceitação, limites, franquias, carências e exclusões variam conforme seguradora, produto e risco. Consulte proposta, apólice e condições contratuais.</p>\n"
  },

  {
    id: 123,
    slug: "plano-saude-enfermaria-vs-apartamento",
    title: "Plano de Saúde: Enfermaria vs Apartamento — Qual Vale a Pena?",
    date: "22 Ago, 2026",
    category: "Planos de Saúde",
    readTime: "10 min",
    image: "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?auto=format&fit=crop&q=80&w=800",
    excerpt: "Compare enfermaria e apartamento por preço, privacidade, internação e perfil familiar antes de escolher seu plano de saúde.",
    content: "\n      <p class=\"mb-4\">Na cotação, a diferença parece simples: enfermaria é quarto compartilhado; apartamento é quarto individual. Só que a escolha interfere em preço, privacidade e experiência durante uma internação — e não deve ser confundida com rede hospitalar, coparticipação ou abrangência do plano.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Qual é a diferença entre enfermaria e apartamento?</h2>\n      <p class=\"mb-4\">A ANS classifica o padrão de acomodação hospitalar como coletivo, em enfermaria, ou individual, em quarto. Essa definição vale para internações cobertas pelo produto contratado. Consultas, exames e pronto atendimento não se tornam automaticamente diferentes apenas por causa da acomodação.</p>\n      <ul class=\"list-none space-y-3 mb-6\">\n        <li class=\"flex items-start gap-2\"><span class=\"text-blue-600 font-black\">→</span><span><strong>Enfermaria:</strong> acomodação coletiva, compartilhada com outros pacientes conforme a estrutura hospitalar e o contrato.</span></li>\n        <li class=\"flex items-start gap-2\"><span class=\"text-blue-600 font-black\">→</span><span><strong>Apartamento:</strong> acomodação individual durante a internação, conforme as condições do produto e a disponibilidade assistencial.</span></li>\n      </ul>\n\n      <div class=\"my-10 bg-blue-50 p-8 rounded-3xl border border-blue-100 shadow-sm text-[#0d1f3c]\">\n        <h3 class=\"font-bold mb-2\">Antes de escolher</h3>\n        <p class=\"text-sm font-medium\">Não compare apenas “enfermaria vs. apartamento”. Confirme se as propostas têm a mesma operadora, rede, segmentação, abrangência, coparticipação, carências e regras de reembolso. Às vezes o plano mais caro muda outros itens além do quarto.</p>\n      </div>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Comparação direta</h2>\n      <div class=\"overflow-x-auto mb-6\">\n        <table class=\"w-full text-sm border-collapse\">\n          <thead>\n            <tr class=\"bg-[#0d1f3c] text-white\"><th class=\"p-3 text-left\">Critério</th><th class=\"p-3 text-left\">Enfermaria</th><th class=\"p-3 text-left\">Apartamento</th></tr>\n          </thead>\n          <tbody>\n            <tr class=\"bg-slate-50 border-b border-slate-100\"><td class=\"p-3 font-semibold\">Quarto</td><td class=\"p-3\">Coletivo</td><td class=\"p-3\">Individual</td></tr>\n            <tr class=\"bg-white border-b border-slate-100\"><td class=\"p-3 font-semibold\">Privacidade</td><td class=\"p-3\">Menor, por compartilhar o ambiente</td><td class=\"p-3\">Maior durante a internação</td></tr>\n            <tr class=\"bg-slate-50 border-b border-slate-100\"><td class=\"p-3 font-semibold\">Mensalidade</td><td class=\"p-3\">Tende a ser menor no mesmo conjunto de condições</td><td class=\"p-3\">Tende a ser maior</td></tr>\n            <tr class=\"bg-white border-b border-slate-100\"><td class=\"p-3 font-semibold\">Cobertura médica</td><td class=\"p-3\">Definida pela segmentação e contrato</td><td class=\"p-3\">Definida pela segmentação e contrato</td></tr>\n            <tr class=\"bg-slate-50\"><td class=\"p-3 font-semibold\">Rede hospitalar</td><td class=\"p-3\">Precisa ser conferida no produto específico</td><td class=\"p-3\">Também precisa ser conferida; não presuma que seja igual</td></tr>\n          </tbody>\n        </table>\n      </div>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Apartamento oferece atendimento médico melhor?</h2>\n      <p class=\"mb-4\">Não é essa a função da acomodação. O padrão do quarto trata do local de permanência durante a internação. A cobertura assistencial depende da segmentação do plano, do Rol da ANS, das condições contratuais e da indicação clínica.</p>\n      <p class=\"mb-4\">O apartamento pode trazer mais privacidade e conforto, mas não significa automaticamente médico “melhor”, mais exames, cirurgia diferente ou atendimento prioritário. Se duas propostas têm redes diferentes, é preciso separar o efeito da rede do efeito da acomodação.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quem costuma aproveitar mais o apartamento?</h2>\n      <ul class=\"list-none space-y-3 mb-6\">\n        <li class=\"flex items-start gap-2\"><span class=\"text-blue-600 font-black\">→</span><span><strong>Famílias com crianças:</strong> privacidade pode pesar em internações, embora regras de acompanhante também dependam da legislação e do hospital.</span></li>\n        <li class=\"flex items-start gap-2\"><span class=\"text-blue-600 font-black\">→</span><span><strong>Gestantes:</strong> o conforto no período hospitalar pode ter mais valor, desde que o plano tenha cobertura obstétrica e a rede desejada.</span></li>\n        <li class=\"flex items-start gap-2\"><span class=\"text-blue-600 font-black\">→</span><span><strong>Idosos ou pacientes com maior probabilidade de internação:</strong> tranquilidade e privacidade podem justificar a diferença, conforme orçamento.</span></li>\n        <li class=\"flex items-start gap-2\"><span class=\"text-blue-600 font-black\">→</span><span><strong>Quem trabalha ou descansa com dificuldade em ambiente compartilhado:</strong> o quarto individual pode ter valor prático real.</span></li>\n      </ul>\n      <p class=\"mb-4\">Isso não transforma apartamento em obrigação. Uma pessoa jovem, com orçamento limitado e foco em ter acesso à rede desejada pode preferir enfermaria e direcionar a diferença para um produto mais sustentável no longo prazo.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quando a enfermaria pode ser a escolha mais racional?</h2>\n      <p class=\"mb-4\">A enfermaria pode fazer sentido quando a economia na mensalidade é relevante, a rede atende bem à região, o beneficiário aceita compartilhar o quarto e a prioridade é manter o plano sem apertar o orçamento. Plano de saúde é compromisso contínuo; contratar um padrão que se torna impagável depois não ajuda.</p>\n      <p class=\"mb-4\">Para quem quase não utiliza o plano, também é importante comparar a acomodação junto da <a href=\"/blog/o-que-e-coparticipacao-plano-de-saude\" class=\"text-blue-600 font-bold hover:underline\">coparticipação</a>. São decisões diferentes: uma altera custos de uso; a outra define o padrão de internação.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">A rede hospitalar é sempre a mesma?</h2>\n      <p class=\"mb-4\">Não presuma que sim. Algumas operadoras oferecem versões com enfermaria e apartamento dentro da mesma linha; outras vinculam o quarto individual a uma categoria com rede, reembolso ou serviços diferentes. O nome da operadora sozinho não confirma hospitais disponíveis.</p>\n      <p class=\"mb-4\">Antes de fechar, peça a relação atualizada de hospitais do <strong>produto e registro específicos</strong>. Confira também se o estabelecimento aparece para internação, pronto-socorro e especialidades relevantes. Uma marca conhecida pode ter várias redes.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Posso pagar a diferença e ir para apartamento?</h2>\n      <p class=\"mb-4\">Não conte com isso como regra geral. Eventual mudança de acomodação, cobrança de diferença e disponibilidade dependem do contrato, do hospital e das circunstâncias do atendimento. Se o quarto individual é importante para você, o caminho seguro é contratar esse padrão e confirmar como ele aparece na proposta.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">E se não houver leito disponível?</h2>\n      <p class=\"mb-4\">Situações de indisponibilidade são tratadas conforme regras assistenciais, contrato e organização da rede. O beneficiário deve contatar a operadora e guardar protocolos. Não é prudente prometer antecipadamente qual acomodação alternativa será oferecida em todo hospital ou situação.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para comparar as cotações</h2>\n      <ol class=\"list-decimal pl-6 space-y-3 mb-6\">\n        <li>Acomodação coletiva ou individual claramente indicada.</li>\n        <li>Segmentação: ambulatorial, hospitalar com ou sem obstetrícia e demais combinações.</li>\n        <li>Rede hospitalar do produto exato, não apenas da operadora.</li>\n        <li>Abrangência geográfica adequada à rotina.</li>\n        <li>Coparticipação por consulta, exame, terapia e internação, quando houver.</li>\n        <li>Carências, cobertura parcial temporária e regras de portabilidade.</li>\n        <li>Reembolso, se existir, com valores e procedimentos.</li>\n        <li>Diferença mensal e anual entre as duas opções.</li>\n      </ol>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Como decidir sem pagar por um rótulo?</h2>\n      <p class=\"mb-4\">Peça duas propostas comparáveis e faça três contas: diferença mensal, diferença anual e impacto no orçamento se houver reajuste. Depois pergunte quanto a privacidade em uma possível internação vale para sua família.</p>\n      <p class=\"mb-4\">Se o apartamento custa mais, mas cabe com folga e atende uma preferência importante, pode valer. Se a diferença compromete a permanência no plano, a enfermaria com rede adequada pode ser a escolha mais consistente. Para quem está migrando de outro contrato, confira também as regras de <a href=\"/blog/portabilidade-plano-saude-sem-carencia-2026\" class=\"text-blue-600 font-bold hover:underline\">portabilidade sem novas carências</a>.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Conclusão</h2>\n      <p class=\"mb-4\">Enfermaria e apartamento não são sinônimos de plano ruim e plano bom. São padrões de acomodação. A escolha certa depende de orçamento, privacidade desejada, perfil familiar e — principalmente — comparação do produto completo.</p>\n\n      <div class=\"mt-10 bg-[#0d1f3c] text-white p-8 rounded-3xl shadow-xl\">\n        <h3 class=\"text-xl font-black mb-3\">Compare enfermaria e apartamento com os detalhes lado a lado</h3>\n        <p class=\"mb-5 text-slate-200\">A Elevance analisa rede, coparticipação, carências, acomodação e custo para apresentar opções coerentes com seu perfil.</p>\n        <a href=\"https://wa.me/5511920144864?text=Quero%20comparar%20plano%20de%20saude%20enfermaria%20e%20apartamento\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-green-500 hover:bg-green-400 text-white font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a>\n      </div>\n\n      <p class=\"mt-6 text-xs text-slate-500 italic\">Conteúdo informativo. Rede, cobertura, acomodação, aceitação, preço, carências e coparticipação variam conforme operadora, produto, contrato e perfil. Consulte a proposta e as condições contratuais.</p>\n"
  },

  {
    id: 124,
    slug: "seguro-escola-creche-alunos-patrimonio-responsabilidade-civil",
    title: "Seguro para Escola e Creche: Alunos, Patrimônio e Responsabilidade Civil",
    date: "23 Ago, 2026",
    category: "Seguro Empresarial",
    readTime: "11 min",
    image: "https://images.unsplash.com/photo-1509062522246-3755977927d7?auto=format&fit=crop&q=80&w=800",
    excerpt: "Entenda como combinar proteção patrimonial, responsabilidade civil e continuidade da operação em escolas, creches e berçários.",
    content: "\n      <p class=\"mb-4\">Escolas e creches concentram, no mesmo endereço, crianças, famílias, funcionários, equipamentos, cozinha, áreas de recreação e circulação de terceiros. Por isso, escolher o seguro apenas pelo menor preço pode deixar justamente o risco mais sensível fora da apólice.</p>\n      <p class=\"mb-4\">A contratação mais consistente começa separando três frentes: <strong>patrimônio</strong>, <strong>responsabilidade civil</strong> e <strong>continuidade da operação</strong>. Elas se complementam, mas não são equivalentes — e nenhuma cobertura deve ser presumida sem constar na proposta e nas condições contratuais.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Seguro patrimonial e responsabilidade civil: qual é a diferença?</h2>\n      <p class=\"mb-4\">O seguro empresarial protege o interesse da instituição sobre prédio, conteúdo e funcionamento, conforme os bens e coberturas declarados. Já a responsabilidade civil pode amparar indenizações por danos involuntários a terceiros quando o evento estiver coberto e houver responsabilidade do segurado.</p>\n      <div class=\"overflow-x-auto my-8\">\n        <table class=\"w-full border-collapse text-left\">\n          <thead><tr class=\"bg-[#0d1f3c] text-white\"><th class=\"p-3\">Situação</th><th class=\"p-3\">Cobertura a analisar</th><th class=\"p-3\">Ponto de atenção</th></tr></thead>\n          <tbody>\n            <tr class=\"border-b\"><td class=\"p-3\">Incêndio, raio ou explosão</td><td class=\"p-3\">Básica patrimonial</td><td class=\"p-3\">Verificar prédio, móveis, materiais e equipamentos declarados.</td></tr>\n            <tr class=\"border-b bg-slate-50\"><td class=\"p-3\">Curto-circuito em computadores ou ar-condicionado</td><td class=\"p-3\">Danos elétricos</td><td class=\"p-3\">Limite, franquia e definição de equipamentos cobertos.</td></tr>\n            <tr class=\"border-b\"><td class=\"p-3\">Acidente de aluno em área comum</td><td class=\"p-3\">RC operações/estabelecimento</td><td class=\"p-3\">A indenização depende da responsabilidade apurada e das condições da apólice.</td></tr>\n            <tr class=\"border-b bg-slate-50\"><td class=\"p-3\">Dano relacionado a atividade técnica ou educacional</td><td class=\"p-3\">RC profissional, quando aplicável</td><td class=\"p-3\">Nem toda apólice empresarial inclui atos profissionais.</td></tr>\n            <tr class=\"border-b\"><td class=\"p-3\">Interdição após sinistro coberto</td><td class=\"p-3\">Lucros cessantes ou despesas fixas</td><td class=\"p-3\">Normalmente depende de dano material indenizável e período contratado.</td></tr>\n          </tbody>\n        </table>\n      </div>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quais coberturas uma escola ou creche deve comparar?</h2>\n      <h3 class=\"text-[#0d1f3c] font-bold mt-6 mb-3 text-xl\">1. Incêndio e danos ao patrimônio</h3>\n      <p class=\"mb-4\">A cobertura básica costuma ser o ponto de partida, mas o valor segurado precisa refletir o que efetivamente está em risco: edificação, mobiliário, brinquedos, computadores, projetores, aparelhos de ar-condicionado, equipamentos de cozinha e materiais pedagógicos. Se o imóvel for alugado, convém conferir as responsabilidades previstas no contrato de locação.</p>\n      <h3 class=\"text-[#0d1f3c] font-bold mt-6 mb-3 text-xl\">2. Danos elétricos, equipamentos e vidros</h3>\n      <p class=\"mb-4\">Laboratórios, salas multimídia, portões eletrônicos, sistemas de segurança e climatização elevam a exposição a danos elétricos. Vidros, letreiros e painéis podem exigir cobertura própria. Compare limites e franquias; um limite muito baixo pode não acompanhar o custo de reposição.</p>\n      <h3 class=\"text-[#0d1f3c] font-bold mt-6 mb-3 text-xl\">3. Subtração de bens</h3>\n      <p class=\"mb-4\">Roubo e furto qualificado não devem ser tratados como sinônimos de qualquer desaparecimento. A definição do evento, os vestígios exigidos, os bens aceitos e as proteções mínimas do local variam por produto. Equipamentos portáteis merecem declaração clara.</p>\n      <h3 class=\"text-[#0d1f3c] font-bold mt-6 mb-3 text-xl\">4. Responsabilidade civil da operação</h3>\n      <p class=\"mb-4\">Quedas, acidentes em playground, danos durante entrada e saída e ocorrências em eventos podem gerar reclamações. A apólice deve refletir número de alunos, faixa etária, horários, atividades, instalações e circulação de visitantes. Na creche, trocas, alimentação, repouso e recreação tornam a descrição da rotina ainda mais importante.</p>\n      <h3 class=\"text-[#0d1f3c] font-bold mt-6 mb-3 text-xl\">5. Empregador e prestadores terceirizados</h3>\n      <p class=\"mb-4\">A RC empregador é diferente da RC perante alunos e visitantes. Limpeza, segurança, cantina e manutenção terceirizadas também precisam ser informadas. O seguro do contratado não substitui automaticamente a proteção da escola, e vice-versa.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Passeios, eventos e transporte escolar entram automaticamente?</h2>\n      <p class=\"mb-4\"><strong>Não é seguro presumir.</strong> Excursões, festas, atividades esportivas fora do endereço e transporte podem depender de extensão territorial, comunicação prévia ou contratação específica. Veículos próprios exigem análise de seguro auto e proteção adequada aos passageiros. Quando o transporte é terceirizado, verifique documentos, contrato e seguro do prestador.</p>\n      <p class=\"mb-4\">Se a instituição realiza muitas atividades físicas, vale comparar também os critérios usados em seguros para academias e espaços esportivos. Veja nosso guia sobre <a class=\"text-blue-700 underline\" href=\"/blog/seguro-para-academia-equipamentos-responsabilidade-civil\">seguro para academia e responsabilidade civil</a>.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Cantina, cozinha e alimentos: o que informar?</h2>\n      <p class=\"mb-4\">Cozinha própria, gás, fritadeiras, câmaras frias e venda de alimentos alteram o perfil do risco. Além da proteção patrimonial, podem existir exposições por produtos e serviços. Informe se a operação é própria ou terceirizada, quais equipamentos existem e se há armazenamento refrigerado. Deterioração de mercadorias, quando disponível, costuma ter condições e causas específicas.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Dados de alunos e famílias também representam risco</h2>\n      <p class=\"mb-4\">Matrículas, fichas de saúde, imagens, contatos e informações financeiras tornam escolas e creches alvos relevantes de fraude e incidentes digitais. O seguro empresarial tradicional não substitui uma cobertura cibernética. Entenda as diferenças no artigo sobre <a class=\"text-blue-700 underline\" href=\"/blog/seguro-cibernetico-para-pequenas-empresas-coberturas\">seguro cibernético para pequenas empresas</a>.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para pedir cotações comparáveis</h2>\n      <ul class=\"list-disc pl-6 mb-4 space-y-2\">\n        <li>tipo de instituição, CNPJ, endereço e situação do imóvel;</li>\n        <li>número de alunos, faixa etária, turnos e quantidade de funcionários;</li>\n        <li>atividades extracurriculares, playground, quadra, piscina e eventos;</li>\n        <li>transporte próprio ou terceirizado e frequência de passeios;</li>\n        <li>cozinha, cantina, gás e equipamentos de refrigeração;</li>\n        <li>valores de prédio, conteúdo, eletrônicos e equipamentos especiais;</li>\n        <li>histórico de sinistros, medidas de segurança e prevenção;</li>\n        <li>limites desejados para RC, danos elétricos, subtração e paralisação.</li>\n      </ul>\n      <p class=\"mb-4\">Ao comparar propostas, confira ainda franquias, participações obrigatórias, riscos excluídos, território, retroatividade quando houver e documentos exigidos em eventual sinistro. Duas apólices com preço semelhante podem oferecer proteções muito diferentes.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Para quem esse seguro faz mais sentido?</h2>\n      <p class=\"mb-4\">A análise é especialmente importante para creches, berçários, escolas de educação infantil, ensino fundamental e médio, cursos livres, escolas de idiomas e instituições com atividades esportivas ou transporte. O desenho muda conforme idade dos alunos, estrutura e serviços — não existe uma configuração única que sirva para todos.</p>\n\n      <div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\">\n        <h2 class=\"text-2xl font-black mb-3\">Compare o seguro da sua escola com apoio especializado</h2>\n        <p class=\"mb-5\">A Elevance ajuda a organizar as informações do risco e comparar limites, franquias e coberturas de propostas disponíveis para o perfil da instituição.</p>\n        <a href=\"https://wa.me/5511920144864?text=Ol%C3%A1%2C%20quero%20cotar%20seguro%20para%20escola%20ou%20creche\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a>\n      </div>\n\n      <p class=\"text-sm text-slate-600 mb-4\"><strong>Aviso:</strong> coberturas, limites, franquias, carências e exclusões variam por seguradora e produto. A indenização depende da análise do sinistro e das condições gerais e particulares da apólice.</p>\n      <p class=\"text-sm text-slate-600\">Referências: <a class=\"text-blue-700 underline\" target=\"_blank\" rel=\"noopener noreferrer\" href=\"https://www.gov.br/susep/pt-br/copy_of_planos-e-produtos/seguros/seguro-compreensivo\">Susep — seguro compreensivo</a> e <a class=\"text-blue-700 underline\" target=\"_blank\" rel=\"noopener noreferrer\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-responsabilidade-civil\">Susep — seguro de responsabilidade civil</a>.</p>\n"
  },

  {
    id: 125,
    slug: "seguro-oficina-mecanica-auto-center-veiculos-clientes",
    title: "Seguro para Oficina Mecânica e Auto Center: Veículos de Clientes, Equipamentos e RC",
    date: "24 Ago, 2026",
    category: "Seguro Empresarial",
    readTime: "12 min",
    image: "https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?auto=format&fit=crop&q=80&w=800",
    excerpt: "Veja como proteger máquinas, ferramentas e veículos de clientes e o que comparar na responsabilidade civil de oficinas e centros automotivos.",
    content: "\n      <p class=\"mb-4\">Uma oficina pode ter elevadores, scanners, ferramentas, estoque de peças e vários carros de clientes no mesmo endereço. Ainda assim, é comum a cotação ser feita apenas pelo valor do prédio e do conteúdo. O problema aparece quando ocorre um incêndio, uma queda no elevador, uma colisão durante o teste ou o desaparecimento de um veículo sob guarda.</p>\n      <p class=\"mb-4\">Para uma proteção coerente, é preciso separar <strong>patrimônio da oficina</strong>, <strong>danos causados a terceiros</strong>, <strong>veículos confiados ao estabelecimento</strong> e <strong>interrupção da atividade</strong>. Essas frentes não são automaticamente equivalentes e precisam constar da proposta e da apólice.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Seguro empresarial comum cobre carros de clientes?</h2>\n      <p class=\"mb-4\"><strong>Não se deve presumir que sim.</strong> A cobertura patrimonial protege os bens e interesses declarados da empresa dentro das condições contratadas. O automóvel entregue pelo cliente é um bem de terceiro sob guarda, custódia ou controle da oficina, situação que pode exigir responsabilidade civil específica para garagistas, oficinas ou estabelecimentos similares.</p>\n      <p class=\"mb-4\">Uma cobertura genérica de responsabilidade civil também pode excluir bens confiados ao segurado. Por isso, a pergunta correta não é apenas “tem RC?”, mas: <strong>o contrato contempla veículos de clientes enquanto estão na oficina, no pátio e em deslocamentos autorizados?</strong></p>\n\n      <div class=\"overflow-x-auto my-8\">\n        <table class=\"w-full border-collapse text-left\">\n          <thead><tr class=\"bg-[#0d1f3c] text-white\"><th class=\"p-3\">Situação</th><th class=\"p-3\">Cobertura a analisar</th><th class=\"p-3\">O que comparar</th></tr></thead>\n          <tbody>\n            <tr class=\"border-b\"><td class=\"p-3\">Incêndio danifica prédio e ferramentas</td><td class=\"p-3\">Patrimonial básica</td><td class=\"p-3\">Valores de prédio, conteúdo, máquinas e estoque.</td></tr>\n            <tr class=\"border-b bg-slate-50\"><td class=\"p-3\">Carro cai do elevador</td><td class=\"p-3\">RC para veículos sob guarda</td><td class=\"p-3\">Operações cobertas, limite, franquia e exclusões.</td></tr>\n            <tr class=\"border-b\"><td class=\"p-3\">Funcionário bate o carro em teste</td><td class=\"p-3\">Extensão para circulação/teste</td><td class=\"p-3\">Quem pode dirigir, trajeto, finalidade e território.</td></tr>\n            <tr class=\"border-b bg-slate-50\"><td class=\"p-3\">Scanner ou compressor queima</td><td class=\"p-3\">Danos elétricos ou equipamentos</td><td class=\"p-3\">Bens aceitos, causa do dano, limite e franquia.</td></tr>\n            <tr class=\"border-b\"><td class=\"p-3\">Oficina para após sinistro coberto</td><td class=\"p-3\">Lucros cessantes/despesas fixas</td><td class=\"p-3\">Período indenitário e vínculo com dano material.</td></tr>\n          </tbody>\n        </table>\n      </div>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quais coberturas uma oficina deve comparar?</h2>\n      <h3 class=\"text-[#0d1f3c] font-bold mt-6 mb-3 text-xl\">1. Incêndio, raio e explosão</h3>\n      <p class=\"mb-4\">Óleos, combustíveis residuais, solda, baterias, instalações elétricas e produtos inflamáveis influenciam a avaliação do risco. O valor segurado deve considerar reconstrução, máquinas, ferramentas, computadores, mobiliário e estoque pertencente à empresa. Melhorias em imóvel alugado também merecem atenção.</p>\n      <h3 class=\"text-[#0d1f3c] font-bold mt-6 mb-3 text-xl\">2. Danos elétricos e quebra de equipamentos</h3>\n      <p class=\"mb-4\">Elevadores automotivos, alinhadores, balanceadoras, compressores, scanners e sistemas eletrônicos podem representar boa parte do investimento. Danos elétricos não significam cobertura para qualquer defeito mecânico, desgaste ou falta de manutenção. Compare a definição do evento coberto e as exigências de conservação.</p>\n      <h3 class=\"text-[#0d1f3c] font-bold mt-6 mb-3 text-xl\">3. Subtração de ferramentas, peças e equipamentos</h3>\n      <p class=\"mb-4\">Roubo, furto qualificado e simples desaparecimento são situações diferentes. A apólice pode exigir sinais de arrombamento, relação dos bens, notas fiscais e proteções mínimas. Ferramentas portáteis, pneus, rodas e peças de alto valor precisam ser declarados corretamente.</p>\n      <h3 class=\"text-[#0d1f3c] font-bold mt-6 mb-3 text-xl\">4. Responsabilidade civil de operações</h3>\n      <p class=\"mb-4\">Além dos veículos, clientes, fornecedores e vizinhos podem sofrer danos ligados à atividade. Um vazamento, uma peça mal acondicionada, uma queda na área de atendimento ou dano a imóvel vizinho pode gerar reclamação. A cobertura depende da responsabilidade apurada e das condições contratadas.</p>\n      <h3 class=\"text-[#0d1f3c] font-bold mt-6 mb-3 text-xl\">5. Veículos sob guarda, custódia ou controle</h3>\n      <p class=\"mb-4\">Essa é a parte mais sensível. Confira se há proteção no interior do estabelecimento, pátio fechado, área externa autorizada e durante manobras. Pergunte expressamente sobre incêndio, colisão, subtração, fenômenos naturais e danos provocados durante o serviço. Nem todo produto reúne todos esses eventos.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Teste de rua e leva-e-traz exigem atenção</h2>\n      <p class=\"mb-4\">Se mecânicos dirigem os veículos para diagnóstico, teste ou entrega, essa rotina precisa aparecer na proposta. A seguradora pode definir condutores habilitados, raio de circulação, horário, finalidade e controle de chaves. O seguro auto do cliente não substitui automaticamente a responsabilidade da oficina, assim como a apólice da oficina não substitui o seguro individual do automóvel.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Oficina, funilaria, autoelétrica e centro automotivo têm o mesmo risco?</h2>\n      <p class=\"mb-4\">Não. Uma troca de óleo tem exposição diferente de funilaria com cabine de pintura, solda e armazenamento de produtos inflamáveis. Autoelétricas trabalham intensamente com baterias e circuitos; centros automotivos podem guardar pneus e operar vários elevadores; oficinas de motos ou veículos pesados mudam valores e características dos bens confiados.</p>\n      <p class=\"mb-4\">Descrever a atividade apenas como “serviços automotivos” pode esconder diferenças relevantes. Informe todas as operações, inclusive lavagem, estacionamento, venda de peças, guincho, instalação de acessórios e atendimento móvel.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Poluição e descarte de resíduos entram no seguro?</h2>\n      <p class=\"mb-4\">Óleo usado, solventes, fluidos, baterias e resíduos podem causar contaminação. Responsabilidade ambiental e custos de limpeza não devem ser presumidos dentro da RC operacional. Se essa exposição for relevante, peça análise específica e mantenha armazenamento, coleta e documentação de destinação conforme as regras aplicáveis.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Como calcular os limites sem chutar</h2>\n      <ul class=\"list-disc pl-6 mb-4 space-y-2\">\n        <li>some máquinas, ferramentas, estoque, mobiliário e eletrônicos pelo valor de reposição;</li>\n        <li>levante o maior número de veículos simultaneamente sob guarda;</li>\n        <li>considere o valor médio e o maior valor individual dos carros atendidos;</li>\n        <li>estime faturamento, margem e despesas fixas para o período de paralisação;</li>\n        <li>registre benfeitorias feitas no imóvel e responsabilidades do contrato de locação;</li>\n        <li>informe sinistros anteriores, sistemas de alarme, câmeras, cercas e controle de chaves.</li>\n      </ul>\n      <p class=\"mb-4\">Uma oficina com cinco carros populares tem necessidade diferente de outra que recebe veículos premium ou mantém dezenas de automóveis no pátio. Limite baixo pode reduzir o prêmio, mas também deixar a maior exposição sem proteção suficiente.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist antes de contratar</h2>\n      <ul class=\"list-disc pl-6 mb-4 space-y-2\">\n        <li>a razão social e todas as atividades estão corretas?</li>\n        <li>veículos de terceiros estão expressamente contemplados?</li>\n        <li>manobras, testes de rua e leva-e-traz estão descritos?</li>\n        <li>há limites separados ou compartilhados entre coberturas?</li>\n        <li>quais são as franquias e participações obrigatórias?</li>\n        <li>existem exigências de vigilância, pátio fechado ou guarda de chaves?</li>\n        <li>quais bens, eventos e tipos de veículo estão excluídos?</li>\n        <li>lucros cessantes dependem de qual dano material coberto?</li>\n      </ul>\n\n      <p class=\"mb-4\">Se a oficina também coleta dados de clientes, agenda serviços on-line ou depende de sistemas para orçamento, vale conhecer o guia sobre <a class=\"text-blue-700 underline\" href=\"/blog/seguro-cibernetico-para-pequenas-empresas-coberturas\">seguro cibernético para pequenas empresas</a>. Para entender a proteção do próprio automóvel, veja também <a class=\"text-blue-700 underline\" href=\"/blog/seguro-auto-cobre-enchente-alagamento\">quando o seguro auto pode cobrir enchente e alagamento</a>.</p>\n\n      <div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\">\n        <h2 class=\"text-2xl font-black mb-3\">Sua oficina recebe veículos de clientes?</h2>\n        <p class=\"mb-5\">A Elevance ajuda a organizar o risco e comparar coberturas, limites, franquias e condições adequadas à atividade real da oficina ou auto center.</p>\n        <a href=\"https://wa.me/5511920144864?text=Ol%C3%A1%2C%20quero%20cotar%20seguro%20para%20oficina%20ou%20auto%20center\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a>\n      </div>\n\n      <p class=\"text-sm text-slate-600 mb-4\"><strong>Aviso:</strong> coberturas, limites, franquias e exclusões variam entre seguradoras e produtos. A indenização depende da análise do evento e das condições gerais e particulares da apólice.</p>\n      <p class=\"text-sm text-slate-600\">Referências: <a class=\"text-blue-700 underline\" target=\"_blank\" rel=\"noopener noreferrer\" href=\"https://www.gov.br/susep/pt-br/copy_of_planos-e-produtos/seguros/seguro-compreensivo\">Susep — seguro compreensivo</a> e <a class=\"text-blue-700 underline\" target=\"_blank\" rel=\"noopener noreferrer\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-responsabilidade-civil\">Susep — seguro de responsabilidade civil</a>.</p>\n"
  },

  {
    id: 126,
    slug: "seguro-imobiliaria-corretor-imoveis-rc-profissional",
    title: "Seguro para Imobiliária e Corretor de Imóveis: RC Profissional, Escritório e Dados",
    date: "25 Ago, 2026",
    category: "Responsabilidade Civil",
    readTime: "12 min",
    image: "https://images.unsplash.com/photo-1560518883-ce09059eeffa?auto=format&fit=crop&q=80&w=800",
    excerpt: "Entenda as diferenças entre RC profissional, seguro empresarial e proteção cibernética para imobiliárias e corretores de imóveis.",
    content: "\n      <p class=\"mb-4\">Uma imobiliária pode administrar dezenas de contratos, receber documentos, anunciar imóveis, guardar chaves e orientar clientes em decisões de alto valor. Um erro de informação, perda de prazo ou falha documental pode gerar reclamação mesmo quando não houve má-fé.</p>\n      <p class=\"mb-4\">O ponto central é separar três riscos: <strong>a prestação do serviço profissional</strong>, <strong>o patrimônio físico do escritório</strong> e <strong>os dados de proprietários, compradores e inquilinos</strong>. Um único seguro nem sempre reúne tudo, e a contratação precisa refletir quem presta o serviço: corretor pessoa física, imobiliária ou ambos.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">O que é RC profissional para imobiliária e corretor?</h2>\n      <p class=\"mb-4\">O seguro de responsabilidade civil profissional pode amparar reclamações de terceiros relacionadas a falhas involuntárias na prestação do serviço, dentro das atividades, datas, limites e condições contratadas. Ele não elimina a responsabilidade do profissional nem transforma todo desentendimento comercial em sinistro coberto.</p>\n      <p class=\"mb-4\">Na prática, a análise pode envolver alegações de erro, omissão, informação inexata, falha na conferência documental ou perda de prazo. A cobertura efetiva depende do produto disponível e de como a atividade foi declarada na proposta.</p>\n\n      <div class=\"overflow-x-auto my-8\">\n        <table class=\"w-full border-collapse text-left\">\n          <thead><tr class=\"bg-[#0d1f3c] text-white\"><th class=\"p-3\">Exposição</th><th class=\"p-3\">Proteção a analisar</th><th class=\"p-3\">Ponto de atenção</th></tr></thead>\n          <tbody>\n            <tr class=\"border-b\"><td class=\"p-3\">Alegação de erro na prestação do serviço</td><td class=\"p-3\">RC profissional</td><td class=\"p-3\">Atividades declaradas, exclusões e data de retroatividade.</td></tr>\n            <tr class=\"border-b bg-slate-50\"><td class=\"p-3\">Dano corporal ou material no escritório</td><td class=\"p-3\">RC operações</td><td class=\"p-3\">Não é a mesma cobertura dos atos profissionais.</td></tr>\n            <tr class=\"border-b\"><td class=\"p-3\">Incêndio, dano elétrico ou subtração</td><td class=\"p-3\">Seguro empresarial</td><td class=\"p-3\">Prédio, conteúdo, computadores e benfeitorias.</td></tr>\n            <tr class=\"border-b bg-slate-50\"><td class=\"p-3\">Vazamento de documentos e dados pessoais</td><td class=\"p-3\">Seguro cibernético</td><td class=\"p-3\">Resposta a incidente, terceiros e restauração, se contratados.</td></tr>\n            <tr class=\"border-b\"><td class=\"p-3\">Decisão de administrador da empresa</td><td class=\"p-3\">D&O, conforme o perfil</td><td class=\"p-3\">É diferente do erro na atividade de corretagem.</td></tr>\n          </tbody>\n        </table>\n      </div>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">RC profissional e seguro empresarial são a mesma coisa?</h2>\n      <p class=\"mb-4\"><strong>Não.</strong> O seguro empresarial é voltado principalmente ao patrimônio e à operação do estabelecimento. Pode incluir incêndio, danos elétricos, subtração, vidros, equipamentos e responsabilidade civil no local. Já o RC profissional trata das consequências de alegadas falhas na prestação do serviço especificado.</p>\n      <p class=\"mb-4\">Uma imobiliária instalada em sala comercial pode precisar dos dois. Se um computador queima, a discussão é patrimonial. Se um cliente afirma ter sofrido prejuízo por uma informação profissional incorreta, a análise é outra.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quais situações merecem atenção na cotação?</h2>\n      <h3 class=\"text-[#0d1f3c] font-bold mt-6 mb-3 text-xl\">Documentos e informações do imóvel</h3>\n      <p class=\"mb-4\">Matrícula, certidões, procurações, laudos, cadastros, condições de locação e informações do anúncio passam por várias pessoas. O seguro não substitui procedimentos de conferência, mas a proposta deve explicar quais serviços a empresa executa e quais terceiros participam do processo.</p>\n      <h3 class=\"text-[#0d1f3c] font-bold mt-6 mb-3 text-xl\">Prazos, repasses e administração de locações</h3>\n      <p class=\"mb-4\">Administração de imóveis, cobrança, repasse, vistoria, renovação e comunicação entre proprietário e inquilino ampliam a exposição. Informe se a empresa apenas intermedeia vendas e locações ou também administra contratos, valores e manutenção.</p>\n      <h3 class=\"text-[#0d1f3c] font-bold mt-6 mb-3 text-xl\">Chaves e acesso aos imóveis</h3>\n      <p class=\"mb-4\">Guardar chaves ou permitir visitas cria risco de perda, acesso indevido e dano ao imóvel. Bens sob custódia ou controle podem ter tratamento específico ou exclusões. Pergunte expressamente como o produto trata chaves, documentos e bens confiados.</p>\n      <h3 class=\"text-[#0d1f3c] font-bold mt-6 mb-3 text-xl\">Anúncios, fotos e material de divulgação</h3>\n      <p class=\"mb-4\">Uso de imagens, descrições, metragem, características e localização pode gerar conflito. Direitos autorais, publicidade e promessas comerciais nem sempre estão contemplados. A imobiliária deve manter autorização, origem dos dados e histórico de alterações.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Custos de defesa e danos morais entram automaticamente?</h2>\n      <p class=\"mb-4\">Não. Custos de defesa, honorários, acordos, danos morais e diferentes tipos de prejuízo podem depender de cobertura específica, sublimite e anuência da seguradora. A própria Susep alerta que danos morais são frequentemente tratados como risco excluído, embora alguns produtos possam oferecê-los como adicional.</p>\n      <p class=\"mb-4\">Compare também se a apólice trabalha por reclamação, quando o fato precisa ter ocorrido e quando a reclamação deve ser apresentada. Esses detalhes são tão importantes quanto o limite financeiro.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">O que são retroatividade e vigência no RC profissional?</h2>\n      <p class=\"mb-4\">Em produtos estruturados na base de reclamações, pode existir uma data retroativa: atos praticados depois dessa data podem ser analisados se a reclamação surgir durante a vigência ou período adicional previsto. Fatos conhecidos antes da contratação, reclamações já esperadas e informações omitidas tendem a não ser aceitos.</p>\n      <p class=\"mb-4\">Ao trocar de seguradora ou interromper a apólice, não olhe somente o preço do novo contrato. Verifique continuidade da data retroativa, prazo complementar e suplementar, quando disponíveis, para não criar uma lacuna entre o trabalho passado e uma reclamação futura.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Corretor autônomo e imobiliária precisam da mesma apólice?</h2>\n      <p class=\"mb-4\">Não necessariamente. O profissional autônomo deve declarar suas atividades, faturamento e histórico. A imobiliária precisa informar equipe, prestadores, filiais, administração de locações e volume de negócios. É essencial conferir quem aparece como segurado: somente a pessoa jurídica, sócios, corretores vinculados ou profissionais individualmente nomeados.</p>\n      <p class=\"mb-4\">Se corretores atuam como pessoas jurídicas independentes, não se deve presumir que estejam incluídos na apólice da imobiliária. A relação contratual e a abrangência do seguro precisam ser compatíveis.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Dados pessoais são um risco separado</h2>\n      <p class=\"mb-4\">Imobiliárias armazenam documentos de identidade, comprovantes de renda, dados bancários, contratos, assinaturas e contatos. Phishing, invasão de e-mail, ransomware e envio ao destinatário errado podem interromper a operação e atingir terceiros. RC profissional não substitui automaticamente proteção cibernética.</p>\n      <p class=\"mb-4\">Veja o guia da Elevance sobre <a class=\"text-blue-700 underline\" href=\"/blog/seguro-cibernetico-para-pequenas-empresas-coberturas\">seguro cibernético para pequenas empresas</a> e o comparativo sobre <a class=\"text-blue-700 underline\" href=\"/blog/seguro-empresarial-cobre-equipamentos-eletronicos\">proteção de equipamentos eletrônicos no seguro empresarial</a>.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para solicitar propostas comparáveis</h2>\n      <ul class=\"list-disc pl-6 mb-4 space-y-2\">\n        <li>CNPJ, tempo de atividade, faturamento e número de profissionais;</li>\n        <li>corretagem de venda, locação, administração, vistoria e avaliação realizadas;</li>\n        <li>volume e perfil dos imóveis negociados ou administrados;</li>\n        <li>existência de filiais, corretores autônomos e prestadores terceirizados;</li>\n        <li>histórico de reclamações, processos ou fatos que possam gerar reclamação;</li>\n        <li>limite de RC desejado, franquia e cobertura de custos de defesa;</li>\n        <li>data de retroatividade e regras para renovação ou troca de seguradora;</li>\n        <li>danos morais, perda de documentos, custódia de chaves e publicidade;</li>\n        <li>computadores, mobiliário, benfeitorias e medidas de segurança digital.</li>\n      </ul>\n      <p class=\"mb-4\">Preço só é comparável quando segurados, atividades, limites, datas e exclusões também são comparáveis. Uma proposta mais barata pode simplesmente estar protegendo menos profissionais ou menos serviços.</p>\n\n      <div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\">\n        <h2 class=\"text-2xl font-black mb-3\">Quer comparar a proteção da sua imobiliária?</h2>\n        <p class=\"mb-5\">A Elevance ajuda a organizar as atividades e comparar RC profissional, seguro empresarial e proteção cibernética conforme o perfil real da operação.</p>\n        <a href=\"https://wa.me/5511920144864?text=Ol%C3%A1%2C%20quero%20cotar%20seguro%20para%20imobili%C3%A1ria%20ou%20corretor%20de%20im%C3%B3veis\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a>\n      </div>\n\n      <p class=\"text-sm text-slate-600 mb-4\"><strong>Aviso:</strong> a oferta, abrangência, limites, franquias, retroatividade e exclusões variam conforme seguradora, produto e análise de risco. A indenização depende das condições da apólice e da análise da reclamação.</p>\n      <p class=\"text-sm text-slate-600\">Referências: <a class=\"text-blue-700 underline\" target=\"_blank\" rel=\"noopener noreferrer\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-responsabilidade-civil\">Susep — seguro de responsabilidade civil</a> e <a class=\"text-blue-700 underline\" target=\"_blank\" rel=\"noopener noreferrer\" href=\"https://www.gov.br/susep/pt-br/copy_of_planos-e-produtos/seguros/seguro-compreensivo\">Susep — seguro compreensivo</a>.</p>\n"
  },

  {
    id: 127,
    slug: "seguro-loja-roupas-estoque-vitrine-roubo",
    title: "Seguro para Loja de Roupas: Estoque, Vitrine, Roubo e Lucros Cessantes",
    date: "26 Ago, 2026",
    category: "Seguro Empresarial",
    readTime: "12 min",
    image: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&q=80&w=800",
    excerpt: "Veja como proteger estoque sazonal, vitrines, equipamentos e faturamento de lojas físicas e operações de moda com vendas on-line.",
    content: "\n      <p class=\"mb-4\">Uma loja de roupas pode concentrar centenas de milhares de reais em estoque dentro de um espaço relativamente pequeno. Em períodos como troca de coleção, Black Friday e fim de ano, esse valor sobe rapidamente — mas a apólice nem sempre acompanha.</p>\n      <p class=\"mb-4\">Para contratar bem, é preciso olhar além da cobertura básica contra incêndio. <strong>Estoque sazonal, vitrines, subtração, danos elétricos, água, vendas on-line e paralisação</strong> formam riscos diferentes, com limites e condições próprias.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">O seguro empresarial cobre todo o estoque?</h2>\n      <p class=\"mb-4\">Somente até os limites contratados e dentro dos eventos cobertos. O valor informado deve refletir o custo de reposição das mercadorias pertencentes à empresa, não apenas uma média baixa do ano. Se a loja dobra o estoque em datas comerciais, vale verificar se a seguradora oferece ajuste, verba adicional ou comunicação de aumento temporário.</p>\n      <p class=\"mb-4\">Mercadoria em consignação, peças de terceiros, produtos deixados para troca e bens guardados em outro endereço precisam ser declarados. Não se deve presumir que tudo que está fisicamente na loja integra automaticamente a cobertura.</p>\n\n      <div class=\"overflow-x-auto my-8\">\n        <table class=\"w-full border-collapse text-left\">\n          <thead><tr class=\"bg-[#0d1f3c] text-white\"><th class=\"p-3\">Risco</th><th class=\"p-3\">Cobertura a analisar</th><th class=\"p-3\">Ponto de atenção</th></tr></thead>\n          <tbody>\n            <tr class=\"border-b\"><td class=\"p-3\">Incêndio atinge loja e mercadorias</td><td class=\"p-3\">Básica patrimonial</td><td class=\"p-3\">Prédio, benfeitorias, conteúdo e estoque declarados.</td></tr>\n            <tr class=\"border-b bg-slate-50\"><td class=\"p-3\">Arrombamento e retirada de peças</td><td class=\"p-3\">Subtração de bens</td><td class=\"p-3\">Definição de roubo/furto, vestígios, limite e proteções mínimas.</td></tr>\n            <tr class=\"border-b\"><td class=\"p-3\">Quebra da vitrine</td><td class=\"p-3\">Vidros, anúncios e letreiros</td><td class=\"p-3\">Tipo, dimensões, instalação e franquia.</td></tr>\n            <tr class=\"border-b bg-slate-50\"><td class=\"p-3\">Curto danifica computadores e iluminação</td><td class=\"p-3\">Danos elétricos</td><td class=\"p-3\">Bens aceitos e exclusão de desgaste ou manutenção.</td></tr>\n            <tr class=\"border-b\"><td class=\"p-3\">Loja fecha após sinistro coberto</td><td class=\"p-3\">Lucros cessantes/despesas fixas</td><td class=\"p-3\">Período indenitário e dependência de dano material.</td></tr>\n          </tbody>\n        </table>\n      </div>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Roubo, furto qualificado e furto simples: por que a diferença importa?</h2>\n      <p class=\"mb-4\">A expressão “seguro contra roubo” costuma simplificar demais. Roubo envolve grave ameaça ou violência; furto qualificado pode depender de arrombamento ou outras circunstâncias previstas; desaparecimento sem vestígios pode ser excluído. Cada apólice define os eventos aceitos e os documentos necessários.</p>\n      <p class=\"mb-4\">Lojas em shopping, rua, galeria e prédio comercial têm proteções e acessos diferentes. Informe grades, alarme, câmeras, vigilância, portas, vitrines e como as chaves são controladas. Declarar uma medida de segurança que não existe pode comprometer a análise do sinistro.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Vitrine e fachada entram na cobertura básica?</h2>\n      <p class=\"mb-4\"><strong>Nem sempre.</strong> Vidros, espelhos, letreiros, painéis e comunicação visual podem exigir cobertura adicional. Uma vitrine grande ou com vidro especial custa muito mais do que o limite padrão de alguns produtos. Compare também mão de obra, instalação e peças decorativas.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Danos por água, chuva e alagamento são a mesma coisa?</h2>\n      <p class=\"mb-4\">Não. Vazamento interno, ruptura de tubulação, infiltração, chuva pela fachada e alagamento externo podem ter tratamentos distintos. Estoque de roupas é especialmente sensível à água, umidade, fumaça e odor. Pergunte quais causas estão cobertas e como a mercadoria danificada será avaliada.</p>\n      <p class=\"mb-4\">Se a loja fica em condomínio ou shopping, o seguro do empreendimento não substitui automaticamente a proteção do lojista. A apólice do prédio pode não cobrir estoque, benfeitorias, mobiliário ou perda de faturamento da operação individual.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Lucros cessantes: quanto tempo sua loja suportaria fechada?</h2>\n      <p class=\"mb-4\">Depois de um incêndio ou outro dano coberto, reconstruir a loja, repor estoque e obter autorizações pode levar semanas ou meses. A cobertura de lucros cessantes ou despesas fixas pode ajudar durante o período contratado, mas normalmente depende de um dano material indenizável.</p>\n      <p class=\"mb-4\">Para dimensionar, levante faturamento, margem, folha, aluguel, condomínio, financiamentos e prazo realista de retomada. Dez dias podem ser insuficientes para uma loja com reforma complexa; um limite anual alto pode ser desnecessário para operação que reabre rapidamente em outro ponto.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Responsabilidade civil com clientes e funcionários</h2>\n      <p class=\"mb-4\">Queda de cliente, arara que tomba, provador com defeito ou dano causado durante atendimento pode gerar reclamação. RC operações é diferente de RC empregador. Se há costura, ajustes, eventos, desfiles ou serviço fora do endereço, essas atividades também precisam ser informadas.</p>\n      <p class=\"mb-4\">Danos morais, custos de defesa e bens de clientes podem depender de previsão específica. Confira limites e exclusões em vez de considerar que “RC” cobre qualquer situação.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">E-commerce da própria loja está protegido?</h2>\n      <p class=\"mb-4\">Vender pelo site ou redes sociais adiciona riscos. Estoque em centro de distribuição, mercadoria em trânsito, fraude de pagamento, invasão de conta e vazamento de dados não entram automaticamente no seguro do ponto físico.</p>\n      <p class=\"mb-4\">Mercadorias enviadas por transportadora podem depender de seguro de transporte. Sistemas, dados e resposta a incidentes pedem análise cibernética. Veja os guias sobre <a class=\"text-blue-700 underline\" href=\"/blog/seguro-cibernetico-para-pequenas-empresas-coberturas\">seguro cibernético para pequenas empresas</a> e <a class=\"text-blue-700 underline\" href=\"/blog/seguro-transporte-carga-embarcador-vs-transportadora\">seguro de transporte para embarcador e transportadora</a>.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Loja de rua e loja em shopping precisam da mesma proteção?</h2>\n      <p class=\"mb-4\">Não. Na rua, fachada, acesso direto, alagamento e medidas próprias de segurança pesam mais. No shopping, existem regras do condomínio, fundo de promoção, horários, sistemas coletivos e exigências contratuais. Mesmo assim, o lojista continua exposto em estoque, conteúdo, responsabilidade civil e perda de faturamento.</p>\n      <p class=\"mb-4\">Franquias, quiosques, outlets e lojas temporárias também precisam declarar corretamente marca, estrutura, localização e duração da operação. Quiosques abertos podem ter restrições diferentes de lojas fechadas.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Como calcular o valor do estoque</h2>\n      <ol class=\"list-decimal pl-6 mb-4 space-y-2\">\n        <li>use relatórios do sistema e notas para apurar o custo de reposição;</li>\n        <li>separe estoque próprio, consignado e mercadoria de terceiros;</li>\n        <li>considere coleção atual, peças no depósito e mercadorias em outros endereços;</li>\n        <li>identifique o pico de estoque do ano, não apenas a média;</li>\n        <li>mantenha inventário, imagens e documentos atualizados;</li>\n        <li>revise o limite quando abrir nova unidade ou ampliar o depósito.</li>\n      </ol>\n      <p class=\"mb-4\">Capital segurado muito abaixo do valor real pode deixar parte relevante do prejuízo com a empresa e, conforme a estrutura contratual, envolver regras de rateio. O valor informado precisa ser defensável por registros contábeis e de estoque.</p>\n\n      <h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para comparar propostas</h2>\n      <ul class=\"list-disc pl-6 mb-4 space-y-2\">\n        <li>atividade, endereço, área e tipo de ocupação estão corretos?</li>\n        <li>prédio, benfeitorias, mobiliário, eletrônicos e estoque têm limites separados?</li>\n        <li>há ajuste para aumento sazonal de mercadorias?</li>\n        <li>quais situações de subtração são cobertas ou excluídas?</li>\n        <li>vitrine, espelhos, letreiros e fachada estão contemplados?</li>\n        <li>água, vendaval e alagamento têm coberturas distintas?</li>\n        <li>lucros cessantes cobrem qual período e quais despesas?</li>\n        <li>venda on-line, depósito externo e transporte foram informados?</li>\n        <li>quais franquias e medidas obrigatórias de segurança se aplicam?</li>\n      </ul>\n\n      <div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\">\n        <h2 class=\"text-2xl font-black mb-3\">O estoque da sua loja aumentou?</h2>\n        <p class=\"mb-5\">A Elevance ajuda a comparar limites, franquias e coberturas para o ponto físico, estoque e operação on-line da sua loja.</p>\n        <a href=\"https://wa.me/5511920144864?text=Ol%C3%A1%2C%20quero%20cotar%20seguro%20para%20loja%20de%20roupas\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a>\n      </div>\n\n      <p class=\"text-sm text-slate-600 mb-4\"><strong>Aviso:</strong> coberturas, limites, franquias, obrigações e exclusões variam conforme seguradora, produto e análise de risco. A indenização depende das condições da apólice e da análise do sinistro.</p>\n      <p class=\"text-sm text-slate-600\">Referências: <a class=\"text-blue-700 underline\" target=\"_blank\" rel=\"noopener noreferrer\" href=\"https://www.gov.br/susep/pt-br/copy_of_planos-e-produtos/seguros/seguro-compreensivo\">Susep — seguro compreensivo</a> e <a class=\"text-blue-700 underline\" target=\"_blank\" rel=\"noopener noreferrer\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-responsabilidade-civil\">Susep — seguro de responsabilidade civil</a>.</p>\n"
  },

  {
  "id": 128,
  "slug": "franquia-reduzida-normal-seguro-auto-comparar",
  "title": "Franquia Reduzida ou Normal no Seguro Auto: Como Comparar o Custo Total",
  "date": "27 Ago, 2026",
  "category": "Seguro Auto",
  "readTime": "4 min",
  "image": "https://images.unsplash.com/photo-1494976388531-d1058494cdd8?auto=format&fit=crop&q=80&w=800",
  "excerpt": "A proposta com a menor parcela pode exigir mais dinheiro justamente no dia em que o carro precisa de conserto.",
  "content": "<p class=\"mb-4\">A proposta com a menor parcela pode exigir mais dinheiro justamente no dia em que o carro precisa de conserto. Para escolher entre franquia normal e reduzida, compare o preço anual do seguro com a participação que caberia no seu orçamento após um dano coberto.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">O que muda entre as duas propostas?</h2>\n<p class=\"mb-4\">A franquia é a participação prevista no contrato para determinada cobertura. A opção chamada reduzida costuma diminuir essa participação em relação à modalidade normal daquele produto, em troca de um prêmio maior. Não existe um valor único de franquia normal válido para todos os carros e seguradoras.</p>\n<p class=\"mb-4\">Peça os dois números por escrito: prêmio total da vigência e franquia em reais. Nomes comerciais como básica, obrigatória, normal ou reduzida não bastam para comparar empresas diferentes. Confira também se a redução vale para o casco ou para outra cobertura específica.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Uma simulação que mostra a diferença</h2>\n<p class=\"mb-4\">Considere duas propostas hipotéticas com todas as outras condições iguais: normal por R$ 2.400 ao ano e franquia de R$ 4.000; reduzida por R$ 2.900 ao ano e franquia de R$ 2.000. Um único reparo coberto de R$ 8.000, sujeito integralmente a essas franquias, produziria esta comparação:</p>\n<div class=\"overflow-x-auto my-6\"><table class=\"w-full text-left\"><thead><tr><th>Cenário ilustrativo</th><th>Normal</th><th>Reduzida</th></tr></thead><tbody><tr><td>Sem acionar a cobertura</td><td>R$ 2.400</td><td>R$ 2.900</td></tr><tr><td>Prêmio + participação em um reparo coberto</td><td>R$ 6.400</td><td>R$ 4.900</td></tr></tbody></table></div>\n<p class=\"mb-4\">Na primeira situação, a normal custa R$ 500 menos. Na segunda, a reduzida deixa o desembolso total R$ 1.500 menor. A conta não prevê se haverá acidente, nem inclui mudança de bônus na renovação, custos fora da cobertura ou mais de um sinistro. Ela serve para tornar a escolha concreta.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">E se o conserto ficar abaixo da franquia?</h2>\n<p class=\"mb-4\">Em uma franquia dedutível, um reparo de R$ 1.500 não geraria valor a receber em nenhuma das duas opções do exemplo. Portanto, contratar franquia reduzida não transforma qualquer risco ou arranhão em reparo pago pela seguradora.</p>\n<p class=\"mb-4\">Peça que o corretor simule um dano pequeno, um intermediário e um grande. Esse exercício mostra onde cada proposta começa a ajudar e evita escolher apenas pela impressão de que a palavra reduzida significa cobertura sem participação.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Qual opção combina com seu orçamento?</h2>\n<p class=\"mb-4\">A pergunta útil é: se o carro precisasse de conserto nesta semana, quanto você conseguiria desembolsar sem comprometer contas essenciais? Quem possui reserva e aceita absorver uma participação maior pode preferir economizar no prêmio. Quem teria dificuldade com a franquia normal pode atribuir mais valor à previsibilidade da reduzida.</p>\n<p class=\"mb-4\">Frequência de uso, estacionamento e dependência do veículo ajudam a organizar a decisão, mas não permitem prever um sinistro individual. Não escolha uma franquia que só cabe no papel. E confira se o parcelamento do seguro inclui juros: parcelas semelhantes podem esconder totais diferentes.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Confira o que ficou igual antes de decidir</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>Mesma cobertura para colisão, roubo e eventos naturais?</li><li>Mesmo critério e percentual de indenização do veículo?</li><li>Mesmos limites para danos a terceiros?</li><li>Mesmas regras para oficinas, peças, assistência e carro reserva?</li><li>Franquias separadas para vidros, faróis e retrovisores?</li><li>Há franquia na indenização integral, conforme o contrato?</li></ul>\n<p class=\"mb-4\">A Susep orienta a leitura da cláusula de franquia, inclusive porque produtos podem prever participação em indenização integral. Não use a regra de outra apólice para presumir como a sua funciona. A comparação final deve caber em uma página com valores e condições lado a lado.</p>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/seguro-auto-carro-acima-de-100-mil-coberturas\">coberturas para veículos de maior valor</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-auto-para-carro-financiado-indenizacao\">indenização de carro financiado</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Quer comparar franquia normal e reduzida?</h2><p class=\"mb-5\">Envie sua necessidade e as propostas que recebeu. A Elevance ajuda a comparar coberturas, limites e participações antes da contratação.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo. Disponibilidade, aceitação, coberturas, limites, franquias e exclusões dependem do produto e das condições contratuais. Exemplos numéricos são ilustrativos e não representam cotação ou promessa de indenização.</p>\n<p class=\"text-sm text-slate-600\">Fontes: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-de-automoveis\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro de automóveis</a>.</p>"
},
  {
  "id": 129,
  "slug": "carro-reserva-seguro-auto-7-15-30-dias",
  "title": "Carro Reserva no Seguro Auto: 7, 15 ou 30 Dias São Suficientes?",
  "date": "28 Ago, 2026",
  "category": "Seguro Auto",
  "readTime": "4 min",
  "image": "https://images.unsplash.com/photo-1494976388531-d1058494cdd8?auto=format&fit=crop&q=80&w=800",
  "excerpt": "Se ficar sem carro impede você de trabalhar, levar os filhos à escola ou cuidar de alguém, o carro reserva merece uma linha própria na comparação do seguro.",
  "content": "<p class=\"mb-4\">Se ficar sem carro impede você de trabalhar, levar os filhos à escola ou cuidar de alguém, o carro reserva merece uma linha própria na comparação do seguro. O número de diárias importa, mas as condições para retirar e usar o veículo podem pesar tanto quanto o prazo.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Carro reserva é o mesmo que assistência 24 horas?</h2>\n<p class=\"mb-4\">Não. Guincho, socorro mecânico e transporte de passageiros não significam, por si só, liberação de um automóvel por vários dias. Procure a previsão específica de carro reserva e identifique quais eventos permitem o uso.</p>\n<p class=\"mb-4\">Há produtos que oferecem sete, quinze ou trinta dias. O Bradesco Seguro Auto, por exemplo, divulga essas opções para situações de indenização integral ou danos parciais. Isso demonstra a existência dessas modalidades; não significa que qualquer seguro do mercado tenha as mesmas regras.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Como escolher a quantidade de dias</h2>\n<p class=\"mb-4\">Faça uma estimativa do impacto de uma semana, duas semanas e um mês sem seu carro. Liste deslocamentos inevitáveis, custo de transporte alternativo e possibilidade de usar outro veículo da família. Depois compare quanto custa ampliar o benefício na proposta.</p>\n<p class=\"mb-4\">Um exemplo de planejamento: se sua alternativa de transporte custasse R$ 60 por dia, quinze dias representariam R$ 900. Esse valor hipotético não é o preço de uma locação nem uma previsão de indenização. É uma referência do seu custo de ficar sem mobilidade.</p>\n<p class=\"mb-4\">O tempo de oficina depende de diagnóstico, autorização, peças e reparo. Mesmo trinta diárias podem terminar antes do conserto em um caso complexo. Evite interpretar o benefício como carro disponível até o fim de qualquer reparação.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">As seis perguntas que evitam surpresa na retirada</h2>\n<ol class=\"list-decimal pl-6 space-y-2 mb-4\"><li>O benefício começa após qual autorização ou etapa do sinistro?</li><li>O prazo é contado em dias corridos? Existe limite por evento e por vigência?</li><li>Qual categoria de veículo está incluída?</li><li>A locadora exige cartão, caução, idade mínima ou tempo de habilitação?</li><li>Há limite de quilometragem ou restrições para viagens e condutores adicionais?</li><li>Combustível, pedágio, multas, proteções extras e participação por dano no alugado ficam com quem?</li></ol>\n<p class=\"mb-4\">Esses pontos devem ser confirmados no manual da assistência e nas condições de locação. Não é suficiente ouvir que o carro reserva está incluso; é preciso conseguir utilizá-lo quando necessário.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Automático, carro familiar e motorista de aplicativo</h2>\n<p class=\"mb-4\">Se você depende de câmbio automático, precisa acomodar cadeirinhas ou transporta pessoa com mobilidade reduzida, pergunte pela categoria disponível antes de contratar. Um benefício de categoria básica pode não resolver sua rotina. Modelo exato, equipamentos e disponibilidade precisam ser confirmados.</p>\n<p class=\"mb-4\">Quem usa o carro profissionalmente deve verificar, também, se o veículo disponibilizado admite essa utilização. Não presuma que a cobertura do automóvel original autoriza transporte remunerado em um veículo alugado. Informe o uso ao corretor e confira as condições da locadora.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Pane, terceiro culpado e aluguel por conta própria</h2>\n<p class=\"mb-4\">Pergunte separadamente sobre pane mecânica, colisão com reparo abaixo da franquia e acidente em que você pretende ser atendido como terceiro. O enquadramento pode mudar o acesso ao benefício. A culpa pelo acidente, isoladamente, não responde se sua cobertura de carro reserva será liberada.</p>\n<p class=\"mb-4\">Antes de alugar por conta própria esperando reembolso, obtenha a orientação da seguradora. Guarde protocolos e confirmações. Caso as diárias contratadas acabem, solicite por escrito as opções de extensão e quem assumirá o custo.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Uma proposta boa é a que resolve o seu deslocamento</h2>\n<p class=\"mb-4\">Na comparação, anote prazo, categoria, gatilho de liberação, exigências e custo adicional. Se a opção mais barata exige uma caução que você não consegue disponibilizar ou oferece uma categoria inadequada, a economia pode não atender à necessidade que motivou a contratação.</p>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/porto-seguro-vs-tokio-marine-assistencia-24h\">como comparar assistência 24 horas</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-auto-para-uber-e-99-como-contratar\">seguro para uso em aplicativos</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Seu seguro garante mobilidade quando o carro para?</h2><p class=\"mb-5\">Envie sua necessidade e as propostas que recebeu. A Elevance ajuda a comparar coberturas, limites e participações antes da contratação.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo. Disponibilidade, aceitação, coberturas, limites, franquias e exclusões dependem do produto e das condições contratuais. Exemplos numéricos são ilustrativos e não representam cotação ou promessa de indenização.</p>\n<p class=\"text-sm text-slate-600\">Fontes: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-de-automoveis\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — coberturas adicionais</a> · <a class=\"underline\" href=\"https://www.bradescoseguros.com.br/clientes/produtos/seguro-auto/seguro-auto\" target=\"_blank\" rel=\"noopener noreferrer\">Bradesco Seguros — opções de carro reserva</a>.</p>"
},
  {
  "id": 130,
  "slug": "seguro-residencial-home-office-negocio-em-casa",
  "title": "Seguro Residencial para Home Office: O Trabalho em Casa Está Coberto?",
  "date": "29 Ago, 2026",
  "category": "Seguro Residencial",
  "readTime": "4 min",
  "image": "https://images.unsplash.com/photo-1484154218962-a197022b5858?auto=format&fit=crop&q=80&w=800",
  "excerpt": "Uma mesa com notebook e uma pequena produção com estoque podem funcionar no mesmo tipo de imóvel, mas não representam o mesmo risco.",
  "content": "<p class=\"mb-4\">Uma mesa com notebook e uma pequena produção com estoque podem funcionar no mesmo tipo de imóvel, mas não representam o mesmo risco. Quem trabalha em casa precisa descrever a atividade antes de assumir que o seguro residencial protege também a operação profissional.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">O endereço residencial não resolve sozinho a cobertura</h2>\n<p class=\"mb-4\">O seguro residencial pode reunir proteção do imóvel, conteúdo, responsabilidade civil e serviços de assistência. Bens usados profissionalmente e atividades comerciais, porém, precisam ser analisados conforme o produto. A Porto divulga opções para negócios em casa, o que não torna essa extensão automática em qualquer apólice.</p>\n<p class=\"mb-4\">Explique o que acontece no endereço: trabalho remoto administrativo, atendimento a clientes, produção, armazenamento ou retirada de mercadorias. Essa descrição ajuda a definir se um residencial com extensão é adequado ou se a operação pede outra estrutura de seguro.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Notebook da empresa e equipamentos próprios</h2>\n<p class=\"mb-4\">Separe bens pessoais, equipamentos comprados pelo seu CNPJ e itens cedidos pelo empregador. Registre modelos, valores e documentos disponíveis. Pergunte expressamente como a proposta trata bens de terceiros e uso profissional.</p>\n<p class=\"mb-4\">Um computador pode sofrer danos por causas diferentes: oscilação elétrica, queda, líquido ou subtração. Não conclua que uma cobertura de danos elétricos cobre todas elas. Se o aparelho também vai a coworkings e reuniões, informe a circulação fora da residência. A proteção do endereço não garante, por si só, cobertura em qualquer lugar.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quando há estoque ou produção</h2>\n<p class=\"mb-4\">Costura, artesanato, preparo de alimentos e venda on-line acrescentam perguntas sobre materiais, máquinas, calor, gás, entregas e valor do estoque. Uma operação que começou pequena pode crescer sem que a descrição do risco seja atualizada.</p>\n<p class=\"mb-4\">Exemplo: uma pessoa que guardava poucos produtos passa a manter três cômodos ocupados por mercadorias. O ponto de revisão é a mudança real da atividade e dos valores, não apenas a renovação anual. Leve essa informação ao corretor antes de depender da cobertura.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Clientes em casa: qual responsabilidade civil?</h2>\n<p class=\"mb-4\">Uma reclamação ligada à vida familiar não é a mesma coisa que uma reclamação por atendimento profissional. Se alguém frequenta o imóvel para consulta, aula, retirada ou serviço, pergunte qual cobertura contempla a operação.</p>\n<p class=\"mb-4\">Danos decorrentes do serviço prestado, erros profissionais e incidentes com dados exigem perguntas próprias. RC familiar, RC operações, RC profissional e proteção cibernética não são nomes intercambiáveis. Liste os riscos relevantes para sua atividade e solicite a identificação da cláusula correspondente.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Seguro não substitui um plano para continuar trabalhando</h2>\n<p class=\"mb-4\">Mesmo quando um equipamento é indenizável, pode haver tempo entre o problema e a reposição. Organize backup, acesso aos sistemas e alternativa temporária de trabalho. A cobertura patrimonial não implica automaticamente pagamento de todo faturamento perdido.</p>\n<p class=\"mb-4\">Se a continuidade da renda for essencial, pergunte sobre despesas adicionais, lucros cessantes ou outras soluções aplicáveis ao seu caso, sem presumir sua disponibilidade. Para um profissional que trabalha apenas com um notebook, uma reserva para locação temporária pode ter função diferente da cobertura do imóvel.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">O que enviar para uma cotação útil</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>Endereço, tipo de imóvel e área utilizada para trabalho.</li><li>Descrição da atividade e eventual CNPJ.</li><li>Existência de clientes, funcionários ou entregadores no local.</li><li>Relação de equipamentos próprios e de terceiros.</li><li>Valor do estoque, materiais e máquinas.</li><li>Uso fora de casa e medidas de segurança.</li><li>Coberturas já contratadas pelo empregador ou condomínio.</li></ul>\n<p class=\"mb-4\">Peça que a aceitação da atividade e dos bens fique documentada. Uma resposta genérica sobre home office não substitui a confirmação de que sua forma concreta de trabalhar foi considerada.</p>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/seguro-para-notebook-celular-equipamentos-portateis-empresa\">equipamentos portáteis profissionais</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-cibernetico-para-pequenas-empresas-coberturas\">proteção cibernética para pequenas empresas</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Sua casa também é seu local de trabalho?</h2><p class=\"mb-5\">Envie sua necessidade e as propostas que recebeu. A Elevance ajuda a comparar coberturas, limites e participações antes da contratação.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo. Disponibilidade, aceitação, coberturas, limites, franquias e exclusões dependem do produto e das condições contratuais. Exemplos numéricos são ilustrativos e não representam cotação ou promessa de indenização.</p>\n<p class=\"text-sm text-slate-600\">Fontes: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-residencial\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro residencial</a> · <a class=\"underline\" href=\"https://www.portoseguro.com.br/seguro-residencial\" target=\"_blank\" rel=\"noopener noreferrer\">Porto — residencial e negócios em casa</a>.</p>"
},
  {
  "id": 131,
  "slug": "seguro-rc-profissional-psicologo-consultorio-online",
  "title": "RC Profissional para Psicólogo: Consultório, Atendimento On-line e Limites",
  "date": "30 Ago, 2026",
  "category": "Responsabilidade Civil",
  "readTime": "4 min",
  "image": "https://images.unsplash.com/photo-1497366754035-f200968a6e72?auto=format&fit=crop&q=80&w=800",
  "excerpt": "Proteger a sala de atendimento contra incêndio não responde à mesma necessidade de se defender de uma reclamação relacionada ao trabalho clínico.",
  "content": "<p class=\"mb-4\">Proteger a sala de atendimento contra incêndio não responde à mesma necessidade de se defender de uma reclamação relacionada ao trabalho clínico. Para psicólogos, a comparação de RC profissional começa pelo serviço efetivamente prestado e por quem precisa constar como segurado.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">O que a responsabilidade civil profissional procura proteger?</h2>\n<p class=\"mb-4\">O RC profissional é voltado a reclamações de terceiros associadas a falhas profissionais previstas no contrato. A Susep distingue esse risco da responsabilidade civil geral. A contratação deve especificar a atividade aceita; não basta adquirir um produto com a sigla RC.</p>\n<p class=\"mb-4\">Isso não significa pagamento automático sempre que um paciente se sentir insatisfeito. A reclamação, o fato alegado, os danos e as condições do seguro serão analisados. Seguro tampouco substitui deveres éticos, qualificação, consentimento, registros e cuidado no atendimento.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Pessoa física, clínica ou ambos?</h2>\n<p class=\"mb-4\">Um psicólogo autônomo pode prestar serviços em uma clínica que também possui seguro. A primeira pergunta é se ele está efetivamente incluído naquela proteção e para quais atendimentos. Peça confirmação documental em vez de depender apenas da informação verbal de que a clínica tem apólice.</p>\n<p class=\"mb-4\">Para uma clínica, relacione profissionais, vínculos, especialidades e serviços. Verifique como a proposta trata sócios, empregados e prestadores. Se cada profissional possui seguro individual, ainda pode existir uma exposição própria da pessoa jurídica. O objetivo é identificar possíveis lacunas, e não empilhar contratos sem entender a função de cada um.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Atendimento on-line e documentos profissionais</h2>\n<p class=\"mb-4\">Informe atendimento remoto, presencial e domiciliar, além de avaliações e emissão de documentos quando fizerem parte da atividade. Pergunte se todos esses serviços estão contemplados e quais territórios e jurisdições são aceitos.</p>\n<p class=\"mb-4\">Se há pacientes em outro país, não assuma que a cobertura acompanha a chamada de vídeo. A resposta depende tanto do seguro quanto das regras profissionais aplicáveis. Este artigo não estabelece autorização para atendimento transfronteiriço.</p>\n<p class=\"mb-4\">Prontuários e dados sensíveis também merecem avaliação. Uma reclamação por falha clínica, um incidente de segurança e uma violação de sigilo podem receber tratamentos diferentes. Solicite a separação entre RC profissional e eventual cobertura cibernética.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Custos de defesa merecem comparação própria</h2>\n<p class=\"mb-4\">Pergunte se despesas de defesa estão incluídas, quais procedimentos exigem autorização, como é escolhida a representação e se os custos consomem o mesmo limite destinado à indenização. Reclamações éticas ou administrativas precisam de confirmação específica; não devem ser presumidas como cobertas.</p>\n<p class=\"mb-4\">Da mesma forma, confira danos morais, franquias, sub-limites e exclusões. Uma frase comercial como proteção completa é menos útil que saber o limite para cada situação relevante.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Retroatividade e troca de seguradora</h2>\n<p class=\"mb-4\">Em contratos à base de reclamações, datas são decisivas. A cobertura depende da combinação entre o período do fato, a apresentação da reclamação e as condições da apólice. Verifique a data de retroatividade, regras de notificação e eventuais prazos adicionais.</p>\n<p class=\"mb-4\">Ao renovar ou mudar de seguradora, leve a apólice anterior para análise. Não cancele a proteção existente antes de compreender como fatos passados e reclamações futuras serão tratados. Circunstâncias já conhecidas precisam ser informadas corretamente no questionário.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para pedir uma proposta comparável</h2>\n<ol class=\"list-decimal pl-6 space-y-2 mb-4\"><li>Identifique CPF/CNPJ e todos os profissionais que precisam de proteção.</li><li>Descreva modalidades de atendimento, serviços e locais.</li><li>Informe experiência, histórico e eventuais reclamações conhecidas.</li><li>Compare limite por reclamação e limite agregado da vigência.</li><li>Confira defesa, franquias, retroatividade e território.</li><li>Peça a cláusula que confirma a aceitação da atividade de psicologia.</li></ol>\n<p class=\"mb-4\">A decisão melhora quando a proposta acompanha a realidade do consultório. O menor preço só é comparável depois que atividade, pessoas, períodos e limites estão alinhados.</p>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/seguro-clinica-odontologica-empresarial-rc-profissional\">diferença entre proteção do consultório e RC</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-cibernetico-para-pequenas-empresas-coberturas\">riscos relacionados a dados</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Quer avaliar RC para sua atividade profissional?</h2><p class=\"mb-5\">Envie sua necessidade e as propostas que recebeu. A Elevance ajuda a comparar coberturas, limites e participações antes da contratação.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo. Disponibilidade, aceitação, coberturas, limites, franquias e exclusões dependem do produto e das condições contratuais. Exemplos numéricos são ilustrativos e não representam cotação ou promessa de indenização.</p>\n<p class=\"text-sm text-slate-600\">Fontes: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-responsabilidade-civil\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — responsabilidade civil</a> · <a class=\"underline\" href=\"https://www.portoseguro.com.br/seguro-responsabilidade-civil/profissional\" target=\"_blank\" rel=\"noopener noreferrer\">Porto — responsabilidade civil profissional</a>.</p>"
},
  {
  "id": 132,
  "slug": "seguro-viagem-bagagem-atraso-extravio-diferencas",
  "title": "Seguro Viagem e Bagagem: Atraso, Extravio e Danos São a Mesma Cobertura?",
  "date": "31 Ago, 2026",
  "category": "Seguro Viagem",
  "readTime": "4 min",
  "image": "https://images.unsplash.com/photo-1488646953014-85cb44e25828?auto=format&fit=crop&q=80&w=800",
  "excerpt": "A mala não aparecer na esteira pode significar atraso temporário ou perda definitiva.",
  "content": "<p class=\"mb-4\">A mala não aparecer na esteira pode significar atraso temporário ou perda definitiva. No seguro viagem, esses acontecimentos podem acionar coberturas diferentes. Antes de escolher pelo maior valor anunciado para bagagem, descubra qual situação aquele limite realmente protege.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Três situações para comparar separadamente</h2>\n<p class=\"mb-4\">Atraso pode gerar necessidade de comprar itens essenciais enquanto a bagagem é localizada. Extravio definitivo envolve a perda reconhecida conforme os critérios aplicáveis. Danos dizem respeito à mala ou ao conteúdo avariado. Roubo e furto durante a viagem acrescentam outras circunstâncias.</p>\n<p class=\"mb-4\">A Susep orienta que o seguro viagem responde pelos eventos previstos na contratação. Portanto, peça os nomes exatos das coberturas e os respectivos gatilhos. Um único campo chamado bagagem no resumo comercial não explica todas essas diferenças.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">O valor é complementar ou independente?</h2>\n<p class=\"mb-4\">Alguns produtos estruturam o pagamento considerando valores recebidos da transportadora. O seguro viagem divulgado pelo Itaú, por exemplo, informa abatimento do que já foi pago pela companhia responsável no benefício de bagagem ali descrito. Não generalize essa regra para todo produto.</p>\n<p class=\"mb-4\">Peça uma simulação escrita. Se o limite hipotético fosse R$ 3.000 e a transportadora pagasse R$ 1.000, uma cobertura estritamente complementar poderia ter cálculo diferente de uma modalidade suplementar. Termos, moeda, documentos e limites precisam ser confirmados na apólice; somar automaticamente os dois valores pode superestimar a proteção.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Antes de comprar roupas e itens de higiene</h2>\n<p class=\"mb-4\">Se a bagagem atrasar, comunique a transportadora, registre a ocorrência e procure a central do seguro. Pergunte se existe tempo mínimo de atraso, quais despesas são elegíveis e que comprovantes serão necessários. Registre protocolos e guarde recibos detalhados.</p>\n<p class=\"mb-4\">Itens essenciais não significam qualquer compra feita durante a espera. Também verifique se as regras mudam na ida e no retorno ao local de residência. Não é prudente gastar o limite anunciado sem primeiro entender a cobertura.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Notebook, joias e equipamentos exigem atenção</h2>\n<p class=\"mb-4\">Liste os objetos que pretende levar e pergunte sobre exclusões, valores máximos por item, comprovação de propriedade e transporte como bagagem de mão ou despachada. Equipamentos profissionais podem exigir proteção específica.</p>\n<p class=\"mb-4\">Fotografar os pertences e guardar comprovantes pode facilitar a organização documental, mas não cria cobertura para um bem excluído. Se você depende de câmera ou computador para trabalhar na viagem, compare o risco do equipamento separadamente do benefício genérico de bagagem.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Uma viagem com conexão muda o planejamento</h2>\n<p class=\"mb-4\">Imagine chegar ao destino à noite e embarcar novamente na manhã seguinte. Mesmo um limite alto para perda definitiva talvez não resolva a necessidade imediata de roupas, medicamentos de uso pessoal ou material de trabalho. A escolha deve considerar a logística real da viagem.</p>\n<p class=\"mb-4\">Verifique como informar novo endereço de entrega à transportadora e mantenha os contatos da assistência acessíveis fora da mala. Isso é organização de viagem, não garantia de entrega ou de reembolso.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">O que precisa aparecer na comparação final</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>Limites separados para atraso, extravio, roubo e danos, se oferecidos.</li><li>Moeda, abrangência territorial e duração da viagem.</li><li>Relação entre pagamento do seguro e da transportadora.</li><li>Tempo mínimo e despesas aceitas na cobertura de atraso.</li><li>Itens excluídos e limites por objeto.</li><li>Procedimentos e documentação para solicitar análise.</li></ul>\n<p class=\"mb-4\">Bagagem é apenas uma parte do seguro viagem. Confira também assistência e despesas médicas adequadas ao destino e às atividades previstas. A apólice mais útil combina as necessidades da viagem inteira, não apenas um número destacado no anúncio.</p>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/seguro-para-notebook-celular-equipamentos-portateis-empresa\">equipamentos profissionais fora da empresa</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-transporte-carga-embarcador-vs-transportadora\">diferença para transporte de mercadorias</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Vai viajar e quer comparar a proteção da bagagem?</h2><p class=\"mb-5\">Envie sua necessidade e as propostas que recebeu. A Elevance ajuda a comparar coberturas, limites e participações antes da contratação.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo. Disponibilidade, aceitação, coberturas, limites, franquias e exclusões dependem do produto e das condições contratuais. Exemplos numéricos são ilustrativos e não representam cotação ou promessa de indenização.</p>\n<p class=\"text-sm text-slate-600\">Fontes: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-viagem\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro viagem</a> · <a class=\"underline\" href=\"https://www.itau.com.br/seguros/viagem\" target=\"_blank\" rel=\"noopener noreferrer\">Itaú — exemplo de cobertura complementar de bagagem</a>.</p>"
},
  {
  "id": 133,
  "slug": "seguro-vida-invalidez-acidente-doenca-diferencas",
  "title": "Seguro de Vida: Invalidez por Acidente e por Doença São Diferentes",
  "date": "01 Set, 2026",
  "category": "Seguro de Vida",
  "readTime": "4 min",
  "image": "https://images.unsplash.com/photo-1511895426328-dc8714191300?auto=format&fit=crop&q=80&w=800",
  "excerpt": "Duas propostas podem apresentar o mesmo capital para morte e oferecer proteções muito diferentes para quem continua vivo, mas enfrenta uma limitação permanente.",
  "content": "<p class=\"mb-4\">Duas propostas podem apresentar o mesmo capital para morte e oferecer proteções muito diferentes para quem continua vivo, mas enfrenta uma limitação permanente. Na comparação do seguro de vida, a palavra invalidez precisa vir acompanhada da causa e do critério usado pelo contrato.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Acidente não é sinônimo de qualquer problema de saúde</h2>\n<p class=\"mb-4\">A cobertura de invalidez permanente por acidente está ligada a uma sequela definitiva decorrente de acidente pessoal nos termos do seguro. Ela não deve ser interpretada como proteção geral para doenças que impeçam o trabalho. Confira se o produto contempla invalidez total, parcial ou ambas.</p>\n<p class=\"mb-4\">Na invalidez parcial por acidente, o valor pode depender da tabela contratual e do grau da perda funcional. O capital anunciado é um limite, não necessariamente o pagamento integral para qualquer sequela. Peça um exemplo de cálculo aplicável à proposta que recebeu.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Por doença: laborativa e funcional têm critérios distintos</h2>\n<p class=\"mb-4\">A Susep diferencia a invalidez laborativa permanente total por doença, relacionada à impossibilidade definitiva de exercer a atividade laborativa principal conforme o contrato, da invalidez funcional permanente total por doença, vinculada à perda da existência independente nos termos do plano.</p>\n<p class=\"mb-4\">Assim, não poder continuar na profissão não equivale automaticamente a preencher o critério funcional. O STJ também reconheceu a validade da cláusula de cobertura funcional vinculada à perda de autonomia. É uma distinção central para comparar produtos; não é uma avaliação sobre um caso individual.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Um exemplo para orientar a leitura</h2>\n<p class=\"mb-4\">Pense em um profissional que desenvolve uma doença, mantém autonomia nas atividades cotidianas, mas não consegue mais executar tarefas essenciais da sua profissão. Esse cenário hipotético mostra por que perguntar apenas se o seguro cobre invalidez é insuficiente.</p>\n<p class=\"mb-4\">Ele não permite concluir se haverá indenização: é preciso examinar diagnóstico, permanência, definição de atividade, exclusões e critérios contratuais. O exercício serve para levar uma pergunta concreta ao corretor: qual cobertura desta proposta foi desenhada para o risco que mais me preocupa?</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Invalidez, diária por incapacidade e doenças graves</h2>\n<p class=\"mb-4\">Essas coberturas respondem a gatilhos diferentes. Uma diária por incapacidade temporária, quando contratada e aplicável, não é equivalente a um capital por sequela permanente. Já uma cobertura de doenças graves depende das doenças e critérios especificados no produto.</p>\n<p class=\"mb-4\">Liste separadamente três necessidades: despesas durante um afastamento, reorganização da vida após limitação permanente e proteção financeira da família em caso de morte. Depois identifique qual cláusula responde a cada uma. Uma única soma segurada raramente explica todo o desenho da proteção.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">O que verificar além do nome da cobertura</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>Causa coberta: acidente, doença ou situações expressamente definidas.</li><li>Critério de permanência e possibilidade de invalidez parcial.</li><li>Capital de cada cobertura e eventual tabela de percentuais.</li><li>Regras de antecipação ou redução de outro capital após pagamento.</li><li>Carências, franquias temporais e exclusões, quando aplicáveis.</li><li>Profissão informada e critérios de manutenção ou renovação.</li><li>Documentos necessários para análise do evento.</li></ul>\n<p class=\"mb-4\">Também pergunte como a apólice trata benefícios previdenciários. Não presuma que uma decisão do INSS substitui a avaliação prevista no seguro privado. Guarde a proposta, as condições e as respostas recebidas.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Como escolher sem contratar apenas pelo preço</h2>\n<p class=\"mb-4\">Organize renda, compromissos familiares, reserva financeira e custo de adaptação que deseja proteger. Esses dados ajudam a dimensionar uma necessidade; não produzem sozinhos um capital obrigatório ou ideal.</p>\n<p class=\"mb-4\">Ao comparar duas propostas, alinhe as coberturas uma a uma. Um seguro mais barato pode simplesmente incluir apenas acidente onde o outro contempla determinada proteção por doença. O objetivo é entender essa diferença antes da contratação, sem confundir nomes parecidos com resultados iguais.</p>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/seguro-de-vida-para-socios-empresa-capital-sucessao\">proteção financeira para sócios</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-de-vida-entra-inventario-beneficiarios\">indicação e atualização de beneficiários</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Sua proposta protege quais situações de invalidez?</h2><p class=\"mb-5\">Envie sua necessidade e as propostas que recebeu. A Elevance ajuda a comparar coberturas, limites e participações antes da contratação.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo. Disponibilidade, aceitação, coberturas, limites, franquias e exclusões dependem do produto e das condições contratuais. Exemplos numéricos são ilustrativos e não representam cotação ou promessa de indenização.</p>\n<p class=\"text-sm text-slate-600\">Fontes: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/copy_of_planos-e-produtos/seguros/seguro-de-pessoas\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — coberturas de seguros de pessoas</a> · <a class=\"underline\" href=\"https://www.stj.jus.br/sites/portalp/Paginas/Comunicacao/Noticias/05112021-Segunda-Secao-considera-valida-cobertura-de-invalidez-vinculada-a-perda-total-da-autonomia-do-segurado.aspx\" target=\"_blank\" rel=\"noopener noreferrer\">STJ — critério da invalidez funcional</a>.</p>"
},

  {
  "id": 134,
  "slug": "plano-saude-regional-vs-nacional-abrangencia-rede",
  "title": "Plano de Saúde Regional ou Nacional: Como Comparar Abrangência e Rede",
  "date": "02 Set, 2026",
  "category": "Plano de Saúde",
  "readTime": "4 min",
  "image": "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&q=80&w=800",
  "excerpt": "Compare cidades cobertas, rede do produto, viagens e custo para escolher um plano que acompanhe a rotina da família ou da empresa.",
  "content": "<p class=\"mb-4\">Seu plano precisa acompanhar os lugares onde você vive, trabalha e passa parte do ano. Para comparar um plano de saúde regional com um nacional, comece pelo mapa da sua rotina e pela rede do produto, não apenas pela mensalidade ou pelo nome da operadora.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Regional e nacional: o que muda?</h2>\n<p class=\"mb-4\">A ANS informa que a abrangência pode ser municipal, de um grupo de municípios, estadual, de um grupo de estados ou nacional. “Regional” é uma descrição comercial que precisa ser traduzida na lista exata de localidades cobertas pelo contrato.</p>\n<p class=\"mb-4\">Abrangência responde onde o plano oferece cobertura; segmentação define os tipos de atendimento incluídos. Um plano nacional não se torna automaticamente hospitalar, com obstetrícia ou com acomodação em apartamento. Essas características devem ser conferidas separadamente.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Nacional significa qualquer hospital?</h2>\n<p class=\"mb-4\">Não. A área de cobertura não equivale a livre escolha irrestrita de hospitais e médicos. A ANS recomenda avaliar a rede do plano antes de contratar. Consulte o produto específico: dois planos da mesma operadora podem ter redes diferentes.</p>\n<p class=\"mb-4\">Faça uma lista curta de serviços importantes: pronto-socorro próximo de casa, laboratório acessível, especialistas de uso frequente e hospital nas cidades em que você permanece. Confira cada endereço com o nome e o registro do produto cotado, guardando a data da consulta.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Três perfis para organizar a comparação</h2>\n<div class=\"overflow-x-auto my-6\"><table class=\"w-full text-left\"><thead><tr><th scope=\"col\">Rotina</th><th scope=\"col\">O que investigar na proposta</th></tr></thead><tbody><tr><td>Família que concentra a rotina no mesmo município</td><td>Rede local, deslocamentos e cidades vizinhas incluídas.</td></tr><tr><td>Profissional que divide o mês entre estados</td><td>Cobertura e acesso a serviços nos dois destinos recorrentes.</td></tr><tr><td>Empresa com colaboradores em diferentes cidades</td><td>Residência e local de trabalho de cada grupo, não só o endereço da sede.</td></tr></tbody></table></div>\n<p class=\"mb-4\">Esses perfis são exemplos de planejamento, não recomendações automáticas. Um mapa amplo pode ser importante para uma família que passa meses fora; para outra, a prioridade pode ser um serviço próximo e fácil de acessar. A decisão depende das propostas disponíveis e do uso esperado.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Viagens, urgência e atendimento fora da área</h2>\n<p class=\"mb-4\">Não interprete a palavra “urgência” em um anúncio como extensão automática da abrangência para todo o Brasil. Antes de viajar, peça confirmação escrita sobre atendimento fora da área, eventual serviço adicional, locais disponíveis e procedimentos de acionamento. Não confunda esse benefício com consultas de rotina em qualquer cidade.</p>\n<p class=\"mb-4\">Também não confunda ausência de cobertura territorial com falta de prestador disponível dentro da área contratada. A ANS prevê medidas para garantir atendimento quando a rede não consegue atender nas condições regulamentares. Nessas situações, procure a operadora, solicite uma alternativa e guarde o protocolo. Os prazos regulatórios não garantem um profissional específico de sua preferência.</p>\n<p class=\"mb-4\">Uma orientação individual sobre negativa depende do contrato e do caso concreto. Em uma emergência real, a prioridade é procurar assistência imediata, sem atrasar cuidados para resolver uma dúvida comercial.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Como comparar o custo sem misturar produtos</h2>\n<p class=\"mb-4\">Peça simulações para o mesmo grupo de pessoas, com as mesmas faixas etárias e modalidade de contratação. Separe mensalidade, coparticipação, acomodação e reembolso. Não atribua toda diferença de preço à abrangência quando outras características também mudaram.</p>\n<p class=\"mb-4\">Uma planilha simples pode ter três colunas: requisito da família ou empresa, resposta da proposta regional e resposta da proposta nacional. Marque como “a confirmar” qualquer informação recebida apenas verbalmente. Preço menor não resolve a ausência de um serviço essencial; abrangência maior também não substitui uma rede adequada à rotina.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para pedir uma cotação útil</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>Cidades de residência, trabalho e permanência frequente dos beneficiários.</li><li>Nome e registro do produto, com abrangência por escrito.</li><li>Hospitais e serviços desejados, conferidos na rede daquele plano.</li><li>Segmentação, acomodação, coparticipação e condições de reembolso.</li><li>Carências e condições de ingresso aplicáveis à contratação.</li><li>Regras de atendimento durante viagens e canais de orientação.</li><li>Valor total para o grupo e documentação necessária.</li></ul>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/plano-de-saude-com-reembolso-vale-a-pena\">quando comparar planos com reembolso</a> · <a class=\"text-blue-700 underline\" href=\"/blog/plano-de-saude-empresarial-pme-como-funciona\">contratação empresarial PME</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Regional ou nacional para a sua rotina?</h2><p class=\"mb-5\">Informe à Elevance as cidades onde você precisa de atendimento, as idades e os serviços prioritários. Vamos comparar as opções disponíveis entre os parceiros autorizados, com atenção à rede e às condições do produto.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Comparar planos com a Elevance</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo, revisado em 02/09/2026. Disponibilidade, elegibilidade, rede e condições dependem do produto e da contratação. Não representa cotação, garantia de cobertura para um caso individual ou substituição da análise contratual.</p>\n<p class=\"text-sm text-slate-600\">Fontes: <a class=\"underline\" href=\"https://www.gov.br/ans/pt-br/assuntos/consumidor/o-que-o-seu-plano-de-saude-deve-cobrir-1\" target=\"_blank\" rel=\"noopener noreferrer\">ANS — cobertura, segmentação, rede e abrangência</a> · <a class=\"underline\" href=\"https://www.gov.br/ans/pt-br/assuntos/consumidor/prazos-maximos-de-atendimento\" target=\"_blank\" rel=\"noopener noreferrer\">ANS — garantia e prazos de atendimento</a>.</p>"
},

  {
  "id": 135,
  "slug": "seguro-auto-terceiros-100-mil-200-mil-limites",
  "title": "Seguro Auto para Terceiros: R$ 100 Mil ou R$ 200 Mil de Cobertura?",
  "date": "03 Set, 2026",
  "category": "Seguro Auto",
  "readTime": "4 min",
  "image": "https://images.unsplash.com/photo-1494976388531-d1058494cdd8?auto=format&fit=crop&q=80&w=800",
  "excerpt": "Compare limites de danos materiais, corporais e morais e veja por que o valor do seu carro não define a proteção necessária para terceiros.",
  "content": "<p class=\"mb-4\">Na cotação do seguro auto, muita gente confere o valor do próprio carro e passa rápido pela linha “terceiros”. Só que o preço do seu veículo não determina o tamanho do prejuízo que um acidente pode causar a outras pessoas. É por isso que comparar R$ 100 mil e R$ 200 mil exige mais do que olhar a diferença na parcela.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Primeiro: limite de qual cobertura?</h2>\n<p class=\"mb-4\">A responsabilidade civil facultativa de veículos, ou RCF-V, protege o interesse do segurado quando ele é responsabilizado por danos a terceiros, conforme o contrato. A Susep ressalta que a proteção está limitada ao valor contratado. Não é um saldo livre para qualquer despesa do acidente.</p>\n<p class=\"mb-4\">Confira separadamente danos materiais, danos corporais e eventual cobertura de danos morais. A proposta pode organizar esses valores de maneiras diferentes. Não some limites de naturezas distintas para concluir que existe uma única reserva disponível para consertar outro carro.</p>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li><strong>Materiais:</strong> examine a proteção para prejuízos a bens de terceiros, como veículos e imóveis.</li><li><strong>Corporais:</strong> confira as condições relativas a lesões físicas sofridas por terceiros e suas consequências cobertas.</li><li><strong>Morais:</strong> verifique se há contratação expressa, qual o limite e como o contrato define essa cobertura.</li></ul>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Um exemplo: prejuízo material de R$ 150 mil</h2>\n<p class=\"mb-4\">Imagine um único evento com R$ 150 mil de danos materiais reconhecidos como cobertos, responsabilidade apurada, limite integral disponível e nenhuma franquia ou outra dedução aplicável. A comparação hipotética seria:</p>\n<div class=\"overflow-x-auto my-6\"><table class=\"w-full text-left\"><thead><tr><th scope=\"col\">Limite para danos materiais</th><th scope=\"col\">Parcela coberta no exemplo</th><th scope=\"col\">Excesso sobre o limite</th></tr></thead><tbody><tr><td>R$ 100 mil</td><td>R$ 100 mil</td><td>R$ 50 mil</td></tr><tr><td>R$ 200 mil</td><td>R$ 150 mil</td><td>R$ 0</td></tr></tbody></table></div>\n<p class=\"mb-4\">O limite de R$ 200 mil não gera pagamento de R$ 200 mil se o dano coberto é de R$ 150 mil. Já o limite menor não apaga a responsabilidade pelo excedente. O cálculo apenas ilustra a diferença entre teto contratado e prejuízo indenizável; não prevê o resultado de um sinistro real.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">E se houver dois carros ou mais de uma vítima?</h2>\n<p class=\"mb-4\">Pergunte se o valor indicado vale por evento, por pessoa ou segundo outra regra, e como funciona quando vários terceiros participam do mesmo acidente. Um número destacado no orçamento não responde sozinho a essa pergunta.</p>\n<p class=\"mb-4\">Peça também esclarecimento sobre redução do limite após um pagamento e eventual recomposição durante a vigência. Não conte com renovação automática do saldo para cada pessoa prejudicada. Solicite um exemplo escrito usando exatamente as condições da proposta recebida.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">R$ 200 mil é suficiente para todo motorista?</h2>\n<p class=\"mb-4\">Não existe um valor que garanta suficiência para qualquer acidente. O exemplo não transforma R$ 200 mil em recomendação universal, nem indica que R$ 100 mil sempre será inadequado. O objetivo é decidir conscientemente quanto risco financeiro ficará fora do seguro.</p>\n<p class=\"mb-4\">Leve à comparação sua frequência de uso, trajetos e capacidade de suportar uma despesa inesperada. Quem dirige um carro mais antigo também pode atingir bens de valor elevado. Por outro lado, pagar por um limite maior sem entender exclusões ou deixar danos corporais de lado pode produzir uma falsa sensação de proteção.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Compare o preço mantendo o restante igual</h2>\n<p class=\"mb-4\">Solicite duas versões da mesma proposta, alterando apenas o limite que deseja avaliar. Compare o prêmio total da vigência, não só a parcela. Confira se franquia do casco, assistência, oficinas e demais coberturas permaneceram iguais.</p>\n<p class=\"mb-4\">Se a diferença hipotética fosse de R$ 180 ao ano, ela equivaleria a R$ 15 por mês em uma divisão simples por 12, sem juros. Isso é somente uma conta ilustrativa, não uma faixa de preço de mercado. O acréscimo real precisa vir da cotação.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Antes de fechar, faça estas perguntas</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>Quais são os limites de danos materiais, corporais e morais?</li><li>Existe limite único, sublimite ou participação do segurado?</li><li>Como são tratados vários prejudicados no mesmo evento?</li><li>O que acontece com os limites depois de um sinistro?</li><li>Como funcionam custos de defesa e acordos com terceiros?</li><li>Quais situações e pessoas estão excluídas da definição contratual de terceiro?</li></ul>\n<p class=\"mb-4\">A Susep diferencia a cobertura de responsabilidade civil da proteção do próprio veículo e dos acidentes pessoais de passageiros. Após um acidente, comunique a seguradora e siga o procedimento contratual antes de negociar pagamentos por conta própria.</p>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/franquia-reduzida-normal-seguro-auto-comparar\">franquia normal ou reduzida</a> · <a class=\"text-blue-700 underline\" href=\"/blog/sinistro-de-seguro-como-acionar\">como comunicar um sinistro</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Quanto custa ampliar a cobertura para terceiros?</h2><p class=\"mb-5\">Envie sua apólice ou cotação à Elevance. Vamos comparar os limites disponíveis e o preço total entre os parceiros autorizados, sem misturar coberturas diferentes na mesma conta.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Comparar meu seguro com a Elevance</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo, revisado em 03/09/2026. Exemplos são hipotéticos e não representam cotação ou promessa de indenização. Disponibilidade, aceitação, coberturas, limites e exclusões dependem do produto e das condições contratuais.</p>\n<p class=\"text-sm text-slate-600\">Fontes: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-de-automoveis\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro de automóveis</a> · <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-responsabilidade-civil\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — responsabilidade civil e limites</a>.</p>"
},

  {
  "id": 136,
  "slug": "seguro-auto-cobre-pane-mecanica-motor-fundido",
  "title": "Seguro Auto Cobre Pane Mecânica ou Motor Fundido?",
  "date": "04 Set, 2026",
  "category": "Seguro Auto",
  "readTime": "4 min",
  "image": "https://images.unsplash.com/photo-1487754180451-c456f719a1fc?auto=format&fit=crop&q=80&w=800",
  "excerpt": "Entenda a diferença entre dano por evento coberto, defeito mecânico, desgaste, assistência e garantia antes de comparar o seguro do carro.",
  "content": "<p class=\"mb-4\">O motor parou, o painel acendeu e o carro precisou de guincho. Essa cena pode acionar um serviço de assistência sem significar que o seguro pagará o conserto. Para saber o que acontece com uma pane mecânica ou um motor fundido, é preciso separar <strong>o evento que causou o dano</strong> do componente que apresentou o problema.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Pane, sinistro e assistência não são sinônimos</h2>\n<p class=\"mb-4\">O seguro auto cobre os riscos descritos na apólice. A Susep orienta que o consumidor verifique as coberturas contratadas, as exclusões e os serviços de assistência. Colisão, incêndio, roubo ou furto podem integrar uma cobertura compreensiva, mas isso não transforma manutenção, desgaste ou falha interna em indenização automática.</p>\n<p class=\"mb-4\">Já a assistência 24 horas pode oferecer reboque, socorro ou outro serviço dentro de limites de distância e quantidade. O guincho resolve a remoção; não decide quem paga peças e mão de obra da oficina.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quando o motor fundido costuma ficar fora do casco?</h2>\n<p class=\"mb-4\">Se o problema decorre de desgaste, falta de manutenção, defeito próprio, superaquecimento sem evento externo coberto ou uso continuado após um alerta, a tendência contratual é não haver cobertura pelo casco. A conclusão depende da causa apurada e das condições do produto — não apenas do diagnóstico “motor fundido”.</p>\n<p class=\"mb-4\">Também não presuma cobertura porque o veículo está segurado pelo valor de mercado. Esse valor serve ao critério de indenização previsto para eventos cobertos; não funciona como verba para qualquer reparo.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">E se o dano veio de colisão, enchente ou incêndio?</h2>\n<p class=\"mb-4\">A pergunta muda: a causa inicial está entre os riscos contratados? Se uma colisão coberta danifica o conjunto mecânico, a seguradora analisa o nexo entre o acidente e o reparo. Em alagamento, entrar deliberadamente em área inundada ou insistir no funcionamento pode ser discutido como agravamento do risco; preserve o veículo e siga as orientações de acionamento.</p>\n<p class=\"mb-4\">Em qualquer cenário, a oficina e a seguradora podem precisar identificar se o dano decorreu do evento ou de problema anterior. Fotos, alertas do painel, notas de manutenção, relato cronológico e laudo técnico ajudam a documentar a análise.</p>\n<div class=\"overflow-x-auto my-6\"><table class=\"w-full text-left\"><thead><tr><th scope=\"col\">Situação</th><th scope=\"col\">O que conferir</th></tr></thead><tbody><tr><td>Pane sem evento externo</td><td>Assistência para remoção e exclusões de defeito ou desgaste.</td></tr><tr><td>Dano mecânico após colisão</td><td>Nexo com o acidente, cobertura do casco e franquia aplicável.</td></tr><tr><td>Carro afetado por alagamento</td><td>Cobertura contratada, conduta do motorista e procedimento de preservação.</td></tr><tr><td>Defeito de fabricação ou reparo</td><td>Garantia do fabricante, da peça ou do serviço, fora do seguro auto tradicional.</td></tr></tbody></table></div>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Seguro auto e garantia mecânica: qual a diferença?</h2>\n<p class=\"mb-4\">O seguro transfere riscos definidos no contrato, como colisão ou roubo quando incluídos. A garantia trata defeitos nas condições e no prazo do fabricante, vendedor, oficina ou produto específico. Um carro pode ter seguro e estar fora da garantia; também pode estar na garantia e sofrer um acidente coberto pelo seguro.</p>\n<p class=\"mb-4\">Antes de contratar uma proteção anunciada como “garantia estendida” ou “proteção mecânica”, identifique quem é o fornecedor, quais componentes entram, carência, limite, manutenção exigida e natureza jurídica do produto. Não use a promessa comercial como substituta das condições escritas.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">O que fazer quando o carro para</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>Pare em local seguro e evite insistir em ligar o motor se houver alerta de temperatura, óleo ou ruído anormal.</li><li>Acione a assistência pelo canal oficial e confirme destino, quilometragem e eventual custo excedente.</li><li>Não autorize desmontagem extensa antes de entender a documentação necessária para seguro ou garantia.</li><li>Registre sintomas, horário, local e circunstâncias; guarde ordens de serviço e comprovantes de manutenção.</li><li>Peça por escrito a causa provável e quais danos seriam consequência do evento.</li></ul>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Perguntas para comparar propostas</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>Quais eventos estão cobertos pelo casco?</li><li>Como o contrato trata falha mecânica, desgaste e falta de manutenção?</li><li>Qual é o limite de guincho por ocorrência e por vigência?</li><li>Há assistência para pane seca, bateria ou troca de pneu?</li><li>Quando há franquia e como ela se aplica a reparos ligados a um sinistro?</li><li>Quais documentos ajudam a demonstrar a causa do dano?</li></ul>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/seguro-auto-cobre-enchente-alagamento\">seguro auto em enchente e alagamento</a> · <a class=\"text-blue-700 underline\" href=\"/blog/franquia-reduzida-normal-seguro-auto-comparar\">franquia normal ou reduzida</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Quer comparar cobertura e assistência do seu seguro auto?</h2><p class=\"mb-5\">Envie sua apólice ou cotação à Elevance. Vamos conferir os riscos cobertos, as exclusões e os limites de assistência entre os parceiros autorizados.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Comparar meu seguro com a Elevance</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo, revisado em 04/09/2026. Coberturas, assistências, franquias, limites e exclusões dependem do produto e das condições contratuais. A causa e a cobertura de um dano são apuradas no caso concreto.</p>\n<p class=\"text-sm text-slate-600\">Fonte: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-de-automoveis\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro de automóveis, coberturas e assistência</a>.</p>"
},

  {
    "id": 137,
    "slug": "seguro-mercado-minimercado-freezer-estoque",
    "title": "Seguro para Mercado e Minimercado: Freezers, Estoque e RC",
    "date": "05 Set, 2026",
    "category": "Seguro Empresarial",
    "readTime": "5 min",
    "image": "https://images.unsplash.com/photo-1604719312566-8912e9227c6a?auto=format&fit=crop&q=80&w=800",
    "excerpt": "Veja como comparar proteção para freezers, estoque refrigerado, subtração, paralisação e responsabilidade civil em mercados e mercearias.",
    "content": "<p class=\"mb-4\">Um mercado pode perder mercadoria sem sofrer um incêndio: basta uma falha elétrica, um freezer parado durante a madrugada ou uma pane que só seja percebida na abertura. Por isso, cotar apenas “incêndio e roubo” costuma deixar sem resposta justamente os riscos mais ligados à rotina do negócio.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">O seguro empresarial básico resolve tudo?</h2>\n<p class=\"mb-4\">Não. A cobertura básica e as coberturas adicionais precisam ser lidas separadamente. A Susep explica que seguros compreensivos reúnem diferentes riscos em uma apólice, mas a proteção efetiva depende do que foi contratado, dos limites e das exclusões.</p>\n<p class=\"mb-4\">Para mercado, minimercado, mercearia ou empório, a cotação deve separar prédio, móveis, equipamentos, mercadorias e responsabilidade perante clientes. A verba para conteúdo não deve ser presumida como um limite único disponível para qualquer prejuízo.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Freezer parado: dano elétrico, quebra de máquina ou deterioração?</h2>\n<p class=\"mb-4\">São exposições diferentes. Danos elétricos podem tratar danos causados por fenômenos elétricos aos equipamentos, conforme a definição contratual. Quebra de máquinas pode ter outra abrangência. Já a perda de carnes, laticínios, congelados e outros produtos depende de cobertura para deterioração de mercadorias, com causas e condições especificadas.</p>\n<p class=\"mb-4\">Uma cobertura para o freezer não significa automaticamente pagamento do estoque perdido dentro dele. Da mesma forma, contratar deterioração não dispensa manutenção, registro de temperatura e procedimentos de contingência. Pergunte quais eventos precisam causar a paralisação e qual documentação será exigida.</p>\n<div class=\"overflow-x-auto my-6\"><table class=\"w-full text-left\"><thead><tr><th scope=\"col\">Risco</th><th scope=\"col\">O que conferir na proposta</th></tr></thead><tbody><tr><td>Curto-circuito em freezer ou balança</td><td>Danos elétricos, franquia e bens abrangidos.</td></tr><tr><td>Falha mecânica de equipamento</td><td>Quebra de máquinas e exclusões de desgaste ou manutenção.</td></tr><tr><td>Produtos perecíveis impróprios</td><td>Deterioração de mercadorias, causas cobertas e sublimite.</td></tr><tr><td>Loja fechada após sinistro</td><td>Lucros cessantes ou despesas fixas e período indenitário.</td></tr><tr><td>Cliente sofre dano no estabelecimento</td><td>Responsabilidade civil de operações.</td></tr></tbody></table></div>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Subtração de mercadorias e dinheiro</h2>\n<p class=\"mb-4\">A palavra “roubo” no orçamento não deve ser interpretada como proteção para todo desaparecimento. Verifique como o contrato define roubo e furto qualificado, quais vestígios ou documentos são necessários e se há exclusões para desaparecimento inexplicável, apropriação por funcionários ou mercadoria deixada fora das áreas declaradas.</p>\n<p class=\"mb-4\">Dinheiro em caixa, numerário em trânsito, celulares, cigarros, bebidas e outros itens visados podem ter sublimites ou exigir contratação específica. Informe os valores máximos normalmente mantidos no local, inclusive em datas de maior movimento.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Como calcular o estoque sem usar uma média enganosa</h2>\n<p class=\"mb-4\">O estoque de um minimercado varia ao longo do mês e cresce antes de feriados, datas comemorativas e promoções. Declare o pico razoavelmente esperado, não apenas uma fotografia de um dia fraco. Separe mercadoria seca, refrigerada, congelada e de maior valor.</p>\n<p class=\"mb-4\">Confira se a apólice trabalha com limite máximo de indenização, rateio, primeiro risco ou outra regra. Estoque subestimado pode reduzir a proteção no momento em que a loja está mais abastecida. Guarde inventários, notas fiscais e relatórios do sistema de vendas.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Lucros cessantes: quanto tempo a loja levaria para voltar?</h2>\n<p class=\"mb-4\">A cobertura de lucros cessantes ou despesas fixas, quando disponível e contratada, costuma depender de um dano material coberto que interrompa a operação. Não basta a loja ter faturado menos por qualquer motivo.</p>\n<p class=\"mb-4\">Para dimensionar o período, pense em limpeza, perícia, reposição de equipamentos, obras, licenças e recomposição do estoque. Considere aluguel, folha, energia mínima, sistemas e outras despesas que continuam mesmo com as portas fechadas. O período indenitário precisa ser comparado junto com o valor segurado.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Responsabilidade civil e circulação de clientes</h2>\n<p class=\"mb-4\">Piso molhado, queda de mercadoria, carrinho, estacionamento, entrega e alimentos preparados podem gerar reclamações de terceiros. A RC de operações precisa refletir as atividades reais. Padaria, açougue, rotisseria, entrega própria, botijão de gás e estacionamento não devem aparecer somente depois de um incidente.</p>\n<p class=\"mb-4\">Danos a empregados, produtos vendidos e veículos podem ter tratamento separado. Confirme quem é considerado terceiro e quais atividades estão incluídas.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para pedir propostas comparáveis</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>Endereço, área construída, tipo de imóvel e medidas de proteção.</li><li>Valor do prédio, benfeitorias, móveis, equipamentos e sistemas.</li><li>Estoque médio e máximo, separado entre seco, refrigerado e congelado.</li><li>Freezers, câmaras frias, gerador e plano de contingência.</li><li>Valores de dinheiro, itens visados e transporte de numerário.</li><li>Faturamento, despesas fixas e prazo estimado de recuperação.</li><li>Padaria, açougue, rotisseria, delivery, estacionamento e outras atividades.</li><li>Histórico de sinistros e manutenção elétrica e dos equipamentos.</li></ul>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/seguro-padaria-confeitaria-fornos-camara-fria\">seguro para padaria e confeitaria</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-empresarial-para-farmacia-coberturas\">seguro empresarial para farmácia</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Quer comparar o seguro do seu mercado?</h2><p class=\"mb-5\">Envie o perfil da operação à Elevance. Vamos organizar estoque, equipamentos, paralisação e responsabilidade civil para comparar as opções disponíveis entre os parceiros autorizados.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Cotar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo, revisado em 05/09/2026. Disponibilidade, aceitação, coberturas, franquias, limites e exclusões dependem do produto e da análise de risco. A indenização depende das condições da apólice e da apuração do evento.</p>\n<p class=\"text-sm text-slate-600\">Fonte: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/copy_of_planos-e-produtos/seguros/seguro-compreensivo\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguros compreensivos</a>.</p>"
  },

  {
    "id": 138,
    "slug": "seguro-estacionamento-valet-veiculos-clientes",
    "title": "Seguro para Estacionamento e Valet: Veículos de Clientes e RC",
    "date": "06 Set, 2026",
    "category": "Responsabilidade Civil",
    "readTime": "5 min",
    "image": "https://images.unsplash.com/photo-1506521781263-d8422e82f27a?auto=format&fit=crop&q=80&w=800",
    "excerpt": "Entenda como comparar proteção para veículos sob guarda, colisões durante manobras, subtração, incêndio e responsabilidade civil.",
    "content": "<p class=\"mb-4\">Um estacionamento pode ter câmeras, controle de chaves e manobristas treinados e ainda assim sofrer colisão, subtração, incêndio ou reclamação por um objeto deixado dentro do carro. O erro mais comum na cotação é tratar todos esses riscos como se fossem apenas “responsabilidade civil”.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">RC operacional cobre automaticamente os carros dos clientes?</h2>\n<p class=\"mb-4\">Não se deve presumir. O seguro de responsabilidade civil protege o interesse do segurado diante de reclamações abrangidas pelo contrato, mas bens sob guarda, custódia ou controle podem exigir previsão específica. Para estacionamento e valet, a proposta precisa dizer claramente como trata veículos de terceiros recebidos pela operação.</p>\n<p class=\"mb-4\">Uma cobertura genérica para danos corporais e materiais a terceiros pode não responder da mesma forma a um automóvel confiado ao estabelecimento. Nome comercial, atividade declarada, definição de veículo, locais e situações cobertas precisam aparecer por escrito.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Estacionamento fixo e serviço de valet têm riscos diferentes</h2>\n<p class=\"mb-4\">No estacionamento fixo, é necessário informar endereço, capacidade, áreas cobertas ou abertas, controle de entrada, circulação e medidas de segurança. No valet, os veículos podem ser recebidos em restaurante, clínica ou evento e conduzidos até outro local. O trajeto e o ponto onde ficam guardados não devem ser omitidos.</p>\n<p class=\"mb-4\">Se a empresa atende vários estabelecimentos ou eventos temporários, confira se todos os locais e modalidades são aceitos. Uma apólice vinculada a um endereço não deve ser interpretada como autorização automática para operar em qualquer lugar.</p>\n<div class=\"overflow-x-auto my-6\"><table class=\"w-full text-left\"><thead><tr><th scope=\"col\">Situação</th><th scope=\"col\">Ponto a verificar</th></tr></thead><tbody><tr><td>Manobrista bate o carro</td><td>Condução, movimentação, motoristas autorizados, franquia e limite.</td></tr><tr><td>Veículo é subtraído</td><td>Definição de roubo ou furto qualificado, chaves e procedimentos de controle.</td></tr><tr><td>Incêndio atinge vários carros</td><td>Limite por evento, agregado e quantidade máxima de veículos.</td></tr><tr><td>Objeto some do interior</td><td>Bens deixados no veículo, comprovantes e exclusões.</td></tr><tr><td>Cliente cai no local</td><td>RC operacional do estabelecimento, separada da guarda do automóvel.</td></tr></tbody></table></div>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Colisão durante a manobra</h2>\n<p class=\"mb-4\">Informe quem dirige: empregados registrados, terceiros, autônomos ou equipe do estabelecimento contratante. Idade mínima, habilitação, vínculo e treinamento podem fazer parte da análise de risco. Se qualquer funcionário pega a chave “quando aperta”, a cotação precisa refletir essa realidade.</p>\n<p class=\"mb-4\">Pergunte como funciona a franquia quando uma manobra atinge dois veículos e se existe limite por veículo e por ocorrência. O seguro do automóvel do cliente não elimina a possível responsabilidade do estacionamento; as seguradoras podem discutir ressarcimento após o pagamento.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Roubo, furto e entrega da chave à pessoa errada</h2>\n<p class=\"mb-4\">Controle de tickets, conferência de documentos, registro fotográfico e guarda das chaves ajudam a prevenir perdas e demonstrar o procedimento adotado. A apólice pode diferenciar subtração com ameaça, arrombamento, fraude ou entrega indevida.</p>\n<p class=\"mb-4\">Não prometa ao cliente “cobertura total” com base apenas na existência do seguro. Equipamentos, pertences, dinheiro e mercadorias dentro do veículo podem ter exclusões ou limites próprios.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quantos veículos cabem no limite contratado?</h2>\n<p class=\"mb-4\">Um limite que parece alto para um único carro pode ser insuficiente quando incêndio, queda de estrutura ou outro evento atinge vários veículos. Levante capacidade máxima, valor médio e presença eventual de automóveis de maior valor.</p>\n<p class=\"mb-4\">Confira limite por veículo, por evento e agregado durante a vigência. Informe também picos de lotação em festas, fins de semana e eventos. A análise não deve usar somente a ocupação de uma tarde vazia.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Seguro do prédio e seguro da operação</h2>\n<p class=\"mb-4\">O seguro empresarial pode proteger escritório, cancelas, câmeras, computadores e outros bens próprios contra riscos contratados. Ele não substitui automaticamente a responsabilidade por veículos de clientes. O proprietário do imóvel, o operador do estacionamento e a empresa de valet podem precisar de proteções distintas.</p>\n<p class=\"mb-4\">Se existe contrato com shopping, restaurante, condomínio ou clínica, revise obrigações de seguro, limites mínimos e responsabilidades assumidas. Um contrato comercial pode atribuir riscos além daqueles contemplados na apólice atual.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para uma cotação comparável</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>Atividade: estacionamento, garagem, valet fixo ou eventos.</li><li>Endereços, trajetos e locais externos usados para guardar veículos.</li><li>Capacidade máxima e valor estimado dos carros sob custódia.</li><li>Número, vínculo e perfil dos manobristas.</li><li>Controle de chaves, tickets, imagens e acesso.</li><li>Cobertura para colisão, incêndio, subtração e danos durante movimentação.</li><li>Limites por veículo, por evento e agregado; franquias aplicáveis.</li><li>Tratamento de acessórios e objetos no interior.</li><li>Histórico de reclamações e contratos com estabelecimentos parceiros.</li></ul>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/seguro-oficina-mecanica-auto-center-veiculos-clientes\">veículos de clientes em oficinas e auto centers</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-empresarial-o-que-cobre\">como funciona a responsabilidade civil no seguro</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Quer cotar a proteção do seu estacionamento ou valet?</h2><p class=\"mb-5\">A Elevance ajuda a mapear veículos sob guarda, manobristas, locais e limites para comparar as opções disponíveis entre os parceiros autorizados.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo, revisado em 06/09/2026. Disponibilidade, aceitação, coberturas, limites, franquias e exclusões dependem do produto, da atividade declarada e da análise de risco.</p>\n<p class=\"text-sm text-slate-600\">Fontes: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-responsabilidade-civil\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro de responsabilidade civil</a> · <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/copy_of_planos-e-produtos/seguros/seguro-compreensivo\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguros compreensivos</a>.</p>"
  },

  {
    "id": 139,
    "slug": "seguro-fotografo-produtora-equipamentos-responsabilidade-civil",
    "title": "Seguro para Fotógrafo e Produtora: Equipamentos, Eventos e RC",
    "date": "07 Set, 2026",
    "category": "Seguro Empresarial",
    "readTime": "5 min",
    "image": "https://images.unsplash.com/photo-1452780212940-6f5c0d14d848?auto=format&fit=crop&q=80&w=800",
    "excerpt": "Veja como comparar proteção para câmeras, lentes, equipamentos em trânsito, trabalhos externos, estúdio e responsabilidade civil.",
    "content": "<p class=\"mb-4\">Uma câmera cara não resume o risco de um fotógrafo ou de uma produtora. Lentes, iluminação, computadores, drones e equipamentos alugados circulam entre estúdio, eventos e locações. Ao mesmo tempo, uma falha na prestação do serviço, um tripé que causa um acidente ou a perda de arquivos pode gerar reclamações de clientes e terceiros.</p>\n<p class=\"mb-4\">Por isso, a cotação precisa separar patrimônio próprio, bens em trânsito, equipamentos de terceiros e responsabilidade civil. Uma apólice empresarial genérica não deve ser presumida como proteção automática para tudo o que sai do endereço segurado.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Seguro empresarial, equipamentos portáteis ou RC?</h2>\n<p class=\"mb-4\"><strong>Seguro empresarial:</strong> pode reunir coberturas patrimoniais para o estúdio ou escritório, como incêndio, danos elétricos, subtração e quebra de vidros, conforme contratação.</p>\n<p class=\"mb-4\"><strong>Equipamentos portáteis:</strong> pode ser necessário para câmeras, lentes, notebooks e iluminação usados fora do local fixo. Território de cobertura, forma de subtração, dano acidental e transporte precisam estar expressos nas condições.</p>\n<p class=\"mb-4\"><strong>Responsabilidade civil:</strong> protege o interesse do segurado quando ele é responsabilizado por danos a terceiros, dentro dos eventos e limites contratados. A Susep distingue RC Geral de RC Profissional; a classificação adequada depende da natureza da reclamação e do produto oferecido pela seguradora.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Câmeras e lentes dentro e fora do estúdio</h2>\n<p class=\"mb-4\">Faça um inventário com marca, modelo, número de série, nota fiscal e valor de reposição. Informe quais itens permanecem no endereço, quais viajam com frequência e se ficam em veículos, hotéis, aeronaves ou locais de evento.</p>\n<p class=\"mb-4\">Roubo, furto qualificado e simples desaparecimento não são sinônimos no contrato. Também confirme se queda, líquido, areia, maresia, oscilação elétrica e dano durante transporte estão incluídos ou excluídos. Não escolha apenas pelo limite total: confira franquia e sublimite por item.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Equipamento alugado ou de assistentes</h2>\n<p class=\"mb-4\">Corpos de câmera, lentes e iluminação alugados não devem ser tratados como bens próprios sem confirmação. O contrato de locação pode transferir responsabilidades e exigir seguro específico. Bens de freelancers, sócios e assistentes também precisam ser declarados corretamente.</p>\n<p class=\"mb-4\">Quando há equipe, relacione quem opera cada equipamento e como funciona a guarda. A aceitação pode considerar experiência, atividade, frequência de deslocamento, valores expostos e histórico de perdas.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Casamento, show, estúdio ou produção publicitária</h2>\n<p class=\"mb-4\">O perfil muda o risco. Em casamento, há público, deslocamento e compromisso com uma data que não pode ser repetida facilmente. Em show, multidão, estruturas e acesso controlado exigem atenção. No estúdio, instalações elétricas, cenários e circulação de clientes entram no levantamento. Produções publicitárias podem usar locações, equipes maiores e bens de terceiros.</p>\n<p class=\"mb-4\">Informe todas as atividades reais, inclusive filmagem, edição, transmissão ao vivo e uso de drone. Não presuma que uma ocupação declarada cobre automaticamente serviços adicionais.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Responsabilidade por acidentes e falhas profissionais</h2>\n<p class=\"mb-4\">Um cabo no caminho pode causar queda; uma luminária pode danificar o local; uma orientação inadequada pode ser associada a prejuízo. Esses exemplos têm natureza diferente de uma alegação de erro profissional, como entrega incompatível com o serviço contratado.</p>\n<p class=\"mb-4\">Compare quem aparece como segurado, quais atividades estão descritas, limites por ocorrência e agregado, danos materiais, corporais e morais, custos de defesa, franquia e território. Em apólices à base de reclamações, confira também retroatividade e prazo adicional.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Arquivos, cartões e responsabilidade digital</h2>\n<p class=\"mb-4\">Backup é essencial, mas não transforma automaticamente perda de arquivo em evento indenizável. Pergunte como a apólice trata dados, mídia, restauração, ataque cibernético, privacidade e falha de entrega. Equipamento danificado e conteúdo perdido são prejuízos distintos.</p>\n<p class=\"mb-4\">Mantenha cópias em locais separados, controle de acesso e processo documentado de transferência dos arquivos. Essas práticas reduzem exposição e ajudam a descrever o risco com precisão.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para pedir propostas comparáveis</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>Atividades realizadas e percentual de trabalho em estúdio e em locação.</li><li>Lista de equipamentos próprios, alugados e de terceiros, com valores.</li><li>Territórios e meios de transporte usados.</li><li>Locais e tipos de evento atendidos.</li><li>Equipe fixa, freelancers e operadores de drone.</li><li>Cobertura para subtração, dano acidental, danos elétricos e bens em trânsito.</li><li>Limites, sublimites por item, franquias e critérios de reposição.</li><li>RC Geral e RC Profissional, com atividades e pessoas seguradas.</li><li>Tratamento de arquivos, privacidade, custos de defesa e danos morais.</li><li>Histórico de sinistros e medidas de segurança.</li></ul>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/seguro-para-notebook-celular-equipamentos-portateis-empresa\">seguro para equipamentos portáteis da empresa</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-empresarial-o-que-cobre\">como funciona o seguro empresarial</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Quer comparar proteção para sua operação de fotografia?</h2><p class=\"mb-5\">A Elevance ajuda a mapear equipamentos, locais, serviços e responsabilidades para consultar as opções disponíveis entre os parceiros autorizados.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo, revisado em 07/09/2026. Disponibilidade, aceitação, coberturas, limites, franquias e exclusões dependem do produto, das atividades declaradas e da análise de risco.</p>\n<p class=\"text-sm text-slate-600\">Fontes: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/copy_of_planos-e-produtos/seguros/seguro-compreensivo\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro compreensivo</a> · <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/copy_of_planos-e-produtos/seguros/seguro-de-responsabilidade\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro de responsabilidade</a>.</p>"
  },

  {
    "id": 140,
    "slug": "seguro-vida-individual-vs-grupo-sair-empresa",
    "title": "Seguro de Vida Individual ou em Grupo: O Que Acontece ao Sair da Empresa?",
    "date": "08 Set, 2026",
    "category": "Seguro de Vida",
    "readTime": "5 min",
    "image": "https://images.unsplash.com/photo-1529156069898-49953e39b3ac?auto=format&fit=crop&q=80&w=800",
    "excerpt": "Compare seguro de vida individual e coletivo, entenda o papel do estipulante e planeje sua proteção caso o vínculo com a empresa termine.",
    "content": "<p class=\"mb-4\">Ter seguro de vida pela empresa é uma vantagem importante, mas ele não deve ser confundido com uma proteção necessariamente permanente. Se o vínculo de trabalho ou associativo termina, a permanência no seguro coletivo depende das regras da apólice e das alternativas oferecidas.</p>\n<p class=\"mb-4\">O seguro individual e o seguro em grupo podem coexistir. A comparação certa não é apenas “qual custa menos?”, e sim quem contrata, quem controla a apólice, quais coberturas existem, como o capital foi calculado e o que acontece quando sua relação com o grupo muda.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quem contrata cada modalidade?</h2>\n<p class=\"mb-4\"><strong>No seguro individual</strong>, a contratação é feita diretamente para a pessoa segurada, conforme proposta, condições e aceitação da seguradora. O cliente acompanha vigência, prêmio, beneficiários e alterações do próprio contrato.</p>\n<p class=\"mb-4\"><strong>No seguro coletivo</strong>, os segurados aderem a uma apólice contratada por um estipulante, que os representa perante a seguradora. O estipulante pode ser uma empresa, associação ou outra organização admitida pela regulamentação e pelo produto.</p>\n<p class=\"mb-4\">Isso muda a governança da proteção. No coletivo, regras do contrato principal e do vínculo de elegibilidade importam. No individual, o relacionamento contratual não depende de permanecer empregado ou associado ao mesmo grupo.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">O seguro em grupo termina na demissão?</h2>\n<p class=\"mb-4\">Não existe uma resposta universal sem ler o certificado e as condições. A saída do grupo segurado pode encerrar a cobertura, permitir permanência temporária ou oferecer outra alternativa, conforme o contrato. Não presuma continuidade automática nem cancelamento imediato apenas pela memória de um benefício antigo.</p>\n<p class=\"mb-4\">Peça ao RH ou estipulante o certificado individual, as coberturas, os capitais, a data de término e o procedimento em caso de desligamento. Se houver possibilidade de conversão ou nova contratação, confirme prazo, preço, necessidade de nova análise e diferenças de cobertura antes de decidir.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Capital segurado: benefício padrão ou necessidade real?</h2>\n<p class=\"mb-4\">Muitas apólices coletivas usam capital fixo ou múltiplo salarial. Isso facilita a administração, mas pode não refletir dívidas, renda familiar, filhos, prazo de reorganização e patrimônio disponível.</p>\n<p class=\"mb-4\">No individual, há mais espaço para dimensionar capital e escolher coberturas conforme o perfil, sujeito às regras do produto. Compare valores por cobertura, e não somente o número grande exibido no resumo. Morte, invalidez, doenças graves e diárias têm gatilhos e limites próprios.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Preço baixo do coletivo significa melhor custo-benefício?</h2>\n<p class=\"mb-4\">O grupo pode favorecer condições de contratação, mas o preço isolado não resolve a comparação. Verifique custeio integral ou compartilhado pela empresa, atualização de prêmio, faixas etárias, capital, carências quando aplicáveis, exclusões e duração da cobertura.</p>\n<p class=\"mb-4\">Uma proteção aparentemente barata pode ser insuficiente; uma individual mais completa pode custar mais. Também é possível que o coletivo já atenda parte relevante da necessidade e o individual funcione como complemento. A decisão depende da lacuna, não de uma regra única.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Beneficiários e comunicação com a família</h2>\n<p class=\"mb-4\">Confira como os beneficiários estão registrados em cada contrato. Atualizar um seguro individual não atualiza automaticamente a apólice coletiva, e o contrário também não ocorre. Mudanças familiares merecem revisão separada.</p>\n<p class=\"mb-4\">Guarde certificado, número da apólice, canais de aviso e contatos do corretor ou estipulante em local acessível. A família precisa saber que a cobertura existe; não basta o segurado lembrar do desconto no holerite.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quando faz sentido manter os dois?</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>Quando o capital do benefício empresarial não cobre a necessidade estimada.</li><li>Quando você quer uma proteção que não dependa do emprego atual.</li><li>Quando as modalidades oferecem coberturas complementares.</li><li>Quando há mudança frequente de vínculo ou atuação como autônomo paralelamente.</li><li>Quando a família depende da renda por um período maior que o capital coletivo suportaria.</li></ul>\n<p class=\"mb-4\">Manter dois seguros não significa receber automaticamente duas indenizações em qualquer situação. Cada cobertura precisa ter o evento caracterizado e respeitar suas próprias condições. Informe corretamente outras coberturas quando isso for solicitado na proposta.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist antes de depender apenas do benefício da empresa</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>Quem é o estipulante e qual é a seguradora?</li><li>Qual é a vigência e quem pode permanecer no grupo?</li><li>Quais coberturas e capitais constam no certificado?</li><li>O prêmio é pago pela empresa, pelo segurado ou por ambos?</li><li>O que acontece em demissão, aposentadoria, afastamento ou saída da associação?</li><li>Há prazo ou opção de conversão? Quais condições mudam?</li><li>Os beneficiários estão atualizados?</li><li>Qual lacuna permaneceria se essa proteção terminasse amanhã?</li></ul>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/quanto-de-seguro-de-vida-eu-preciso\">como calcular o capital do seguro de vida</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-vida-invalidez-acidente-doenca-diferencas\">diferenças entre invalidez por acidente e por doença</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Quer comparar sua proteção coletiva com uma opção individual?</h2><p class=\"mb-5\">A Elevance ajuda a levantar coberturas, capitais e dependências do vínculo para consultar as alternativas disponíveis entre os parceiros autorizados.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo, revisado em 08/09/2026. Disponibilidade, aceitação, coberturas, capitais, prêmios, vigência, carências e exclusões dependem do produto e das condições contratuais.</p>\n<p class=\"text-sm text-slate-600\">Fontes: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/planos-e-produtos/seguros/seguro-de-pessoas\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro de pessoas</a> · <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-de-vida-e-acidentes-pessoais\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro de vida e acidentes pessoais</a>.</p>"
  },

  {
    "id": 141,
    "slug": "seguro-ecommerce-loja-virtual-estoque-cyber",
    "title": "Seguro para E-commerce e Loja Virtual: Estoque, Entregas e Risco Cyber",
    "date": "09 Set, 2026",
    "category": "Seguro Empresarial",
    "readTime": "5 min",
    "image": "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&q=80&w=800",
    "excerpt": "Entenda como comparar proteção para estoque, equipamentos, entregas, dados, responsabilidade civil e paralisação de uma operação on-line.",
    "content": "<p class=\"mb-4\">Uma loja virtual pode não ter vitrine nem porta aberta para o público, mas continua exposta a perdas patrimoniais, falhas operacionais e reclamações de clientes. Estoque, notebooks, meios de pagamento, dados pessoais, transportadoras e marketplaces fazem parte do risco — e não cabem automaticamente em uma única cobertura.</p>\n<p class=\"mb-4\">A cotação começa pelo desenho real da operação. Quem guarda mercadoria em casa, usa centro de distribuição terceirizado e vende só por marketplace tem necessidades diferentes de quem possui galpão próprio, equipe, site e frota de entrega.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Seguro empresarial não é sinônimo de “seguro do e-commerce inteiro”</h2>\n<p class=\"mb-4\">O compreensivo empresarial pode reunir coberturas patrimoniais em uma mesma apólice, conforme o produto contratado. Incêndio, danos elétricos, subtração, vendaval, quebra de vidros e lucros cessantes são exemplos de riscos que podem ser avaliados, mas endereço, atividade e bens precisam estar corretamente declarados.</p>\n<p class=\"mb-4\">O site, a conta do marketplace, a mercadoria em trânsito e a responsabilidade por um produto não devem ser presumidos como extensões automáticas da proteção do imóvel. Cada frente exige confirmação nas condições e nos limites.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Estoque em casa: residencial ou empresarial?</h2>\n<p class=\"mb-4\">Se um quarto, garagem ou parte da residência virou depósito, informe isso antes da contratação. Seguro residencial protege a moradia dentro das condições contratadas; mercadoria destinada à venda e atividade comercial podem receber tratamento diferente ou estar excluídas.</p>\n<p class=\"mb-4\">Declare o endereço, tipo de construção, valor máximo armazenado, sazonalidade, prateleiras, embalagens, medidas contra incêndio e controle de acesso. Black Friday e datas comemorativas podem elevar o estoque muito acima da média anual.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Mercadoria com transportadora ou nos Correios</h2>\n<p class=\"mb-4\">A responsabilidade do transportador e o interesse do dono da mercadoria são proteções diferentes. Contrato de frete, declaração de valor e eventual seguro oferecido no envio precisam ser lidos; o seguro empresarial do endereço não acompanha necessariamente o pacote até o cliente.</p>\n<p class=\"mb-4\">Mapeie volume mensal, valor médio e máximo por remessa, tipos de produto, destinos, devoluções e pontos de coleta. Também confirme quando a responsabilidade passa do vendedor para o comprador e quais documentos serão exigidos em caso de avaria, extravio ou subtração.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Produto defeituoso e responsabilidade civil</h2>\n<p class=\"mb-4\">Um cliente pode alegar dano causado pelo produto, erro de separação, informação inadequada ou falha na prestação do serviço. Responsabilidade civil não cobre qualquer desentendimento comercial: o evento, a atividade, o dano e a obrigação de indenizar precisam se enquadrar no contrato.</p>\n<p class=\"mb-4\">Informe se a empresa fabrica, importa, monta, personaliza ou apenas revende. Produtos alimentícios, cosméticos, eletrônicos, brinquedos e itens de terceiros têm exposições diferentes. Custos de defesa, danos materiais, corporais e morais, recall e território devem ser conferidos quando relevantes.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Ataque digital, vazamento e conta bloqueada</h2>\n<p class=\"mb-4\">Risco cibernético pode envolver incidentes com sistemas, informações, segurança e responsabilização perante terceiros, conforme a cobertura contratada. Ransomware, vazamento de dados, restauração, notificação e interrupção digital não devem ser confundidos com dano elétrico no computador.</p>\n<p class=\"mb-4\">Já a suspensão de uma conta por regra do marketplace ou falha puramente comercial não é automaticamente um sinistro. Pergunte quais eventos acionam a cobertura de interrupção, qual franquia temporal existe e como o prejuízo precisa ser comprovado.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Equipamentos, dinheiro e fraude</h2>\n<p class=\"mb-4\">Notebooks, leitores, câmeras e celulares podem precisar de cobertura no endereço e fora dele. Valores recebidos, chargeback, fraude em pagamento e engenharia social também têm tratamentos distintos. Não use a palavra “roubo” como atalho para qualquer desaparecimento de dinheiro ou mercadoria.</p>\n<p class=\"mb-4\">Controle de acesso, autenticação em dois fatores, backups, conciliação de pagamentos e inventário ajudam a reduzir a exposição e a apresentar melhor o risco na cotação.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para comparar propostas</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>CNPJ, atividades realizadas e canais de venda.</li><li>Endereços próprios, residência, galpões e operadores logísticos.</li><li>Valor médio e máximo do estoque, incluindo sazonalidade.</li><li>Equipamentos próprios e usados fora do endereço.</li><li>Volume, valor e modalidades de transporte.</li><li>Fabricação, importação, marca própria ou simples revenda.</li><li>Dados pessoais tratados, site, meios de pagamento e marketplaces.</li><li>Coberturas patrimoniais, RC, cyber, transporte e lucros cessantes.</li><li>Limites, sublimites, franquias e critérios de indenização.</li><li>Histórico de perdas e medidas de segurança.</li></ul>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/seguro-empresarial-o-que-cobre\">como funciona o seguro empresarial</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-transporte-carga-embarcador-vs-transportadora\">seguro da carga e responsabilidade da transportadora</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Quer cotar a proteção da sua loja virtual?</h2><p class=\"mb-5\">A Elevance ajuda a mapear estoque, endereços, entregas e riscos digitais para comparar as opções disponíveis entre os parceiros autorizados.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo, revisado em 09/09/2026. Disponibilidade, aceitação, coberturas, limites, franquias, carências e exclusões dependem do produto, das atividades declaradas e da análise de risco.</p>\n<p class=\"text-sm text-slate-600\">Fontes: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/copy_of_planos-e-produtos/seguros/seguro-compreensivo\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro compreensivo</a> · <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/copy_of_planos-e-produtos/seguros/seguro-de-responsabilidade\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro de responsabilidade</a>.</p>"
  },

  {
    "id": 142,
    "slug": "seguro-deposito-distribuidora-estoque-empilhadeira",
    "title": "Seguro para Depósito e Distribuidora: Estoque, Empilhadeira e RC",
    "date": "10 Set, 2026",
    "category": "Seguro Empresarial",
    "readTime": "6 min",
    "image": "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&q=80&w=800",
    "excerpt": "Compare proteção para prédio, estoque próprio e de terceiros, empilhadeiras, carga e descarga, transporte, responsabilidade civil e paralisação.",
    "content": "<p class=\"mb-4\">Um depósito pode concentrar em um único endereço mercadorias de alto valor, estruturas porta-paletes, empilhadeiras, câmaras frias e uma operação diária de carga e descarga. Para uma distribuidora, proteger apenas o prédio deixa perguntas importantes sem resposta: de quem é o estoque, onde ele circula e o que acontece se a operação parar?</p>\n<p class=\"mb-4\">A cotação precisa retratar a atividade real. Um atacadista com mercadoria própria, um operador que guarda bens de terceiros e uma distribuidora que também entrega pedidos podem precisar de combinações diferentes de proteção.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Seguro empresarial protege prédio e estoque da mesma forma?</h2>\n<p class=\"mb-4\">O seguro compreensivo empresarial pode reunir coberturas patrimoniais em uma apólice, conforme o produto. Isso não significa que todo bem existente no endereço esteja automaticamente incluído. Edificação, máquinas, móveis, mercadorias e benfeitorias devem aparecer com critérios e limites coerentes.</p>\n<p class=\"mb-4\">Se o imóvel é alugado, separe as responsabilidades do proprietário e do ocupante. Confira quem responde por estrutura, instalações, melhorias e conteúdo. A apólice do condomínio ou do dono do galpão não substitui necessariamente a proteção da operação.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Estoque próprio, consignado e de terceiros</h2>\n<p class=\"mb-4\">Informe quem é o proprietário das mercadorias e quais contratos regem a guarda. Bens de clientes ou fornecedores podem exigir declaração e cobertura específica. Não presuma que a soma destinada a estoque próprio também indenizará mercadoria de terceiros.</p>\n<p class=\"mb-4\">O valor segurado precisa considerar picos. Uma distribuidora pode dobrar o estoque antes de datas sazonais ou receber um lote fora do padrão médio. Compare cláusulas para variação de estoque e o procedimento para comunicar mudanças relevantes.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Incêndio não resolve todos os danos</h2>\n<p class=\"mb-4\">A Susep explica que o seguro compreensivo é modular e que incêndio, dano elétrico e outros eventos podem receber coberturas distintas. Curto-circuito em um equipamento sem propagação de fogo, por exemplo, não deve ser tratado automaticamente como incêndio.</p>\n<p class=\"mb-4\">Avalie incêndio, raio, explosão, danos elétricos, vendaval, alagamento, impacto de veículos, subtração e quebra de vidros conforme a exposição do local. Produtos vegetais ou materiais sujeitos a aquecimento e combustão espontânea exigem descrição cuidadosa, pois o evento pode não se enquadrar como incêndio.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Empilhadeira, porta-paletes e movimentação interna</h2>\n<p class=\"mb-4\">Uma empilhadeira pode ser patrimônio, equipamento móvel e fonte de danos a mercadorias, estruturas ou pessoas. Pergunte se ela está incluída no conteúdo segurado, em quais locais pode operar e como colisão, tombamento, pane e dano elétrico são tratados.</p>\n<p class=\"mb-4\">A queda de uma carga ou o colapso de uma estrutura de armazenagem não deve ser presumido como evento coberto. Informe altura, capacidade, tipo de estrutura, manutenção, treinamento, circulação de terceiros e processos de inspeção.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Mercadoria refrigerada e falha de energia</h2>\n<p class=\"mb-4\">Quem armazena alimentos, medicamentos, cosméticos ou outros produtos sensíveis à temperatura precisa separar dano ao equipamento de deterioração do estoque. Uma cobertura pode responder pela máquina e não pelo conteúdo perdido.</p>\n<p class=\"mb-4\">Compare causas aceitas, tempo mínimo, franquia, registros de temperatura, manutenção preventiva, gerador e plano de contingência. Também confirme se interrupção do fornecimento externo de energia está contemplada ou excluída.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Carga, descarga e mercadoria em trânsito</h2>\n<p class=\"mb-4\">O seguro do endereço não acompanha automaticamente o produto durante coleta e entrega. Se a distribuidora utiliza frota própria ou transportadores contratados, descreva trajetos, valores por embarque, tipo de veículo, pernoite, devoluções e documentos de transporte.</p>\n<p class=\"mb-4\">Danos durante carga e descarga também precisam de confirmação. O local do evento e o momento em que começa ou termina a cobertura podem mudar o enquadramento entre seguro patrimonial, transporte e responsabilidade do transportador.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Responsabilidade civil e circulação de terceiros</h2>\n<p class=\"mb-4\">Motoristas, fornecedores e clientes podem circular no pátio enquanto equipamentos trabalham. A responsabilidade civil geral pode proteger o interesse do segurado quando ele for responsabilizado por danos a terceiros, desde que o evento e a atividade estejam cobertos e as condições sejam atendidas.</p>\n<p class=\"mb-4\">Compare danos materiais, corporais e morais, operações, carga e descarga, bens sob guarda, empregador e custos de defesa. Cada item precisa ser confirmado; a presença da sigla RC no resumo não significa cobertura irrestrita.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Paralisação e lucros cessantes</h2>\n<p class=\"mb-4\">Depois de um dano físico coberto, a empresa pode continuar pagando aluguel, salários e contratos enquanto perde faturamento. A cobertura de lucros cessantes, quando contratada, depende dos gatilhos, do período indenitário, da franquia temporal e da comprovação prevista na apólice.</p>\n<p class=\"mb-4\">Estime quanto tempo levaria para repor estruturas, licenças, equipamentos e mercadorias. Um limite alto com período curto pode não acompanhar a recuperação real; um período longo sem documentação financeira adequada também dificulta a análise.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para solicitar propostas comparáveis</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>Atividades do CNPJ e mercadorias armazenadas.</li><li>Endereço, área construída, tipo de construção e ocupação vizinha.</li><li>Valores separados de prédio, instalações, equipamentos e estoque.</li><li>Estoque médio, máximo sazonal, próprio e de terceiros.</li><li>Empilhadeiras, estruturas de armazenagem e circulação no pátio.</li><li>Produtos refrigerados e medidas de contingência.</li><li>Frota, transportadores, carga, descarga e valores por embarque.</li><li>Coberturas patrimoniais, responsabilidade civil e lucros cessantes.</li><li>Limites, sublimites, franquias e critérios de indenização.</li><li>Histórico de perdas, prevenção contra incêndio e segurança.</li></ul>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/seguro-empresarial-o-que-cobre\">como funciona o seguro empresarial</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-transporte-carga-embarcador-vs-transportadora\">seguro da mercadoria e responsabilidade do transportador</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Quer cotar o seguro do seu depósito ou distribuidora?</h2><p class=\"mb-5\">A Elevance ajuda a mapear estoque, equipamentos, movimentação, transporte e responsabilidades para comparar as opções disponíveis entre os parceiros autorizados.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo, revisado em 10/09/2026. Disponibilidade, aceitação, coberturas, limites, franquias, carências e exclusões dependem do produto, das atividades declaradas e da análise de risco.</p>\n<p class=\"text-sm text-slate-600\">Fontes: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/copy_of_planos-e-produtos/seguros/seguro-compreensivo\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro compreensivo</a> · <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/copy_of_planos-e-produtos/seguros/seguro-de-responsabilidade\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro de responsabilidade</a>.</p>"
  },

  {
    "id": 143,
    "slug": "seguro-carro-blindado-cobertura-blindagem-oficina-indenizacao",
    "title": "Seguro para Carro Blindado: Blindagem, Oficina e Indenização",
    "date": "11 Set, 2026",
    "category": "Seguro Auto",
    "readTime": "5 min",
    "image": "https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&q=80&w=800",
    "excerpt": "Entenda como declarar a blindagem e comparar limite, franquias, vidros, rede de oficinas e indenização integral.",
    "content": "<p class=\"mb-4\">Comprar um carro blindado ou mandar blindar o veículo muda mais do que peso e dirigibilidade. Para o seguro, é preciso saber se a blindagem foi informada, como será considerada no valor protegido e onde o automóvel poderá ser reparado depois de um sinistro.</p>\n<p class=\"mb-4\">A pergunta certa não é apenas “seguradora aceita carro blindado?”. É: esta proposta cobre o veículo, a blindagem e os custos de reparo compatíveis com a configuração que eu realmente possuo?</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Blindagem precisa ser informada na cotação</h2>\n<p class=\"mb-4\">Declare a blindagem mesmo quando ela já constar nos documentos ou tiver sido instalada por proprietário anterior. A análise pode considerar ano, modelo, nível e fabricante da blindagem, data de execução, documentação, estado de conservação e valor.</p>\n<p class=\"mb-4\">Se o carro foi segurado antes da transformação, comunique a alteração à corretora e à seguradora antes de presumir que a apólice passou a protegê-la. Mudança relevante no bem segurado pode exigir nova análise, vistoria, endosso e ajuste de prêmio.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Casco e blindagem são a mesma cobertura?</h2>\n<p class=\"mb-4\">A Susep informa que blindagem pode ser oferecida como cobertura adicional no seguro auto. Portanto, não basta encontrar colisão, incêndio, roubo e furto no resumo. Verifique se a blindagem aparece expressamente, com limite e condições.</p>\n<p class=\"mb-4\">Pergunte se vidros blindados, mantas, peças estruturais e mão de obra especializada recebem tratamento próprio. Também confira se existe participação do segurado diferente da franquia do casco.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Valor de mercado referenciado pode não refletir todo o investimento</h2>\n<p class=\"mb-4\">Na modalidade de valor de mercado referenciado, a indenização integral usa a tabela indicada no contrato e o fator de ajuste. A cotação média de um modelo convencional pode não representar automaticamente quanto foi gasto na blindagem.</p>\n<p class=\"mb-4\">Compare como cada proposta incorpora essa diferença: cobertura adicional, limite específico, fator de ajuste ou valor determinado, quando disponível. Não some por conta própria o preço do carro e o custo histórico da transformação; o critério válido é o contratado.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Valor determinado: quando merece avaliação</h2>\n<p class=\"mb-4\">A Susep descreve o valor determinado como uma quantia fixa estipulada entre as partes na contratação. Essa modalidade pode facilitar a leitura do limite de indenização integral, mas disponibilidade, aceitação e preço dependem do produto e do risco.</p>\n<p class=\"mb-4\">Para comparar, coloque lado a lado prêmio, limite do casco, limite da blindagem, franquias e critérios de indenização integral. Um número maior não significa proteção mais ampla se partes importantes estiverem fora da cobertura.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Pequena colisão pode exigir reparo especializado</h2>\n<p class=\"mb-4\">Um impacto na porta, coluna, teto ou vidro pode atingir componentes da blindagem. O reparo precisa preservar segurança, acabamento e documentação técnica. Pergunte antecipadamente quais oficinas da rede atendem veículos blindados na sua região.</p>\n<p class=\"mb-4\">A Susep esclarece que a seguradora pode oferecer livre escolha de oficina ou limitar o reparo à rede referenciada, conforme o contrato. Confira também tipo de peças, transporte do veículo e autorização prévia para desmontagem.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Vidros blindados pedem uma leitura separada</h2>\n<p class=\"mb-4\">Cobertura de vidros convencional não deve ser presumida como suficiente para vidro blindado. Limites, franquias, disponibilidade de peça, delaminação e causas aceitas podem variar.</p>\n<p class=\"mb-4\">Pergunte se a proteção abrange para-brisa, laterais e vidro traseiro, e se existe limite por peça ou evento. Desgaste, defeito progressivo e perda de transparência podem receber tratamento diferente de quebra causada por evento coberto.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Franquia e indenização parcial</h2>\n<p class=\"mb-4\">Compare a franquia do casco e eventuais participações específicas. Um reparo pode envolver funilaria, vidro e componentes da blindagem; entenda se haverá uma única franquia ou regras distintas para cada cobertura, conforme a proposta.</p>\n<p class=\"mb-4\">Não autorize conserto antes do aviso e da liberação quando o contrato exigir autorização prévia. Guarde fotos, notas, certificados e comprovantes de manutenção para organizar a análise.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Peso, suspensão e uso também entram na conversa</h2>\n<p class=\"mb-4\">Alterações de rodas, suspensão, freios, pneus ou acessórios feitas para suportar a blindagem precisam ser declaradas quando solicitadas. Informe também uso particular, executivo, aplicativo, transporte de valores ou atividade profissional.</p>\n<p class=\"mb-4\">O preço do seguro considera o risco apresentado à seguradora. O mesmo modelo pode receber análises diferentes conforme transformação, condutores, região, garagem, uso e histórico.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para comparar propostas</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>Marca, modelo, ano e valor do veículo.</li><li>Fabricante, nível, ano e documentação da blindagem.</li><li>Valor atribuído ao casco e limite específico da blindagem.</li><li>Modalidade de valor de mercado referenciado ou valor determinado.</li><li>Franquias do casco, blindagem e vidros.</li><li>Rede de oficinas apta a reparar veículos blindados.</li><li>Tratamento de vidros, delaminação e peças especiais.</li><li>Critério de indenização integral e destino dos salvados.</li><li>Uso do veículo, condutores e alterações posteriores.</li><li>Assistência e guincho compatíveis com peso e características do carro.</li></ul>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/seguro-auto-carro-acima-100-mil-coberturas\">coberturas para carros de maior valor</a> · <a class=\"text-blue-700 underline\" href=\"/blog/franquia-reduzida-vs-normal-seguro-auto\">como comparar franquia reduzida e normal</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Quer comparar seguro para seu carro blindado?</h2><p class=\"mb-5\">Envie os dados do veículo e da blindagem. A Elevance consulta as opções disponíveis entre os parceiros autorizados e ajuda a comparar limites, franquias e oficinas.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo, revisado em 11/09/2026. Disponibilidade, aceitação, coberturas, limites, oficinas, franquias e critérios de indenização dependem do produto e das condições contratuais.</p>\n<p class=\"text-sm text-slate-600\">Fonte: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-de-automoveis\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro de automóveis</a>.</p>"
  },

  {
    "id": 144,
    "slug": "seguro-auto-condutor-jovem-incluir-filho-perfil",
    "title": "Seguro Auto com Condutor Jovem: Quando Incluir o Filho no Perfil?",
    "date": "12 Set, 2026",
    "category": "Seguro Auto",
    "readTime": "5 min",
    "image": "https://images.unsplash.com/photo-1504215680853-026ed2a45def?auto=format&fit=crop&q=80&w=800",
    "excerpt": "Entenda como declarar condutores jovens, uso compartilhado, residência, frequência e mudanças durante a vigência.",
    "content": "<p class=\"mb-4\">Quando um filho começa a dirigir o carro da família, a dúvida aparece rápido: ele precisa entrar no seguro mesmo usando o veículo só alguns dias? A resposta depende do questionário de avaliação de risco e dos critérios do produto, não apenas de quem consta como proprietário.</p>\n<p class=\"mb-4\">O caminho seguro é descrever a rotina real. Omitir um condutor frequente para tentar reduzir o preço pode gerar divergência justamente quando a seguradora analisar um sinistro.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Proprietário, segurado e principal condutor podem ser pessoas diferentes</h2>\n<p class=\"mb-4\">O proprietário aparece no documento do veículo. O segurado é quem possui o interesse protegido e contrata a apólice. Já o principal condutor costuma ser definido pelas regras da seguradora como quem dirige com maior frequência.</p>\n<p class=\"mb-4\">Não escolha o nome apenas pela idade ou pelo preço da cotação. Se mãe, pai e filho compartilham o automóvel, informe como ele é usado e deixe a seguradora enquadrar o perfil conforme o questionário.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quando o jovem deve ser informado?</h2>\n<p class=\"mb-4\">As perguntas variam entre seguradoras. Algumas pedem dados de todos os condutores habituais; outras perguntam se pessoas dentro de determinada faixa etária residem com o segurado ou dirigem o carro, ainda que não sejam o principal condutor.</p>\n<p class=\"mb-4\">Por isso, “usa só de vez em quando” não é uma classificação suficiente. Informe frequência, dias da semana, finalidade, local onde o carro pernoita e se o jovem tem outro veículo disponível.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Morar na mesma casa significa inclusão automática?</h2>\n<p class=\"mb-4\">Não necessariamente, mas a residência costuma fazer parte da avaliação. Um filho habilitado que mora com os pais e tem acesso às chaves pode precisar ser declarado mesmo que diga usar o carro raramente.</p>\n<p class=\"mb-4\">Se ele mora em outro endereço, estuda fora ou volta apenas em alguns períodos, descreva a situação. Não presuma que o CEP ou a ausência de uso diário elimina a pergunta sobre acesso ao veículo.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Uso eventual e uso habitual</h2>\n<p class=\"mb-4\">Emprestar o carro em uma situação isolada não é igual a compartilhar o veículo toda semana. Ainda assim, cada contrato estabelece como trata condutores eventuais e quais declarações foram consideradas para calcular o prêmio.</p>\n<p class=\"mb-4\">Peça que a corretora registre por escrito a rotina informada. Se houver dúvida entre eventual e habitual, solicite confirmação da seguradora antes de aceitar a proposta.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Por que a idade pode alterar o preço?</h2>\n<p class=\"mb-4\">A Susep explica que o prêmio do seguro auto é calculado a partir das características do risco. Idade e experiência ao volante podem integrar essa análise, junto com veículo, região, uso, garagem, coberturas, franquias e histórico.</p>\n<p class=\"mb-4\">Isso não significa que toda seguradora cobrará o mesmo acréscimo ou aceitará o perfil da mesma maneira. Compare propostas com as mesmas informações e coberturas; cotações preenchidas de formas diferentes não são realmente comparáveis.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">E se o filho tirar a CNH durante a vigência?</h2>\n<p class=\"mb-4\">A nova habilitação e a mudança na rotina de uso devem ser comunicadas antes de ele passar a dirigir regularmente. A seguradora pode solicitar endosso, recalcular o prêmio ou pedir informações adicionais.</p>\n<p class=\"mb-4\">Faça o mesmo quando o jovem mudar de endereço, começar faculdade ou trabalho em outro trajeto, passar a usar o carro diariamente ou se tornar o principal condutor.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">O que pode acontecer se o perfil estiver incorreto?</h2>\n<p class=\"mb-4\">Em um sinistro, a seguradora pode conferir quem dirigia, qual era o uso e se as respostas da proposta correspondiam à realidade. A consequência depende do fato, do contrato e da relação entre a informação divergente e o risco.</p>\n<p class=\"mb-4\">Não existe uma conclusão automática para todo caso. O melhor é evitar a discussão: responda com precisão, guarde a proposta e comunique alterações relevantes durante a vigência.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Cobertura para terceiros merece atenção</h2>\n<p class=\"mb-4\">Um motorista com pouca experiência pode se envolver em colisão com veículos caros, motociclistas, ciclistas ou pedestres. Compare limites de danos materiais, corporais e morais, além de assistência, carro reserva e franquia do casco.</p>\n<p class=\"mb-4\">O limite de responsabilidade civil é separado do valor do próprio veículo. Escolher apenas pelo menor prêmio pode deixar uma diferença relevante por conta da família.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para cotar sem ambiguidade</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>Quem dirige com maior frequência.</li><li>Todos os condutores habituais e respectivas idades.</li><li>Jovens habilitados que moram na residência e têm acesso ao carro.</li><li>Frequência, finalidade e trajetos de cada condutor.</li><li>Endereço de pernoite e tipo de garagem.</li><li>Uso para estudo, trabalho, lazer, aplicativo ou atividade profissional.</li><li>Data da habilitação e histórico solicitado.</li><li>Coberturas, limites para terceiros, franquias e assistências.</li><li>Procedimento para comunicar mudanças durante a vigência.</li><li>Cópia das respostas usadas na proposta.</li></ul>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/como-escolher-o-melhor-seguro-auto-para-seu-perfil\">como funciona o perfil do condutor principal</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-auto-terceiros-100-mil-200-mil-limites\">como comparar limites para terceiros</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Quer incluir um condutor jovem sem deixar dúvidas?</h2><p class=\"mb-5\">Conte como o carro é usado por cada pessoa. A Elevance organiza o perfil e compara as opções disponíveis entre os parceiros autorizados.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo, revisado em 12/09/2026. Aceitação, cálculo do prêmio, critérios de condutor, coberturas, limites, franquias e tratamento de divergências dependem do produto, do questionário e das condições contratuais.</p>\n<p class=\"text-sm text-slate-600\">Fonte: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-de-automoveis\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro de automóveis</a>.</p>"
  },

  {
    "id": 145,
    "slug": "seguro-empresarial-placas-solares-telhado-inversor",
    "title": "Seguro Empresarial com Placas Solares: Telhado, Inversor e Danos Elétricos",
    "date": "13 Set, 2026",
    "category": "Seguro Empresarial",
    "readTime": "5 min",
    "image": "https://images.unsplash.com/photo-1509391366360-2e959784a276?auto=format&fit=crop&q=80&w=800",
    "excerpt": "Entenda como declarar o sistema fotovoltaico e comparar proteção para painéis, inversores, telhado, vendaval e paralisação.",
    "content": "<p class=\"mb-4\">Instalar placas solares reduz a dependência da energia comprada, mas também acrescenta equipamentos de valor ao telhado e à instalação elétrica da empresa. Na hora do seguro, não basta dizer que o imóvel tem energia solar: é preciso mostrar o que foi instalado, quanto custa repor e quais eventos cada proposta realmente cobre.</p>\n<p class=\"mb-4\">O ponto central é separar sistema, prédio e operação. Um dano pode atingir apenas o inversor, arrancar painéis e telhas ou paralisar a empresa sem destruir todo o imóvel.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">As placas entram automaticamente no seguro empresarial?</h2>\n<p class=\"mb-4\">Não presuma isso. O seguro compreensivo empresarial combina cobertura básica e adicionais conforme o produto. Painéis, inversores, estruturas de fixação, cabos e demais componentes precisam ser declarados e enquadrados corretamente.</p>\n<p class=\"mb-4\">Informe se o sistema pertence à empresa, ao proprietário do imóvel, a uma locadora ou a outro financiador. Bens de terceiros podem exigir previsão específica e limite próprio.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Prédio, benfeitoria ou equipamento?</h2>\n<p class=\"mb-4\">A forma de enquadramento varia. Um sistema preso ao telhado pode ser tratado como instalação, benfeitoria ou equipamento, conforme a apólice. Essa definição influencia valor segurado, comprovação, franquia e forma de indenização.</p>\n<p class=\"mb-4\">Se o imóvel é alugado, organize as responsabilidades do proprietário e do ocupante. A apólice do dono do prédio não substitui automaticamente a proteção contratada pela empresa que utiliza ou financiou o sistema.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Incêndio e danos elétricos são coberturas diferentes</h2>\n<p class=\"mb-4\">Curto-circuito, oscilação ou arco elétrico podem danificar inversor, string box e componentes sem provocar incêndio. A cobertura básica de incêndio não deve ser interpretada como proteção automática para toda falha elétrica.</p>\n<p class=\"mb-4\">Compare danos elétricos, causas aceitas, franquia, exigências de aterramento, dispositivos de proteção e documentação de manutenção. Defeito interno, desgaste, instalação inadequada e perda gradual costumam receber tratamento diferente de um evento súbito coberto.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Vendaval, granizo e queda de objetos</h2>\n<p class=\"mb-4\">Painéis ficam expostos a vento, chuva, granizo, galhos e objetos projetados. Verifique se vendaval, granizo e impacto estão contratados, quais velocidades ou evidências podem ser exigidas e se há sublimite.</p>\n<p class=\"mb-4\">O evento pode afetar módulos, estrutura e cobertura do prédio ao mesmo tempo. Pergunte como a apólice trata a retirada temporária das placas para reparar o telhado e sua reinstalação depois da obra.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Alagamento e equipamentos instalados em área baixa</h2>\n<p class=\"mb-4\">Mesmo quando os módulos estão no alto, inversores, quadros, baterias e cabeamento podem ficar próximos ao solo. Se o endereço tem histórico de alagamento, declare a exposição e confirme se a cobertura existe.</p>\n<p class=\"mb-4\">Elevação dos equipamentos, drenagem, barreiras e organização do local ajudam na prevenção, mas não criam cobertura onde o contrato exclui o evento.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Furto e subtração dos painéis</h2>\n<p class=\"mb-4\">Cobertura para subtração costuma depender de vestígios, forma de acesso e condições específicas. O simples desaparecimento de componente não deve ser presumido como indenizável.</p>\n<p class=\"mb-4\">Descreva localização, altura, tipo de fixação, cercamento, câmeras, vigilância e controle de acesso. Sistemas instalados no solo ou em área rural podem receber análise diferente dos montados sobre prédio urbano.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Placa quebrada e perda de geração</h2>\n<p class=\"mb-4\">A indenização do dano físico não significa pagamento automático pela energia que deixou de ser produzida. A cobertura de lucros cessantes, quando disponível e contratada, normalmente depende de dano material coberto e de comprovação prevista na apólice.</p>\n<p class=\"mb-4\">Calcule quanto a interrupção aumenta a conta ou afeta a operação e quanto tempo peças e mão de obra levariam para chegar. O período indenitário precisa acompanhar a realidade da reposição.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Instalação nova ou feita depois da contratação</h2>\n<p class=\"mb-4\">Se as placas foram instaladas durante a vigência, comunique a alteração. O valor e as características do risco mudaram, e a seguradora pode solicitar nota fiscal, projeto, laudos, fotos, endosso ou nova inspeção.</p>\n<p class=\"mb-4\">Guardar apenas a conta de energia não comprova todo o sistema. Organize notas, série dos equipamentos, potência, projeto, garantias, instalação, manutenção e registros fotográficos.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Responsabilidade civil durante instalação e manutenção</h2>\n<p class=\"mb-4\">Queda de ferramenta, painel ou estrutura pode causar dano a pessoas, veículos ou imóveis vizinhos. Separe a responsabilidade da empresa segurada daquela assumida pela instaladora e pelos prestadores.</p>\n<p class=\"mb-4\">Peça certificados de seguro e contratos dos fornecedores, mas não presuma que a apólice deles protege o patrimônio da sua empresa. Responsabilidade civil e dano ao próprio bem são interesses diferentes.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para comparar propostas</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>Proprietário do sistema e do imóvel.</li><li>Valor de reposição de módulos, inversores, baterias, estruturas e instalação.</li><li>Potência, local, idade, fabricante e data de instalação.</li><li>Notas, projeto, laudos, garantias e manutenção.</li><li>Enquadramento como prédio, benfeitoria, instalação ou equipamento.</li><li>Incêndio, danos elétricos, vendaval, granizo, impacto e alagamento.</li><li>Subtração, quebra, franquias e sublimites.</li><li>Custos de retirada e reinstalação para reparar o telhado.</li><li>Paralisação, aumento de despesa e período indenitário.</li><li>Responsabilidades da instaladora, proprietário e ocupante.</li></ul>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/seguro-empresarial-o-que-cobre\">o que o seguro empresarial pode cobrir</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-empresarial-para-farmacia-coberturas\">como mapear equipamentos e estoque em uma empresa</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Quer proteger a empresa e o sistema solar na mesma análise?</h2><p class=\"mb-5\">Envie os dados do imóvel e da instalação. A Elevance organiza os valores e compara as opções disponíveis entre os parceiros autorizados.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo, revisado em 13/09/2026. Disponibilidade, aceitação, enquadramento dos bens, coberturas, limites, franquias, documentos e exclusões dependem do produto e da análise de risco.</p>\n<p class=\"text-sm text-slate-600\">Fonte: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/copy_of_planos-e-produtos/seguros/seguro-compreensivo\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro compreensivo</a>.</p>"
  },

  {
    "id": 146,
    "slug": "seguro-contador-escritorio-contabil-rc-profissional-cyber",
    "title": "Seguro para Contador e Escritório Contábil: RC Profissional, Documentos e Cyber",
    "date": "14 Set, 2026",
    "category": "Seguro Empresarial",
    "readTime": "5 min",
    "image": "https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?auto=format&fit=crop&q=80&w=800",
    "excerpt": "Entenda como combinar responsabilidade civil profissional, patrimônio, documentos, dados e paralisação no escritório contábil.",
    "content": "<p class=\"mb-4\">Um escritório contábil pode ter pouco estoque físico e, ainda assim, concentrar riscos altos. Um prazo perdido, uma informação processada incorretamente, o vazamento de dados ou a paralisação dos sistemas pode gerar prejuízo muito maior do que o valor dos computadores.</p>\n<p class=\"mb-4\">Por isso, cotar apenas incêndio e danos elétricos deixa a principal pergunta sem resposta: o que acontece quando o dano decorre da atividade profissional, e não do prédio?</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Seguro empresarial e RC profissional não são a mesma coisa</h2>\n<p class=\"mb-4\">O seguro empresarial protege interesses patrimoniais conforme as coberturas contratadas, como prédio, móveis, equipamentos, incêndio, danos elétricos e subtração. Já a responsabilidade civil profissional trata reclamações de terceiros relacionadas a falhas na prestação do serviço, dentro das condições da apólice.</p>\n<p class=\"mb-4\">Uma proteção não substitui automaticamente a outra. O computador queimado é um dano ao patrimônio; uma reclamação de cliente por erro em obrigação acessória envolve outra natureza de risco.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Que tipo de reclamação merece atenção?</h2>\n<p class=\"mb-4\">A rotina pode envolver declarações, folha, tributos, registros, orientações e cumprimento de prazos. Uma alegação de erro, omissão ou negligência pode gerar cobrança de indenização e despesas de defesa.</p>\n<p class=\"mb-4\">Isso não significa que toda multa, diferença tributária ou insatisfação será coberta. Compare definições de ato profissional, prejuízo financeiro, custos de defesa, franquia, exclusões e atividades declaradas.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Multa do cliente é automaticamente indenizada?</h2>\n<p class=\"mb-4\">Não. Multas, penalidades, tributos e obrigações contratuais podem ter restrições ou exclusões. O que pode estar em análise é a responsabilidade do escritório pelo prejuízo alegado, e não simplesmente o pagamento de qualquer valor lançado contra o cliente.</p>\n<p class=\"mb-4\">Peça exemplos de enquadramento, leia as exclusões e verifique se prejuízos financeiros sem dano material ou corporal estão contemplados. A palavra “RC” no resumo não resolve essa diferença.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Retroatividade e data da reclamação</h2>\n<p class=\"mb-4\">Muitas apólices profissionais funcionam com critérios ligados à data da reclamação e a uma data retroativa. Um trabalho feito antes da contratação pode ou não entrar na proteção, conforme o contrato e a continuidade da cobertura.</p>\n<p class=\"mb-4\">Compare prazo complementar, prazo suplementar, notificação de circunstâncias e efeito de trocar de seguradora. Uma proposta mais barata pode criar um intervalo relevante se a retroatividade anterior não for preservada.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Sócios, funcionários e terceirizados</h2>\n<p class=\"mb-4\">Confirme quem é considerado segurado: pessoa jurídica, sócios, responsáveis técnicos, empregados, estagiários e prestadores. O escritório pode responder por um ato praticado por alguém da equipe, mas a apólice precisa definir as pessoas e atividades abrangidas.</p>\n<p class=\"mb-4\">Informe número de profissionais, registros, áreas atendidas, terceirização, faturamento e perfil dos clientes. Atender microempresas locais não apresenta a mesma exposição de administrar grupos com operações complexas.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Documentos físicos e digitais</h2>\n<p class=\"mb-4\">Contratos, procurações, livros, certificados e arquivos podem exigir restauração, reconstituição ou comunicação aos clientes. A cobertura patrimonial comum não deve ser presumida como pagamento ilimitado para recuperar informação.</p>\n<p class=\"mb-4\">Mapeie documentos sob guarda, local de armazenamento, digitalização, backup, controle de acesso e política de retenção. Custos de reconstrução de documentos precisam aparecer de forma clara na comparação.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Risco cyber vai além do antivírus</h2>\n<p class=\"mb-4\">Escritórios contábeis tratam dados pessoais, bancários, fiscais e trabalhistas. Phishing, credenciais roubadas, ransomware ou envio de arquivo ao destinatário errado podem provocar paralisação, investigação, comunicação e reclamações.</p>\n<p class=\"mb-4\">Compare resposta a incidente, perícia, restauração, interrupção, responsabilidade por dados e extorsão cibernética, quando disponíveis. Verifique requisitos de backup, autenticação, atualização e treinamento; descumpri-los pode afetar a análise.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Patrimônio e paralisação continuam importantes</h2>\n<p class=\"mb-4\">Incêndio, dano elétrico, subtração ou alagamento pode interromper o acesso a computadores e documentos. O seguro empresarial pode combinar proteção para equipamentos e despesas ou lucros cessantes decorrentes de dano físico coberto.</p>\n<p class=\"mb-4\">Estime tempo de reposição, aluguel de espaço temporário, equipamentos, internet e recuperação de arquivos. Cobertura de paralisação precisa ter gatilho e período compatíveis com a realidade do escritório.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Honorários e custos de defesa</h2>\n<p class=\"mb-4\">Mesmo quando a reclamação é improcedente, responder pode exigir advogado, perito e documentação. Confirme se custos de defesa estão dentro ou fora do limite, se precisam de autorização prévia e como afetam o saldo disponível para indenização.</p>\n<p class=\"mb-4\">Também verifique territorialidade e jurisdição quando houver clientes ou operações fora do Brasil.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para uma cotação comparável</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>CNPJ, registros e atividades efetivamente prestadas.</li><li>Faturamento, tempo de atuação e perfil dos clientes.</li><li>Número de sócios, empregados e terceirizados.</li><li>Histórico de reclamações e circunstâncias conhecidas.</li><li>Limite, franquia, retroatividade e prazos adicionais.</li><li>Prejuízo financeiro, custos de defesa e danos morais.</li><li>Documentos e dados sob guarda.</li><li>Controles de acesso, backups e resposta a incidentes.</li><li>Equipamentos, endereço e coberturas patrimoniais.</li><li>Paralisação, territorialidade e atividades excluídas.</li></ul>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/seguro-imobiliaria-corretor-imoveis-rc-profissional\">como funciona o RC profissional em serviços</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-clinica-odontologica-empresarial-rc-profissional\">diferença entre proteção patrimonial e profissional</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Quer comparar a proteção do escritório contábil?</h2><p class=\"mb-5\">Envie as atividades, faturamento e estrutura da operação. A Elevance organiza os riscos e compara as opções disponíveis entre os parceiros autorizados.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo, revisado em 14/09/2026. Aceitação, atividades cobertas, retroatividade, limites, franquias, defesa, riscos digitais e exclusões dependem do produto e das condições contratuais.</p>\n<p class=\"text-sm text-slate-600\">Fonte: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-responsabilidade-civil\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro de responsabilidade civil</a>.</p>"
  },

  {
    "id": 147,
    "slug": "seguro-lavanderia-maquinas-roupas-clientes-responsabilidade-civil",
    "title": "Seguro para Lavanderia: Máquinas, Roupas de Clientes e Responsabilidade Civil",
    "date": "15 Set, 2026",
    "category": "Seguro Empresarial",
    "readTime": "6 min",
    "image": "https://images.unsplash.com/photo-1545173168-9f1947eebb7f?auto=format&fit=crop&q=80&w=800",
    "excerpt": "Entenda como proteger máquinas, bens de clientes, danos elétricos, vazamentos, paralisação e responsabilidade civil.",
    "content": "<p class=\"mb-4\">Lavanderias trabalham com máquinas de alto valor, água, vapor, calor, produtos químicos e bens pertencentes aos clientes. Uma proposta limitada a incêndio pode proteger parte do patrimônio e ainda deixar sem resposta os dois riscos mais característicos da operação: a paralisação das máquinas e o dano às roupas sob guarda.</p>\n<p class=\"mb-4\">Lavanderia tradicional, autosserviço, industrial e atendimento a hotéis ou hospitais não têm a mesma exposição. A atividade real, os processos executados e o tipo de cliente precisam aparecer corretamente na cotação.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Seguro empresarial e responsabilidade civil cumprem funções diferentes</h2>\n<p class=\"mb-4\">O seguro empresarial pode combinar a cobertura básica com proteções adicionais para máquinas, equipamentos, danos elétricos, subtração e paralisação. A responsabilidade civil trata reclamações de terceiros por danos involuntários ligados à operação, dentro das condições contratadas.</p>\n<p class=\"mb-4\">A lavadora queimada é um dano ao patrimônio da empresa. Uma roupa de cliente danificada, perdida ou entregue à pessoa errada envolve bem de terceiro e precisa de enquadramento próprio.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Roupas de clientes ficam automaticamente cobertas?</h2>\n<p class=\"mb-4\">Não se deve presumir. Bens de terceiros sob guarda, custódia ou controle podem ter exclusão na responsabilidade civil geral ou exigir cobertura específica. Confirme se roupas, enxovais, tapetes e outros itens recebidos aparecem expressamente nas condições.</p>\n<p class=\"mb-4\">Compare também limite por evento, limite por peça ou lote, franquia, comprovação do valor e tratamento para manchas, encolhimento, descoloração, troca, desaparecimento e falha de processo.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Máquinas, caldeiras e danos elétricos</h2>\n<p class=\"mb-4\">Lavadoras, secadoras, centrífugas, calandras, prensas, bombas, dosadores e computadores podem representar boa parte do investimento. Danos elétricos cobertos não são sinônimo de manutenção, desgaste, corrosão ou quebra mecânica.</p>\n<p class=\"mb-4\">Faça uma relação com marca, modelo, ano e valor de reposição. Verifique se equipamentos financiados ou locados podem ser incluídos e se caldeiras, vasos de pressão ou máquinas especiais exigem análise separada.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Vazamento, alagamento e danos pela água</h2>\n<p class=\"mb-4\">A presença constante de água aumenta a importância de tubulações, ralos, bombas, caixas, mangueiras e manutenção preventiva. Nem todo vazamento ou infiltração está coberto; origem, súbito do evento e exclusões fazem diferença.</p>\n<p class=\"mb-4\">Mapeie também a possibilidade de atingir vizinhos, áreas comuns ou imóveis alugados. Danos ao próprio estabelecimento e responsabilidade por dano causado a terceiros não são a mesma cobertura.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Incêndio, calor e produtos utilizados</h2>\n<p class=\"mb-4\">Secadoras, calandras, instalações elétricas e materiais têxteis podem concentrar carga de incêndio. Produtos de limpeza, solventes e processos especiais devem ser informados, inclusive quando armazenados em pequena quantidade.</p>\n<p class=\"mb-4\">A seguradora pode pedir extintores, manutenção, ventilação, instalações adequadas e outras medidas. Declare o processo completo; omitir lavagem a seco ou uso industrial para conseguir preço menor pode prejudicar a aceitação do sinistro.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Subtração e desaparecimento não são iguais</h2>\n<p class=\"mb-4\">Subtração de máquinas, dinheiro ou bens pode depender de sinais, circunstâncias e definições previstas na apólice. Simples desaparecimento, erro de entrega ou diferença de controle pode ficar fora da cobertura patrimonial.</p>\n<p class=\"mb-4\">Para roupas recebidas, identificação, comprovante de entrada, fotografia quando necessária e procedimento de entrega ajudam tanto na prevenção quanto na documentação de reclamações.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Paralisação: quanto custa ficar sem a máquina principal?</h2>\n<p class=\"mb-4\">Um dano material coberto pode interromper a produção enquanto há perícia, reparo ou reposição. Coberturas de lucros cessantes ou despesas fixas podem responder conforme o gatilho, período indenitário e valores declarados.</p>\n<p class=\"mb-4\">Calcule aluguel, folha, energia mínima, contratos e prazo para importar ou substituir equipamentos. Também considere o custo de terceirizar temporariamente o serviço, se essa despesa estiver prevista.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Lavanderia de autosserviço muda a análise</h2>\n<p class=\"mb-4\">No autosserviço, clientes operam equipamentos e permanecem no local sem acompanhamento contínuo. Piso molhado, queimaduras, portas, instruções de uso, câmeras e atendimento remoto podem influenciar a responsabilidade operacional.</p>\n<p class=\"mb-4\">Informe horário de funcionamento, presença de funcionários, quantidade de máquinas, meios de pagamento e procedimentos de emergência.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para comparar propostas</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>CNPJ, endereço e tipo de lavanderia.</li><li>Processos realizados, inclusive lavagem a seco ou industrial.</li><li>Relação e valor de reposição das máquinas.</li><li>Equipamentos locados, financiados ou de terceiros.</li><li>Instalações elétricas, hidráulicas, gás e vapor.</li><li>Produtos utilizados e medidas de prevenção.</li><li>Valor médio e máximo dos bens de clientes sob guarda.</li><li>Responsabilidade civil e exclusões para bens custodiados.</li><li>Danos elétricos, quebra de máquinas e respectivas franquias.</li><li>Faturamento, despesas fixas e prazo de retomada.</li></ul>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/seguro-salao-de-beleza-equipamentos-responsabilidade-civil\">como comparar equipamentos e responsabilidade civil em serviços</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-oficina-mecanica-auto-center-veiculos-clientes\">por que bens de clientes exigem atenção própria</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Quer cotar o seguro da sua lavanderia?</h2><p class=\"mb-5\">Envie o CNPJ, endereço, atividades, equipamentos e valor médio dos bens de clientes. A Elevance organiza os riscos e compara as opções disponíveis entre os parceiros autorizados.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo, revisado em 15/09/2026. Aceitação, atividades, bens protegidos, limites, franquias, gatilhos e exclusões dependem do produto e das condições contratuais.</p>\n<p class=\"text-sm text-slate-600\">Fontes: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/copy_of_planos-e-produtos/seguros/seguro-compreensivo\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro compreensivo</a> · <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-responsabilidade-civil\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — responsabilidade civil</a>.</p>"
  },

  {
    "id": 148,
    "slug": "seguro-coworking-escritorio-compartilhado-responsabilidade-civil",
    "title": "Seguro para Coworking: Bens de Usuários, Eventos e Responsabilidade Civil",
    "date": "16 Set, 2026",
    "category": "Seguro Empresarial",
    "readTime": "6 min",
    "image": "https://images.unsplash.com/photo-1497366754035-f200968a6e72?auto=format&fit=crop&q=80&w=800",
    "excerpt": "Veja como comparar patrimônio, bens de usuários, eventos, controle de acesso, paralisação, cyber e responsabilidade civil.",
    "content": "<p class=\"mb-4\">Coworkings combinam circulação de clientes, salas compartilhadas, eventos, equipamentos, dados e bens de pessoas diferentes. Por isso, uma apólice empresarial genérica pode proteger o patrimônio do operador e ainda deixar dúvidas sobre notebooks e atividades dos usuários.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quem deve aparecer como segurado?</h2>\n<p class=\"mb-4\">O imóvel pode pertencer a um investidor, ser alugado pelo operador e ocupado por dezenas de empresas. A proposta deve identificar quem explora o espaço, quem responde pelo contrato de locação, quais bens pertencem ao coworking e quais obrigações foram assumidas.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Bens dos usuários ficam cobertos?</h2>\n<p class=\"mb-4\">Não se deve presumir. Computadores, celulares, documentos e mercadorias deixados por clientes são bens de terceiros. Verifique se podem ser incluídos, limites por pessoa e evento, controle de acesso e exclusões para desaparecimento sem vestígios.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Responsabilidade civil do espaço</h2>\n<p class=\"mb-4\">Quedas, acidentes em áreas comuns e danos ligados à operação podem gerar reclamações. A responsabilidade civil operacional pode responder conforme as condições contratadas, mas não substitui o RC profissional das empresas residentes.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Eventos e salas por hora</h2>\n<p class=\"mb-4\">Palestras, cursos, confraternizações e gravações aumentam circulação e presença de fornecedores. Informe capacidade, alimentação, equipamentos, horários e eventos realizados fora do endereço.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Patrimônio e danos elétricos</h2>\n<p class=\"mb-4\">Móveis, divisórias, ar-condicionado, rede, câmeras e controle de acesso devem ser avaliados pelo valor de reposição. Benfeitorias em imóvel alugado precisam ser declaradas. Danos elétricos não equivalem a manutenção, desgaste ou defeito interno.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Subtração e acesso 24 horas</h2>\n<p class=\"mb-4\">Cartões, biometria e chaves digitais ajudam no controle, mas cobertura de subtração depende da definição do evento. Informe recepção, câmeras, alarmes, visitantes e política para credenciais perdidas.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Dados, internet e risco cyber</h2>\n<p class=\"mb-4\">Cadastros, pagamentos, Wi-Fi e sistemas de acesso podem expor o negócio a vazamento, ransomware e interrupção. Compare resposta a incidente, restauração, responsabilidade por dados e paralisação quando houver solução cyber disponível.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Paralisação e perda de receita</h2>\n<p class=\"mb-4\">Após dano material coberto, o coworking pode precisar devolver mensalidades, alugar espaço temporário ou manter despesas. Lucros cessantes dependem do gatilho, período e valores contratados; queda de demanda, sozinha, não costuma acionar essa proteção.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para cotação</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>CNPJ, endereço e modelo de operação.</li><li>Imóvel próprio ou alugado e benfeitorias.</li><li>Posições, salas, usuários e horários.</li><li>Recepção e controle de acesso.</li><li>Móveis, rede e equipamentos.</li><li>Bens de usuários sob guarda.</li><li>Eventos e fornecedores externos.</li><li>Responsabilidade civil e atividades.</li><li>Dados, sistemas e backups.</li><li>Faturamento, despesas e prazo de retomada.</li></ul>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/seguro-ecommerce-loja-virtual-estoque-cyber\">patrimônio e risco cyber</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-residencial-home-office-negocio-em-casa\">atividade profissional no local segurado</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Quer comparar o seguro do seu coworking?</h2><p class=\"mb-5\">Envie o CNPJ, endereço, estrutura e serviços. A Elevance organiza os riscos e compara as opções disponíveis entre os parceiros autorizados.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo, revisado em 16/09/2026. Aceitação, atividades, bens, limites, franquias e exclusões dependem das condições contratuais.</p>\n<p class=\"text-sm text-slate-600\">Fontes: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/copy_of_planos-e-produtos/seguros/seguro-compreensivo\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro compreensivo</a> · <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-responsabilidade-civil\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — responsabilidade civil</a>.</p>"
  },

  {
    "id": 149,
    "slug": "seguro-hotel-pousada-hospedes-equipamentos-responsabilidade-civil",
    "title": "Seguro para Hotel e Pousada: Hóspedes, Equipamentos e Responsabilidade Civil",
    "date": "17 Set, 2026",
    "category": "Seguro Empresarial",
    "readTime": "6 min",
    "image": "https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&q=80&w=800",
    "excerpt": "Veja como comparar patrimônio, bens de hóspedes, alimentos, eventos, paralisação e responsabilidade civil na hotelaria.",
    "content": "<p class=\"mb-4\">Hotéis e pousadas reúnem hospedagem, circulação de terceiros, equipamentos, alimentos, lazer e atendimento contínuo. Uma proposta adequada precisa refletir a operação real: número de quartos, serviços oferecidos, áreas comuns e responsabilidades assumidas.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Seguro empresarial e responsabilidade civil são a mesma coisa?</h2>\n<p class=\"mb-4\">Não. O seguro empresarial pode proteger prédio, conteúdo e perdas decorrentes de eventos contratados. A responsabilidade civil trata reclamações de terceiros por danos ligados à operação, conforme limites, franquias e exclusões da apólice.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Prédio, benfeitorias e conteúdo</h2>\n<p class=\"mb-4\">Informe se o imóvel é próprio ou alugado e se há chalés, piscinas, quiosques, elevadores ou construções separadas. Móveis, enxoval, equipamentos de cozinha, ar-condicionado, gerador, sistemas de acesso e benfeitorias devem ser avaliados pelo valor de reposição.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Bens de hóspedes ficam automaticamente cobertos?</h2>\n<p class=\"mb-4\">Não presuma. Bagagens, eletrônicos e veículos são bens de terceiros. Compare a definição de guarda, limites por hóspede e evento, exigências de cofre ou controle de acesso e exclusões para simples desaparecimento.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Acidentes e responsabilidade civil</h2>\n<p class=\"mb-4\">Quedas, falhas de sinalização, danos em áreas comuns e ocorrências durante serviços podem gerar reclamações. Piscina, academia, playground, estacionamento, traslado e atividades recreativas devem ser declarados para que a cotação considere a exposição correta.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Restaurante, café da manhã e eventos</h2>\n<p class=\"mb-4\">Cozinha própria, terceirizada, bar, room service e salões para festas alteram o risco. Informe produção de alimentos, capacidade, gás, coifas, fornecedores e eventos abertos a não hóspedes.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Danos elétricos e quebra de equipamentos</h2>\n<p class=\"mb-4\">Danos elétricos podem atingir câmaras frias, bombas, elevadores e sistemas de climatização. Quebra interna, desgaste e manutenção não devem ser confundidos com evento coberto; compare as definições e franquias de cada cobertura.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Paralisação e temporada</h2>\n<p class=\"mb-4\">Um dano material coberto pode interromper reservas justamente na alta temporada. Para dimensionar lucros cessantes, considere faturamento, despesas fixas, sazonalidade, prazo de reparo e dependência de acessos ou serviços essenciais.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Subtração, dinheiro e controle de acesso</h2>\n<p class=\"mb-4\">Descreva recepção 24 horas, câmeras, cofres, chaves, cartões e áreas restritas. Cobertura para subtração costuma exigir evento caracterizado e não equivale a garantia para qualquer falta de item ou diferença de caixa.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Dados e reservas</h2>\n<p class=\"mb-4\">O negócio trata documentos, dados de pagamento e informações de hóspedes. Quando houver solução cyber disponível, compare resposta a incidente, restauração, responsabilidade por dados e interrupção de sistemas.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para uma cotação comparável</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>CNPJ, endereço e categoria do estabelecimento.</li><li>Imóvel próprio ou alugado e valor das benfeitorias.</li><li>Quartos, ocupação, faturamento e sazonalidade.</li><li>Móveis, enxoval, máquinas e equipamentos.</li><li>Restaurante, eventos, piscina e lazer.</li><li>Estacionamento, traslado e bens sob guarda.</li><li>Controles de acesso, incêndio e manutenção.</li><li>Limites de responsabilidade civil.</li><li>Prazo de retomada e despesas fixas.</li></ul>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/seguro-empresarial-para-restaurante-coberturas\">seguro para restaurante</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-estacionamento-valet-veiculos-clientes\">veículos de clientes e responsabilidade civil</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Quer comparar o seguro do seu hotel ou pousada?</h2><p class=\"mb-5\">Envie o CNPJ, endereço, estrutura e serviços. A Elevance organiza os riscos e compara as opções disponíveis entre os parceiros autorizados.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo, revisado em 17/09/2026. Aceitação, atividades, bens, limites, franquias e exclusões dependem das condições contratuais.</p>\n<p class=\"text-sm text-slate-600\">Fontes: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/copy_of_planos-e-produtos/seguros/seguro-compreensivo\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro compreensivo</a> · <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-responsabilidade-civil\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — responsabilidade civil</a>.</p>"
  },

  {
    "id": 150,
    "slug": "seguro-grafica-maquinas-papel-acabamento-responsabilidade-civil",
    "title": "Seguro para Gráfica: Máquinas, Papel, Acabamento e Responsabilidade Civil",
    "date": "18 Set, 2026",
    "category": "Seguro Empresarial",
    "readTime": "6 min",
    "image": "https://images.unsplash.com/photo-1562564055-71e051d33c19?auto=format&fit=crop&q=80&w=800",
    "excerpt": "Veja como comparar proteção para impressoras, acabamento, estoque de papel, arquivos de clientes, paralisação e responsabilidade civil.",
    "content": "<p class=\"mb-4\">Uma gráfica pode concentrar impressoras de alto valor, máquinas de acabamento, papel sensível à água, tintas, arquivos de clientes e prazos contratuais apertados. A cotação precisa refletir o processo produtivo, não apenas o endereço e o valor total dos bens.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">O que o seguro empresarial pode proteger?</h2>\n<p class=\"mb-4\">Conforme as coberturas contratadas, a apólice pode amparar prédio, conteúdo e prejuízos decorrentes de eventos previstos. Incêndio, danos elétricos, subtração, vendaval, equipamentos e lucros cessantes têm definições, franquias e limites próprios.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Impressoras e máquinas de acabamento</h2>\n<p class=\"mb-4\">Offset, digital, plotter, guilhotina, dobradeira, laminadora e equipamentos de corte devem ser declarados com valor de reposição e identificação. Danos elétricos não equivalem a desgaste, falta de manutenção, erro de regulagem ou quebra interna.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Danos elétricos ou quebra de máquinas?</h2>\n<p class=\"mb-4\">São proteções diferentes. Variações anormais de tensão e curto-circuito podem se enquadrar em danos elétricos conforme o contrato. Falha mecânica interna exige análise de cobertura específica, quando disponível, e das exclusões.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Papel, tinta e estoque de clientes</h2>\n<p class=\"mb-4\">Papel, substratos, tintas e materiais já impressos podem ter valores e sensibilidades diferentes. Informe altura de armazenagem, proximidade do piso, controle de umidade, inflamáveis e itens pertencentes a clientes.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Arquivos, matrizes e dados</h2>\n<p class=\"mb-4\">Layouts, bancos de imagens, dados variáveis e arquivos enviados por clientes podem ser essenciais para refazer pedidos. Backup, controle de acesso e solução cyber devem ser avaliados separadamente da proteção patrimonial.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Responsabilidade civil da operação</h2>\n<p class=\"mb-4\">Danos a visitantes, entregadores, imóveis vizinhos ou bens recebidos podem gerar reclamações. O RC operacional não deve ser confundido com garantia de prazo, qualidade gráfica, erro de impressão ou obrigação contratual.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Instalação fora da gráfica</h2>\n<p class=\"mb-4\">Aplicação de adesivos, fachadas e comunicação visual em locais de clientes cria exposição diferente. Trabalho em altura, veículos, terceirizados e danos durante a instalação precisam ser informados para avaliar aceitação e cobertura adequada.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Paralisação e prazos de entrega</h2>\n<p class=\"mb-4\">Após um dano material coberto, uma máquina pode levar semanas para ser substituída ou reparada. Dimensione lucros cessantes com faturamento, despesas fixas, sazonalidade, dependência de equipamento importado e possibilidade de terceirizar a produção.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Subtração e movimentação de equipamentos</h2>\n<p class=\"mb-4\">Verifique portas, alarmes, câmeras e forma de acesso. Equipamentos usados em feiras, instalações ou produção externa podem exigir proteção própria para transporte e permanência fora do endereço segurado.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para cotação</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>CNPJ, endereço e atividades exercidas.</li><li>Imóvel próprio ou alugado e benfeitorias.</li><li>Relação de máquinas, valores e ano de fabricação.</li><li>Estoque médio e máximo de papel, tinta e produtos acabados.</li><li>Materiais e arquivos de clientes sob guarda.</li><li>Instalação externa, trabalho em altura e terceirizados.</li><li>Proteções elétricas, incêndio, alarme e câmeras.</li><li>Faturamento, despesas fixas e prazo de reposição.</li><li>Histórico de sinistros e interrupções.</li></ul>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/seguro-deposito-distribuidora-estoque-empilhadeira\">estoque, máquinas e movimentação interna</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-lavanderia-maquinas-roupas-clientes-responsabilidade-civil\">máquinas e bens de clientes</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Quer comparar o seguro da sua gráfica?</h2><p class=\"mb-5\">Envie o CNPJ, endereço, relação de máquinas e serviços. A Elevance organiza os riscos e compara as opções disponíveis entre os parceiros autorizados.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo, revisado em 18/09/2026. Aceitação, atividades, bens, limites, franquias e exclusões dependem das condições contratuais.</p>\n<p class=\"text-sm text-slate-600\">Fontes: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/copy_of_planos-e-produtos/seguros/seguro-compreensivo\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro compreensivo</a> · <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-responsabilidade-civil\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — responsabilidade civil</a>.</p>"
  },

  {
    "id": 151,
    "slug": "seguro-marcenaria-maquinas-madeira-incendio-responsabilidade-civil",
    "title": "Seguro para Marcenaria: Máquinas, Madeira, Incêndio e Responsabilidade Civil",
    "date": "19 Set, 2026",
    "category": "Seguro Empresarial",
    "readTime": "6 min",
    "image": "https://images.unsplash.com/photo-1452860606245-08befc0ff44b?auto=format&fit=crop&q=80&w=800",
    "excerpt": "Veja como comparar proteção para máquinas, estoque de madeira, projetos sob medida, instalação externa, paralisação e responsabilidade civil.",
    "content": "<p class=\"mb-4\">Marcenarias combinam máquinas elétricas, pó de madeira, materiais combustíveis, peças sob medida e instalação no endereço do cliente. Uma cotação adequada precisa descrever produção, estoque, equipamentos, proteção contra incêndio e serviços externos.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Seguro empresarial: o que pode entrar?</h2>\n<p class=\"mb-4\">Conforme a apólice, podem ser contratadas proteções para prédio, conteúdo e prejuízos decorrentes de eventos cobertos. Incêndio, danos elétricos, subtração, vendaval, equipamentos, responsabilidade civil e lucros cessantes possuem limites, franquias e exclusões próprios.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Máquinas e ferramentas</h2>\n<p class=\"mb-4\">Seccionadora, esquadrejadeira, coladeira de borda, tupia, compressor, coletor de pó e ferramentas portáteis devem ser relacionados pelo valor de reposição. Informe equipamentos financiados, alugados ou pertencentes a terceiros.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Danos elétricos não são manutenção</h2>\n<p class=\"mb-4\">Variação anormal de tensão, curto-circuito e outros fenômenos elétricos podem ser contemplados quando a cobertura estiver contratada. Desgaste, falha mecânica, falta de manutenção e consumíveis normalmente exigem análise diferente.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Madeira, MDF, vernizes e estoque</h2>\n<p class=\"mb-4\">Declare matéria-prima, ferragens, produtos de acabamento e móveis prontos. O valor máximo pode mudar conforme volume de pedidos. Forma de armazenagem, ventilação, produtos inflamáveis e separação das áreas influenciam a avaliação do risco.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Incêndio e prevenção</h2>\n<p class=\"mb-4\">Pó acumulado, instalações elétricas, solda eventual e produtos de acabamento merecem atenção. Extintores, manutenção elétrica, coleta de resíduos, organização e proibição de fontes de ignição precisam ser informados corretamente na proposta.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Móveis de clientes e projetos em produção</h2>\n<p class=\"mb-4\">Materiais recebidos, peças para reparo e projetos já pagos podem envolver bens e interesses de terceiros. Confirme se há cobertura, como o valor é comprovado e quais limites se aplicam por evento.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Instalação na casa ou empresa do cliente</h2>\n<p class=\"mb-4\">Perfuração de paredes, montagem, trabalho em altura e transporte criam riscos fora da oficina. Danos ao imóvel, a objetos próximos ou a terceiros não devem ser presumidos como cobertos pelo seguro do endereço da marcenaria.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Responsabilidade civil</h2>\n<p class=\"mb-4\">O RC operacional pode responder a reclamações por danos involuntários ligados à atividade, conforme contrato. Defeito do produto, erro de projeto, atraso e obrigação de refazer o móvel podem exigir extensões específicas ou permanecer excluídos.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Transporte e veículos</h2>\n<p class=\"mb-4\">Móveis e ferramentas em deslocamento podem precisar de proteção de transporte ou equipamentos móveis. Veículo próprio, agregado ou transportadora contratada mudam a responsabilidade e a solução possível.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Paralisação da produção</h2>\n<p class=\"mb-4\">Após um dano material coberto, a reposição de máquinas e a recuperação do espaço podem levar tempo. Para dimensionar lucros cessantes, considere faturamento, despesas fixas, carteira de pedidos, multas contratuais não cobertas e possibilidade de terceirização.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para cotação</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>CNPJ, endereço e atividades realizadas.</li><li>Imóvel próprio ou alugado e benfeitorias.</li><li>Máquinas, ferramentas e valores de reposição.</li><li>Estoque médio e máximo de madeira e produtos acabados.</li><li>Vernizes, solventes e forma de armazenagem.</li><li>Coleta de pó, extintores e manutenção elétrica.</li><li>Bens de clientes e projetos em produção.</li><li>Instalação externa, transporte e terceirizados.</li><li>Faturamento, despesas fixas e prazo de retomada.</li></ul>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/seguro-grafica-maquinas-papel-acabamento-responsabilidade-civil\">máquinas, estoque e acabamento</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-lavanderia-maquinas-roupas-clientes-responsabilidade-civil\">máquinas e bens de clientes</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Quer comparar o seguro da sua marcenaria?</h2><p class=\"mb-5\">Envie o CNPJ, endereço, relação de máquinas, estoque e serviços externos. A Elevance organiza os riscos e compara as opções disponíveis entre os parceiros autorizados.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo, revisado em 19/09/2026. Aceitação, atividades, bens, limites, franquias e exclusões dependem das condições contratuais.</p>\n<p class=\"text-sm text-slate-600\">Fontes: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/copy_of_planos-e-produtos/seguros/seguro-compreensivo\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro compreensivo</a> · <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-responsabilidade-civil\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — responsabilidade civil</a>.</p>"
  },

  {
    "id": 152,
    "slug": "seguro-buffet-espaco-festas-eventos-responsabilidade-civil",
    "title": "Seguro para Buffet e Espaço de Festas: Eventos, Equipamentos e Responsabilidade Civil",
    "date": "20 Set, 2026",
    "category": "Seguro Empresarial",
    "readTime": "6 min",
    "image": "https://images.unsplash.com/photo-1507501336603-6e31db2be093?auto=format&fit=crop&q=80&w=800",
    "excerpt": "Veja como comparar proteção para estrutura, cozinha, equipamentos, convidados, atrações, eventos externos e responsabilidade civil.",
    "content": "<p class=\"mb-4\">Buffets e espaços de festas reúnem público, alimentos, equipamentos, decoração, fornecedores e estruturas temporárias em um mesmo evento. Para comparar seguros de forma útil, é preciso separar a proteção do imóvel e dos bens da responsabilidade por danos a convidados e terceiros.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Seguro empresarial ou responsabilidade civil de eventos?</h2>\n<p class=\"mb-4\">O seguro empresarial protege interesses patrimoniais do estabelecimento conforme as coberturas contratadas. Já a responsabilidade civil trata de reclamações por danos involuntários a terceiros dentro dos limites e condições da apólice. Um não substitui automaticamente o outro.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Imóvel, móveis e equipamentos</h2>\n<p class=\"mb-4\">Mesas, cadeiras, cozinha industrial, câmaras frias, som, iluminação, climatização e itens de decoração devem ser informados pelo valor de reposição. Bens alugados ou pertencentes a fornecedores precisam ser identificados, pois não devem ser presumidos como conteúdo próprio.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Incêndio, gás e cozinha</h2>\n<p class=\"mb-4\">Uso de GLP, fritadeiras, fornos, coifas, velas e estruturas decorativas altera o risco. Informe onde ficam os botijões ou central de gás, sistemas de exaustão, extintores, saídas e rotinas de manutenção. A cobertura depende do evento previsto e das condições contratuais.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Danos elétricos e equipamentos de festa</h2>\n<p class=\"mb-4\">Variações anormais de tensão e curto-circuito podem ser contemplados por danos elétricos quando contratados. Desgaste, falha interna, instalação inadequada e manutenção não são a mesma coisa. Som e iluminação de terceiros também exigem análise específica.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quedas e acidentes com convidados</h2>\n<p class=\"mb-4\">Piso molhado, degraus, brinquedos, palco, piscina, estacionamento e grande circulação podem gerar reclamações. A contratação deve considerar capacidade do local, perfil dos eventos, medidas de segurança e limites de responsabilidade civil.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Alimentos e bebidas</h2>\n<p class=\"mb-4\">Produção própria, cozinha terceirizada, bebidas alcoólicas e serviço de garçons precisam ser declarados. O seguro não substitui boas práticas sanitárias, contratos com fornecedores ou controle de conservação dos alimentos.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Brinquedos, recreação e atrações</h2>\n<p class=\"mb-4\">Cama elástica, infláveis, recreadores, música ao vivo, geradores e efeitos especiais podem mudar a aceitação. Confirme quem fornece, instala e opera cada atração, além dos documentos e contratos exigidos.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Eventos no espaço ou fora dele</h2>\n<p class=\"mb-4\">Um buffet que atende apenas no próprio endereço tem exposição diferente de quem monta festas em residências, salões de condomínio ou empresas. Transporte, montagem e permanência de equipamentos fora do local segurado podem demandar proteção própria.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Cancelamento da festa está coberto?</h2>\n<p class=\"mb-4\">Não automaticamente. Lucros cessantes normalmente dependem de dano material coberto e período de paralisação comprovado. Multas, devolução de valores, chuva, ausência de fornecedor ou desistência do cliente exigem análise separada e podem não ter cobertura.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Bens dos clientes e presentes</h2>\n<p class=\"mb-4\">Presentes, roupas, celulares e objetos deixados no local são bens de terceiros. Verifique limites, caracterização do evento, controle de guarda e exclusões para simples desaparecimento antes de prometer qualquer proteção ao contratante.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para pedir uma cotação comparável</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>CNPJ, endereço e atividades exercidas.</li><li>Capacidade máxima e quantidade mensal de eventos.</li><li>Imóvel próprio ou alugado e valor das benfeitorias.</li><li>Móveis, cozinha, som, iluminação e equipamentos.</li><li>Uso de gás, geradores, velas ou efeitos especiais.</li><li>Produção própria ou terceirizada de alimentos.</li><li>Brinquedos, piscina, palco e recreação.</li><li>Estacionamento, segurança e controle de acesso.</li><li>Serviços externos, transporte e montagem.</li><li>Faturamento, despesas fixas e histórico de sinistros.</li></ul>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/seguro-empresarial-para-restaurante-coberturas\">seguro para restaurante e cozinha</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-hotel-pousada-hospedes-equipamentos-responsabilidade-civil\">hóspedes, eventos e responsabilidade civil</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Quer comparar o seguro do seu buffet ou espaço de festas?</h2><p class=\"mb-5\">Envie o CNPJ, endereço, capacidade, estrutura e tipos de evento. A Elevance organiza as informações e compara as opções disponíveis entre os parceiros autorizados.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo, revisado em 20/09/2026. Aceitação, atividades, bens, limites, franquias e exclusões dependem das condições contratuais.</p>\n<p class=\"text-sm text-slate-600\">Fontes: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/copy_of_planos-e-produtos/seguros/seguro-compreensivo\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro compreensivo</a> · <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-responsabilidade-civil\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — responsabilidade civil</a>.</p>"
  },

  {
    "id": 153,
    "slug": "seguro-laboratorio-analises-clinicas-equipamentos-rc-profissional",
    "title": "Seguro para Laboratório de Análises Clínicas: Equipamentos e RC Profissional",
    "date": "21 Set, 2026",
    "category": "Seguro Empresarial",
    "readTime": "6 min",
    "image": "https://images.unsplash.com/photo-1576086213369-97a306d36557?auto=format&fit=crop&q=80&w=800",
    "excerpt": "Entenda como comparar proteção patrimonial, equipamentos, reagentes, amostras, interrupção, dados e responsabilidade profissional.",
    "content": "<p class=\"mb-4\">Laboratórios de análises clínicas combinam equipamentos sensíveis, reagentes, amostras biológicas, sistemas de informação e responsabilidade técnica. Uma cotação útil precisa separar o patrimônio do laboratório das reclamações ligadas à prestação profissional.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Seguro empresarial ou RC profissional?</h2>\n<p class=\"mb-4\">O seguro empresarial pode proteger prédio, benfeitorias, móveis, estoque e equipamentos contra eventos contratados. O RC profissional trata de reclamações decorrentes de falhas involuntárias na prestação do serviço, conforme atividade aceita, limites e condições. São frentes complementares, não equivalentes.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Analisadores, centrífugas e equipamentos</h2>\n<p class=\"mb-4\">Relacione analisadores, centrífugas, microscópios, autoclaves, refrigeradores, freezers, nobreaks e sistemas automatizados pelo valor de reposição. Equipamentos em comodato, locados ou financiados devem ser identificados separadamente.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Danos elétricos não são quebra interna</h2>\n<p class=\"mb-4\">Variações anormais de tensão, curto-circuito e outros fenômenos elétricos podem ser contemplados quando a cobertura estiver contratada. Desgaste, defeito de fabricação, descalibração, falta de manutenção e pane mecânica exigem outra análise.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Reagentes, insumos e cadeia fria</h2>\n<p class=\"mb-4\">Informe estoque médio e máximo, condições de temperatura, alarmes, gerador e plano de contingência. A simples perda de validade, variação gradual ou falha sem evento coberto não deve ser presumida como indenizável.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Amostras de pacientes</h2>\n<p class=\"mb-4\">Amostras são bens e materiais de terceiros com características próprias. Verifique se há aceitação, como se comprova o prejuízo e quais despesas de recoleta ou repetição de exames podem ser consideradas. Não prometa cobertura sem previsão expressa.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Erro de resultado e responsabilidade profissional</h2>\n<p class=\"mb-4\">Troca de amostra, identificação incorreta, falha de processo ou liberação equivocada podem gerar reclamações. A proposta deve informar serviços realizados, responsáveis técnicos, volume de exames, terceirização, histórico e procedimentos de dupla checagem.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Coleta domiciliar e postos externos</h2>\n<p class=\"mb-4\">Coleta fora da sede, postos parceiros e transporte de amostras ampliam a exposição. Veículos, caixas térmicas, profissionais próprios ou terceirizados e cadeia de custódia precisam ser descritos para avaliar as soluções disponíveis.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Dados pessoais e sistemas</h2>\n<p class=\"mb-4\">Laudos, cadastros e dados de saúde exigem controles de acesso, backup e resposta a incidentes. Quando houver produto cyber disponível, compare restauração de dados, interrupção, responsabilidade perante terceiros e serviços de resposta.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Paralisação do laboratório</h2>\n<p class=\"mb-4\">Um dano material coberto pode interromper exames e comprometer receita. Para dimensionar lucros cessantes, considere faturamento, despesas fixas, prazo de reposição de equipamentos, dependência de importação e possibilidade de encaminhar exames a terceiros.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Resíduos, materiais biológicos e exclusões</h2>\n<p class=\"mb-4\">Descarte, armazenamento temporário e contratação de empresa especializada devem ser informados. Danos ambientais, contaminação gradual e riscos biológicos podem exigir condições específicas ou permanecer excluídos.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para solicitar cotação</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>CNPJ, endereço e atividades exercidas.</li><li>Responsáveis técnicos e registros profissionais.</li><li>Tipos e volume anual de exames.</li><li>Relação de equipamentos e valores de reposição.</li><li>Equipamentos próprios, financiados ou em comodato.</li><li>Estoque de reagentes e controle de temperatura.</li><li>Coleta externa, postos e transporte de amostras.</li><li>Backup, segurança de dados e contingência.</li><li>Faturamento, despesas fixas e prazo de retomada.</li><li>Histórico de reclamações e sinistros.</li></ul>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/seguro-clinica-odontologica-empresarial-rc-profissional\">seguro empresarial ou RC profissional para clínicas</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-rc-profissional-psicologo-consultorio-online\">como funciona o RC profissional</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Quer comparar o seguro do seu laboratório?</h2><p class=\"mb-5\">Envie o CNPJ, endereço, atividades, equipamentos e faturamento. A Elevance organiza as informações e compara as opções disponíveis entre os parceiros autorizados.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo, revisado em 21/09/2026. Aceitação, atividades, bens, limites, franquias e exclusões dependem das condições contratuais.</p>\n<p class=\"text-sm text-slate-600\">Fontes: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/copy_of_planos-e-produtos/seguros/seguro-compreensivo\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro compreensivo</a> · <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-responsabilidade-civil\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — responsabilidade civil</a>.</p>"
  },

  {
    "id": 154,
    "slug": "seguro-otica-armacoes-lentes-equipamentos-responsabilidade-civil",
    "title": "Seguro para Ótica: Armações, Lentes, Equipamentos e Responsabilidade Civil",
    "date": "22 Set, 2026",
    "category": "Seguro Empresarial",
    "readTime": "6 min",
    "image": "https://images.unsplash.com/photo-1574258495973-f010dfbb5371?auto=format&fit=crop&q=80&w=800",
    "excerpt": "Veja como comparar proteção para estoque, equipamentos ópticos, vidros, mercadorias em trânsito, paralisação e danos a clientes.",
    "content": "<p class=\"mb-4\">Uma ótica reúne armações de alto valor, lentes sob encomenda, equipamentos de medição, vitrines e dados de clientes. A apólice precisa refletir esse conjunto: contratar apenas uma cobertura básica para o ponto comercial pode deixar exposições importantes fora da comparação.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Seguro empresarial e responsabilidade civil são diferentes</h2>\n<p class=\"mb-4\">O seguro empresarial protege bens e despesas da própria ótica contra eventos contratados. A responsabilidade civil trata de danos involuntários causados a terceiros, dentro das situações previstas. Uma cobertura não substitui automaticamente a outra.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Estoque de armações: use o pico, não apenas a média</h2>\n<p class=\"mb-4\">Some armações expostas, estoque de apoio, óculos prontos aguardando retirada e mercadorias de terceiros sob responsabilidade da loja. Se o volume aumenta antes de datas promocionais, informe o estoque máximo esperado. Um limite calculado apenas pela média mensal pode ficar abaixo da exposição real.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Roubo não é o mesmo que furto simples</h2>\n<p class=\"mb-4\">Compare a definição contratual, os vestígios exigidos, as proteções mínimas do local e os bens abrangidos. Subtração sem vestígios, desaparecimento durante inventário e diferenças de estoque não devem ser presumidos como cobertos. Pergunte também como a apólice trata vitrines e mercadorias fora do cofre.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Vitrine, espelhos e comunicação visual</h2>\n<p class=\"mb-4\">Vidros de fachada, espelhos, letreiros e painéis podem exigir cobertura própria. Confirme se a indenização considera material, instalação, adesivos e eventuais medidas emergenciais de fechamento. Danos estéticos sem quebra ou desgaste gradual costumam precisar de análise específica.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Lensômetro, pupilômetro e outros equipamentos</h2>\n<p class=\"mb-4\">Relacione equipamentos ópticos, computadores, impressoras, ar-condicionado, câmeras e nobreaks pelo valor de reposição. A cobertura de danos elétricos pode responder a variações anormais de tensão e fenômenos definidos no contrato; ela não equivale a manutenção, desgaste ou quebra interna de qualquer origem.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Lentes em produção e mercadorias em trânsito</h2>\n<p class=\"mb-4\">Quando a ótica envia armações ao laboratório ou recebe lentes prontas, existe um intervalo em que os bens estão fora do endereço segurado. Informe coleta própria, transportadora, motoboy, frequência, valores máximos por remessa e responsabilidade contratual. A cobertura do estabelecimento não deve ser presumida durante o transporte.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Óculos de clientes sob guarda</h2>\n<p class=\"mb-4\">Ajustes, reparos e troca de lentes colocam bens de clientes sob responsabilidade da ótica. Pergunte se a apólice contempla danos, incêndio, roubo ou outros eventos envolvendo esses bens, quais documentos comprovam o valor e se há limite por item.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Atendimento, adaptação e reclamações</h2>\n<p class=\"mb-4\">Queda dentro da loja, dano causado durante ajuste ou reclamação ligada ao serviço podem envolver responsabilidade civil. Já a atuação de optometrista, médico ou outro profissional habilitado, quando existente, deve ser declarada e pode demandar análise ou cobertura específica. Não esconda atividades para obter preço menor: elas influenciam aceitação e enquadramento.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Dados de clientes e vendas digitais</h2>\n<p class=\"mb-4\">Cadastros, prescrições recebidas, medidas, pagamentos e pedidos exigem controle de acesso e backup. Se a ótica vende por site ou WhatsApp, descreva a operação. Produtos cyber, quando disponíveis, precisam ser comparados separadamente quanto a resposta a incidentes, restauração e responsabilidade perante terceiros.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Paralisação depois de um sinistro</h2>\n<p class=\"mb-4\">Um evento material coberto pode interromper as vendas mesmo sem destruir todo o estoque. Para avaliar lucros cessantes, informe faturamento, despesas fixas, sazonalidade, prazo para recompor vitrines e equipamentos e dependência de laboratórios fornecedores. A cobertura costuma depender de dano material previsto na apólice e de critérios de comprovação.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quem deve considerar uma análise mais detalhada?</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>Ótica com armações premium ou estoque sazonal elevado.</li><li>Loja em shopping, galeria ou imóvel alugado com exigências contratuais.</li><li>Operação que recebe óculos de clientes para ajuste e reparo.</li><li>Ótica com laboratório próprio, equipamentos de maior valor ou fabricação no local.</li><li>Negócio que transporta armações e lentes entre unidades ou fornecedores.</li><li>Rede com vendas on-line e base relevante de dados pessoais.</li></ul>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para solicitar cotação</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>CNPJ, endereço, área construída e tipo de imóvel.</li><li>Atividades realizadas na loja e existência de laboratório próprio.</li><li>Valor médio e máximo de armações, lentes e produtos acabados.</li><li>Relação de equipamentos com valores de reposição.</li><li>Proteções do local, câmeras, alarme, cofre e portas.</li><li>Vidros, espelhos, letreiros e benfeitorias.</li><li>Bens de clientes e valores máximos sob guarda.</li><li>Transporte de mercadorias e maior valor por remessa.</li><li>Faturamento, despesas fixas e prazo estimado de retomada.</li><li>Histórico de sinistros e reclamações.</li></ul>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/seguro-loja-roupas-estoque-vitrine-roubo\">como analisar estoque, vitrine e roubo no varejo</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-cibernetico-para-pequenas-empresas-coberturas\">proteção cyber para pequenas empresas</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Quer comparar o seguro da sua ótica?</h2><p class=\"mb-5\">Envie o CNPJ, endereço, atividades, estoque, equipamentos e faturamento. A Elevance organiza o risco e compara as opções disponíveis entre os parceiros autorizados.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo, revisado em 22/09/2026. Aceitação, atividades, bens, limites, franquias e exclusões dependem das condições contratuais.</p>\n<p class=\"text-sm text-slate-600\">Fontes: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/copy_of_planos-e-produtos/seguros/seguro-compreensivo\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro compreensivo</a> · <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-responsabilidade-civil\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — responsabilidade civil</a>.</p>"
  },

  {
    "id": 155,
    "slug": "seguro-assistencia-tecnica-celulares-aparelhos-clientes-estoque",
    "title": "Seguro para Assistência Técnica de Celulares: Aparelhos de Clientes, Estoque e RC",
    "date": "23 Set, 2026",
    "category": "Seguro Empresarial",
    "readTime": "6 min",
    "image": "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&q=80&w=800",
    "excerpt": "Veja como comparar proteção para aparelhos de clientes, peças, ferramentas, subtração, danos elétricos, paralisação e responsabilidade civil.",
    "content": "<p class=\"mb-4\">Uma assistência técnica pode manter dezenas de celulares, tablets e notebooks de clientes no mesmo endereço, além de peças pequenas, ferramentas e equipamentos de diagnóstico. Esse patrimônio não pertence todo à empresa, por isso uma cotação genérica baseada apenas nos móveis e no estoque próprio pode deixar a principal exposição sem resposta.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Seguro empresarial cobre aparelhos de clientes?</h2>\n<p class=\"mb-4\">Não automaticamente. O seguro empresarial protege os interesses descritos na apólice contra eventos contratados. Bens de terceiros sob guarda, custódia ou controle precisam ser declarados e aceitos, com limites e condições próprios. A proposta deve dizer expressamente como trata os aparelhos recebidos para orçamento, reparo ou retirada.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Estoque próprio e bens de terceiros não são a mesma verba</h2>\n<p class=\"mb-4\">Telas, baterias, conectores, placas, acessórios e aparelhos destinados à revenda formam o estoque da empresa. Celulares entregues para conserto pertencem aos clientes. Compare separadamente os limites para conteúdo próprio e bens de terceiros, a forma de comprovar valores e o máximo indenizável por aparelho e por evento.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Roubo, furto qualificado e desaparecimento</h2>\n<p class=\"mb-4\">Confira as definições contratuais, os vestígios exigidos e as medidas mínimas de proteção. Diferença de inventário, entrega ao portador errado e desaparecimento sem explicação não devem ser tratados como equivalentes a roubo. Informe portas, grades, alarme, câmeras, cofre e rotina de guarda após o expediente.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quanto declarar para aparelhos em reparo?</h2>\n<p class=\"mb-4\">Use o pico razoavelmente esperado, não apenas a média de uma semana tranquila. Registre marca, modelo, identificação, estado de entrada, defeitos aparentes e acessórios entregues. Uma ordem de serviço clara ajuda a controlar a guarda e a documentar eventual reclamação.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Dano durante o conserto e responsabilidade civil</h2>\n<p class=\"mb-4\">Queda da bancada, líquido, uso de peça inadequada ou dano durante a abertura podem gerar reclamações. A Susep explica que o seguro de responsabilidade civil protege o segurado diante de reparações por danos a terceiros dentro do limite e das condições contratadas. Confirme se trabalhos executados, bens manuseados e responsabilidade profissional estão abrangidos; refazer serviço, garantia e obrigação contratual podem ter tratamento diferente.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Bateria, calor e risco de incêndio</h2>\n<p class=\"mb-4\">Baterias de íons de lítio danificadas, estufadas ou em teste exigem procedimento de recebimento, isolamento e descarte adequado. Declare a quantidade armazenada, o local de carga, as fontes de calor e as medidas de prevenção. O seguro não substitui treinamento, manutenção elétrica nem conformidade com regras aplicáveis.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Danos elétricos e equipamentos da bancada</h2>\n<p class=\"mb-4\">Estações de solda, fontes, microscópios, computadores, ferramentas de diagnóstico, ar-condicionado e nobreaks devem constar no inventário. Danos elétricos podem contemplar fenômenos previstos na apólice, mas não equivalem a desgaste, falha interna de qualquer origem ou falta de manutenção.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Coleta, entrega e aparelhos em trânsito</h2>\n<p class=\"mb-4\">Se a empresa busca aparelhos, envia placas a laboratórios ou entrega reparos por motoboy, informe trajetos, frequência, embalagem, prestadores e maior valor por remessa. A proteção do endereço não deve ser presumida durante o transporte.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Dados e senhas dos clientes</h2>\n<p class=\"mb-4\">O acesso a fotos, contas, senhas e arquivos cria uma exposição distinta do dano físico. Adote termos de autorização, acesso mínimo, registro de quem manipula o aparelho e política de descarte. Coberturas cyber, quando disponíveis, devem ser comparadas separadamente quanto a incidentes, restauração, notificação e responsabilidade perante terceiros.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Paralisação e perda de receita</h2>\n<p class=\"mb-4\">Depois de um dano material coberto, a loja pode ficar sem bancada, sistema ou acesso ao imóvel. Para dimensionar lucros cessantes, informe faturamento, despesas fixas, sazonalidade, prazo de reposição e possibilidade de transferir serviços. A cobertura costuma depender de evento material previsto e de comprovação.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Perfis que merecem análise mais detalhada</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>Assistência que recebe grande volume de aparelhos premium.</li><li>Loja que também vende celulares, acessórios e peças.</li><li>Operação com coleta, entrega ou envio a laboratório externo.</li><li>Empresa que guarda aparelhos por vários dias após o reparo.</li><li>Rede com estoque centralizado e transferência entre unidades.</li><li>Assistência que acessa dados ou credenciais durante o diagnóstico.</li></ul>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para solicitar propostas comparáveis</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>CNPJ, endereço e atividades exercidas.</li><li>Valor de móveis, bancada, ferramentas e equipamentos.</li><li>Estoque médio e máximo de peças e aparelhos próprios.</li><li>Quantidade e valor máximo de bens de clientes sob guarda.</li><li>Ordem de serviço, inventário e controle de retirada.</li><li>Alarme, câmeras, cofre, portas e rotina fora do expediente.</li><li>Armazenamento e manuseio de baterias.</li><li>Coleta, entrega e remessas para terceiros.</li><li>Faturamento, despesas fixas e prazo de retomada.</li><li>Histórico de sinistros e reclamações.</li></ul>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/seguro-para-notebook-celular-equipamentos-portateis-empresa\">proteção para equipamentos portáteis da empresa</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-cibernetico-para-pequenas-empresas-coberturas\">seguro cyber para pequenas empresas</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Quer comparar o seguro da sua assistência técnica?</h2><p class=\"mb-5\">Envie o CNPJ, endereço, estoque, equipamentos e valor máximo dos aparelhos de clientes. A Elevance organiza o risco e compara as opções disponíveis entre os parceiros autorizados.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo, revisado em 23/09/2026. Aceitação, atividades, bens, limites, franquias e exclusões dependem das condições contratuais e da análise de risco.</p>\n<p class=\"text-sm text-slate-600\">Fontes: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/copy_of_planos-e-produtos/seguros/seguro-compreensivo\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro compreensivo</a> · <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-responsabilidade-civil\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — responsabilidade civil</a>.</p>"
  },

  {
    "id": 156,
    "slug": "seguro-clinica-fisioterapia-pilates-equipamentos-rc-profissional",
    "title": "Seguro para Clínica de Fisioterapia e Pilates: Equipamentos e RC Profissional",
    "date": "24 Set, 2026",
    "category": "Responsabilidade Civil",
    "readTime": "6 min",
    "image": "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&q=80&w=800",
    "excerpt": "Compare seguro empresarial e RC profissional para equipamentos, atendimento, quedas, dados de pacientes e paralisação da clínica.",
    "content": "<p class=\"mb-4\">Uma clínica de fisioterapia ou estúdio de Pilates reúne duas exposições que não devem ser colocadas no mesmo pacote sem análise: o patrimônio necessário para funcionar e a responsabilidade ligada ao atendimento profissional. Um incêndio que danifica aparelhos é diferente de uma reclamação de paciente após uma sessão.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Seguro empresarial ou RC profissional?</h2>\n<p class=\"mb-4\"><strong>Seguro empresarial:</strong> pode proteger imóvel, benfeitorias, móveis, computadores e equipamentos contra eventos contratados, além de incluir coberturas como danos elétricos, subtração e lucros cessantes, conforme o produto.</p>\n<p class=\"mb-4\"><strong>Responsabilidade civil profissional:</strong> pode amparar reclamações relacionadas a atos profissionais cobertos, dentro dos limites, vigência, retroatividade e demais condições. A Susep cita fisioterapeutas entre os profissionais que podem contratar RC profissional.</p>\n<p class=\"mb-4\">As duas soluções são complementares. RC operacional para uma queda na recepção também não deve ser presumida como equivalente ao RC ligado ao atendimento técnico.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quem precisa aparecer como segurado?</h2>\n<p class=\"mb-4\">Informe se a clínica é pessoa jurídica, quais profissionais atendem e se há sócios, empregados, prestadores, autônomos ou profissionais que apenas alugam sala. Uma apólice em nome da empresa não inclui automaticamente toda pessoa que atua no endereço. Confira segurados, atividades e vínculos descritos.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Fisioterapia, Pilates e outras atividades</h2>\n<p class=\"mb-4\">Declare fisioterapia ortopédica, respiratória, neurológica, esportiva, pélvica, domiciliar, Pilates, RPG, terapias manuais e outras técnicas efetivamente realizadas. Atendimento de crianças, idosos, pós-operatório ou atletas pode alterar o perfil. Procedimentos não informados ou excluídos não devem ser tratados como cobertos.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Limite por reclamação e durante a vigência</h2>\n<p class=\"mb-4\">Compare limite por reclamação, agregado anual, franquia ou participação obrigatória, custos de defesa e eventual cobertura para danos morais. A existência de um valor alto na proposta não basta se várias reclamações dividirem o mesmo agregado.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Retroatividade e prazo para comunicar</h2>\n<p class=\"mb-4\">Apólices de RC profissional podem operar em base de reclamações. Verifique data de retroatividade, período complementar e suplementar, renovação e regras para notificar fatos que possam gerar reclamação. Trocar de seguradora sem preservar a continuidade pode criar lacunas.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Reclamação não significa indenização automática</h2>\n<p class=\"mb-4\">O contrato define eventos, exclusões e procedimentos. A Susep orienta que acordo ou reconhecimento de responsabilidade depende de anuência da seguradora nas situações previstas. Ao receber uma reclamação, preserve prontuários e documentos e comunique conforme a apólice antes de prometer pagamento.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Reformer, Cadillac e equipamentos da clínica</h2>\n<p class=\"mb-4\">Relacione aparelhos de Pilates, macas, equipamentos de eletroterapia, ultrassom, laser, computadores, ar-condicionado e mobiliário pelo valor de reposição. Bens alugados, financiados ou de profissionais parceiros exigem identificação correta.</p>\n<p class=\"mb-4\">Danos elétricos podem contemplar fenômenos previstos no contrato, mas não equivalem a desgaste, calibração, consumíveis, falha interna de qualquer origem ou manutenção. Para equipamentos móveis usados fora da clínica, confirme território e condições específicas.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quedas, circulação e RC operacional</h2>\n<p class=\"mb-4\">Piso molhado, degraus, barras, molas, bolas e circulação de acompanhantes podem gerar acidentes sem relação com um erro técnico. Avalie RC de operações, acessibilidade, sinalização, manutenção e limite para danos corporais, materiais e morais.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Atendimento domiciliar e em empresas</h2>\n<p class=\"mb-4\">Se o profissional atende em residência, hospital, academia ou empresa, a atividade fora do endereço precisa ser declarada. Transporte de equipamentos, atuação em local de terceiros e responsabilidade contratual podem demandar extensões diferentes.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Prontuários, imagens e dados pessoais</h2>\n<p class=\"mb-4\">Prontuários, avaliações, imagens, agenda e dados de pagamento exigem controle de acesso, backup e descarte seguro. O seguro patrimonial não substitui automaticamente uma proteção cyber. Compare resposta a incidentes, restauração, notificação e responsabilidade perante terceiros quando essa solução estiver disponível.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Paralisação depois de um sinistro</h2>\n<p class=\"mb-4\">Danos ao imóvel ou aos principais aparelhos podem interromper atendimentos. Para avaliar lucros cessantes, informe faturamento, despesas fixas, sazonalidade, prazo de reposição e possibilidade de usar outro espaço. A cobertura normalmente depende de dano material coberto e dos critérios de comprovação.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist para pedir propostas comparáveis</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>CNPJ, endereço, área e ocupação do imóvel.</li><li>Modalidades de fisioterapia e demais serviços realizados.</li><li>Número, vínculo e qualificação dos profissionais.</li><li>Atendimento na clínica, domiciliar ou em locais de terceiros.</li><li>Faturamento e quantidade média de atendimentos.</li><li>Equipamentos próprios, alugados e financiados.</li><li>Histórico de sinistros, reclamações e processos.</li><li>Limite por reclamação, agregado, franquia e custos de defesa.</li><li>Retroatividade e períodos para comunicação.</li><li>Dados pessoais, prontuários e controles de acesso.</li></ul>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/seguro-para-academia-equipamentos-responsabilidade-civil\">seguro para academia e estúdio</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-clinica-odontologica-empresarial-rc-profissional\">diferença entre seguro empresarial e RC profissional em clínicas</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Quer comparar o seguro da sua clínica ou estúdio?</h2><p class=\"mb-5\">Envie o CNPJ, atividades, equipe, faturamento e relação de equipamentos. A Elevance organiza o risco e compara as opções disponíveis entre os parceiros autorizados.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Falar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo, revisado em 24/09/2026. Aceitação, profissionais, atividades, limites, franquias, retroatividade e exclusões dependem das condições contratuais e da análise de risco.</p>\n<p class=\"text-sm text-slate-600\">Fontes: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-responsabilidade-civil\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro de responsabilidade civil</a> · <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/copy_of_planos-e-produtos/seguros/seguro-compreensivo\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro compreensivo</a>.</p>"
  },

  {
    "id": 157,
    "slug": "seguro-auto-valor-mercado-referenciado-vs-determinado",
    "title": "Seguro Auto: Valor de Mercado Referenciado ou Valor Determinado?",
    "date": "25 Set, 2026",
    "category": "Seguro Auto",
    "readTime": "6 min",
    "image": "https://images.unsplash.com/photo-1503736334956-4c8f8e92946d?auto=format&fit=crop&q=80&w=800",
    "excerpt": "Compare como cada modalidade calcula a indenização integral, o papel da tabela de referência, o fator de ajuste e quando o valor fixo merece atenção.",
    "content": "<p class=\"mb-4\">Duas cotações podem proteger o mesmo carro e prever valores bem diferentes numa indenização integral. A razão pode estar na modalidade do casco: <strong>valor de mercado referenciado</strong> ou <strong>valor determinado</strong>. Comparar apenas o prêmio sem olhar esse campo deixa uma parte importante da decisão escondida.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">O que é valor de mercado referenciado?</h2>\n<p class=\"mb-4\">Segundo a Susep, nessa modalidade a indenização integral é variável. O cálculo usa a tabela de referência expressamente indicada na proposta e na apólice, aplicada ao valor de cotação do veículo na data do sinistro e combinada com o fator de ajuste contratado.</p>\n<p class=\"mb-4\">A tabela precisa ser produzida por instituição independente de notória competência e apresentar preços médios do mercado nacional por modelo e ano. A apólice também deve indicar uma tabela substituta para o caso de interrupção da referência principal.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Fator de ajuste: 90%, 100% ou 110% não são a mesma coisa</h2>\n<p class=\"mb-4\">O percentual é aplicado à cotação vigente na data do evento, dentro das condições contratadas. Em um exemplo puramente matemático, se a referência fosse R$ 80 mil, 90% corresponderiam a R$ 72 mil, 100% a R$ 80 mil e 110% a R$ 88 mil.</p>\n<p class=\"mb-4\">Isso não é previsão de preço nem de indenização real. A tabela, o mês do sinistro, o enquadramento exato do veículo e eventuais regras da apólice precisam ser confirmados. O fator disponível também depende da política de aceitação da seguradora.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">O que é valor determinado?</h2>\n<p class=\"mb-4\">No valor determinado, a indenização integral corresponde à quantia fixa estipulada entre as partes na contratação e registrada na apólice. Ela não oscila mensalmente com uma tabela de mercado durante a vigência.</p>\n<p class=\"mb-4\">A modalidade pode merecer análise em veículos cuja configuração não seja bem representada pela média da tabela, mas a oferta, o valor aceito e o preço dependem da seguradora. Não basta informar quanto foi gasto: documentos, vistoria, conservação, raridade, acessórios e mercado podem participar da análise.</p>\n<div class=\"overflow-x-auto my-6\"><table class=\"w-full text-left\"><thead><tr><th scope=\"col\">Ponto</th><th scope=\"col\">Mercado referenciado</th><th scope=\"col\">Valor determinado</th></tr></thead><tbody><tr><td>Base da indenização integral</td><td>Tabela indicada, na data do sinistro, vezes o fator contratado.</td><td>Quantia fixa registrada na apólice.</td></tr><tr><td>Variação durante a vigência</td><td>Acompanha a referência utilizada.</td><td>Não depende da variação mensal da tabela.</td></tr><tr><td>O que comparar</td><td>Tabela, percentual e veículo corretamente enquadrado.</td><td>Valor aceito, documentação e custo da contratação.</td></tr></tbody></table></div>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Acessórios, blindagem e modificações entram automaticamente?</h2>\n<p class=\"mb-4\">Não presuma. Som, rodas, kit gás, equipamentos, adaptações e blindagem podem exigir declaração e cobertura específica. O fato de o proprietário ter investido no carro não transforma automaticamente esses valores em indenização do casco.</p>\n<p class=\"mb-4\">Peça que a proposta mostre o tratamento de cada item, os limites e a documentação exigida. Em carros blindados, clássicos, importados ou modificados, a diferença entre preço médio e custo de reposição pode tornar essa conferência ainda mais relevante.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Valor de novo para carro zero quilômetro</h2>\n<p class=\"mb-4\">A Susep esclarece que não existe um prazo regulatório único para pagar valor de veículo zero quilômetro. As condições podem prever períodos diferentes, como 30, 60, 90 ou 120 dias, ou não oferecer esse critério. Quanto maior a proteção, o prêmio tende a ser maior.</p>\n<p class=\"mb-4\">Confira quando a contagem começa, quais documentos comprovam a condição de zero quilômetro e o que acontece depois do prazo. Não confunda valor de novo com valor determinado: são cláusulas e decisões de contratação distintas.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Perda total não é definida apenas por “75%”</h2>\n<p class=\"mb-4\">As condições contratuais estabelecem o critério para caracterizar a indenização integral. A Susep dá exemplos de produtos que podem usar percentuais diferentes sobre o limite máximo de indenização. Portanto, não trate um único percentual como regra universal para todas as apólices.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quem tende a olhar com mais atenção para cada modalidade?</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li><strong>Carro de uso comum, bem representado na tabela:</strong> compare o fator e confirme a versão correta.</li><li><strong>Veículo raro, antigo, importado ou modificado:</strong> pergunte se existe valor determinado e qual documentação será aceita.</li><li><strong>Carro blindado ou com acessórios relevantes:</strong> separe casco, blindagem e equipamentos em vez de presumir um único valor.</li><li><strong>Zero quilômetro:</strong> compare o prazo de valor de novo, além da modalidade principal.</li><li><strong>Financiado:</strong> entenda a quitação do saldo e não suponha que a dívida define a indenização.</li></ul>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Checklist antes de aceitar a cotação</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>Modalidade do casco: VMR, VD ou outro critério contratual.</li><li>Tabela de referência principal e substituta.</li><li>Fator de ajuste contratado.</li><li>Marca, modelo, versão, ano e opcionais corretamente informados.</li><li>Valor fixo aceito, quando houver valor determinado.</li><li>Blindagem, acessórios, adaptações e equipamentos declarados.</li><li>Prazo e regras de valor de novo para zero quilômetro.</li><li>Critério de caracterização da indenização integral.</li><li>Franquias, coberturas para terceiros e serviços mantidos iguais na comparação.</li></ul>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/seguro-auto-carro-acima-de-100-mil-coberturas\">coberturas para carros acima de R$ 100 mil</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-carro-blindado-cobertura-blindagem-oficina-indenizacao\">como declarar a blindagem no seguro auto</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Quer comparar a indenização antes de contratar?</h2><p class=\"mb-5\">Envie os dados do veículo e as propostas à Elevance. Vamos confrontar modalidade, tabela, fator de ajuste, coberturas e preço entre as opções disponíveis nos parceiros autorizados.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Comparar meu seguro com a Elevance</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo, revisado em 25/09/2026. Aceitação, modalidade, tabela, fator, valor segurado, coberturas, franquias e critérios de indenização dependem da proposta e das condições contratuais.</p>\n<p class=\"text-sm text-slate-600\">Fonte: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-de-automoveis\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro de automóveis</a>.</p>"
  },

  {
    "id": 158,
    "slug": "seguro-auto-veiculo-cnpj-condutor-principal",
    "title": "Seguro Auto para Veículo no CNPJ: Quem Deve Ser o Condutor Principal?",
    "date": "26 Set, 2026",
    "category": "Seguro Auto",
    "readTime": "6 min",
    "image": "https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?auto=format&fit=crop&q=80&w=800",
    "excerpt": "Entenda como declarar proprietário, uso, condutores, funcionários e atividade do veículo empresarial para comparar propostas sem esconder o risco real.",
    "content": "<p class=\"mb-4\">Colocar o carro no CNPJ não transforma automaticamente todo uso em uma frota — e também não permite cotar como se o veículo fosse exclusivamente particular quando ele atende a empresa. Para comparar propostas de forma útil, a seguradora precisa saber <strong>quem é o proprietário, quem dirige, para que o carro é usado e com que frequência</strong>.</p>\n<p class=\"mb-4\">A Susep explica que o prêmio do seguro auto é calculado a partir das informações enviadas sobre o automóvel, o segurado e o condutor. Por isso, escolher o condutor principal apenas pelo menor preço pode produzir uma cotação incompatível com o risco real.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Proprietário, segurado e condutor são papéis diferentes</h2>\n<p class=\"mb-4\"><strong>Proprietário:</strong> é quem consta no registro do veículo. <strong>Segurado:</strong> é quem possui o interesse protegido e aparece no contrato. <strong>Condutor:</strong> é quem efetivamente dirige. Em um veículo empresarial, esses papéis podem envolver o CNPJ, um sócio, empregado ou outro usuário aceito pela seguradora.</p>\n<p class=\"mb-4\">A estrutura admitida varia conforme o produto e a política de aceitação. A proposta precisa reproduzir a situação verdadeira; não presuma que informar apenas o nome da empresa resolve quem usa o carro.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Quem deve ser indicado como condutor principal?</h2>\n<p class=\"mb-4\">Use a definição do questionário da seguradora. Em geral, a pergunta busca identificar quem dirige com maior frequência, mas critérios e faixas podem variar. Se dois ou mais motoristas dividem o uso, descreva a rotina ao corretor em vez de escolher arbitrariamente um deles.</p>\n<p class=\"mb-4\">O sócio que usa o carro todos os dias para visitar clientes não deixa de ser o usuário relevante só porque o documento está em nome da empresa. Da mesma forma, um empregado que conduz o veículo na maior parte da semana não deve ser omitido para manter o perfil do sócio.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Uso particular, comercial ou misto?</h2>\n<div class=\"overflow-x-auto my-6\"><table class=\"w-full text-left\"><thead><tr><th scope=\"col\">Rotina</th><th scope=\"col\">O que declarar</th><th scope=\"col\">Ponto de atenção</th></tr></thead><tbody><tr><td>Sócio usa para deslocamento pessoal e reuniões</td><td>Uso misto e frequência real</td><td>Garagem, quilometragem e demais condutores</td></tr><tr><td>Funcionário visita clientes ou fornecedores</td><td>Atividade profissional e motoristas habilitados</td><td>Rodízio de condutores e território</td></tr><tr><td>Entregas, transporte de mercadorias ou ferramentas</td><td>Natureza da carga e operação</td><td>Bens transportados não entram automaticamente no casco</td></tr><tr><td>Aplicativo, locação ou transporte remunerado</td><td>Uso remunerado específico</td><td>Exige aceitação compatível; não é mero uso comercial genérico</td></tr></tbody></table></div>\n<p class=\"mb-4\">O CNPJ sozinho não descreve a exposição. Um carro administrativo que circula poucas vezes por semana tem rotina diferente de um veículo de entregas que passa o dia na rua.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">E quando vários funcionários dirigem?</h2>\n<p class=\"mb-4\">Informe quantidade aproximada de condutores, idades, funções, frequência e se existe rodízio. A seguradora pode solicitar identificação nominal, trabalhar com critérios por faixa ou estabelecer regras próprias. A resposta correta depende do formulário da proposta.</p>\n<p class=\"mb-4\">Também vale manter controle de habilitação, autorização interna, entrega de chaves, manutenção e comunicação de acidentes. Gestão de frota reduz incerteza operacional, mas não substitui as declarações exigidas no seguro.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Mercadorias, ferramentas e equipamentos estão cobertos?</h2>\n<p class=\"mb-4\">Não automaticamente. O casco protege o veículo conforme as garantias contratadas. Notebooks, ferramentas, amostras, mercadorias e equipamentos transportados podem exigir outra cobertura e ter limites, condições de subtração e exclusões próprias.</p>\n<p class=\"mb-4\">Adesivação, baú, refrigeração, adaptações, kit gás e acessórios também devem ser informados. A Susep destaca que coberturas adicionais integram a apólice por cláusulas específicas; o simples fato de um item estar fixado ou ser essencial ao negócio não confirma indenização.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Seguro individual ou apólice de frota?</h2>\n<p class=\"mb-4\">Ter dois ou três veículos no CNPJ não determina, por si só, qual formato será melhor. Compare aceitação, cadastro de condutores, franquias, bônus, assistência, gestão de inclusões e exclusões e preço total. Uma apólice coletiva pode facilitar movimentações, mas precisa manter limites e veículos corretamente identificados.</p>\n<p class=\"mb-4\">Na renovação, confira se veículos vendidos foram retirados, se novas aquisições entraram e se os usos mudaram. Alterações relevantes durante a vigência devem ser comunicadas para avaliação de endosso.</p>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">O que comparar além do prêmio</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>Razão social, CNPJ e proprietário registrados corretamente.</li><li>Condutor principal e demais usuários conforme o questionário.</li><li>Uso particular, comercial, misto ou remunerado.</li><li>Região de circulação, garagem e quilometragem.</li><li>Casco, modalidade de indenização e fator contratado.</li><li>Limites para danos materiais, corporais e morais a terceiros.</li><li>Franquia do casco, vidros, faróis e demais itens.</li><li>Assistência, guincho e carro reserva adequado à operação.</li><li>Adaptações, acessórios e equipamentos declarados.</li><li>Exclusões para carga, mercadorias e bens transportados.</li></ul>\n<h2 class=\"text-[#0d1f3c] font-black mt-8 mb-4 text-2xl\">Documentos que agilizam a cotação</h2>\n<ul class=\"list-disc pl-6 space-y-2 mb-4\"><li>Cartão CNPJ e atividade da empresa.</li><li>Documento do veículo e informação sobre financiamento.</li><li>Modelo, versão, ano e acessórios.</li><li>Relação de condutores e rotina de cada um.</li><li>CEP de pernoite e locais habituais de circulação.</li><li>Finalidade do uso e estimativa de quilometragem.</li><li>Apólice anterior, classe de bônus e histórico de sinistros.</li><li>Quantidade de veículos que entrarão na análise.</li></ul>\n<p class=\"mb-4\">Leia também: <a class=\"text-blue-700 underline\" href=\"/blog/seguro-auto-valor-mercado-referenciado-vs-determinado\">valor de mercado referenciado ou valor determinado</a> · <a class=\"text-blue-700 underline\" href=\"/blog/seguro-auto-para-uber-e-99-como-contratar\">seguro para uso em aplicativo</a>.</p>\n<div class=\"bg-[#0d1f3c] text-white rounded-2xl p-7 my-10\"><h2 class=\"text-2xl font-black mb-3\">Quer cotar o veículo da empresa sem esconder o uso real?</h2><p class=\"mb-5\">Envie o CNPJ, documento do veículo, rotina e perfis dos condutores. A Elevance organiza as informações e compara as opções disponíveis entre os parceiros autorizados.</p><a href=\"https://wa.me/5511920144864\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"inline-block bg-[#f4c542] text-[#0d1f3c] font-black px-6 py-3 rounded-xl\">Cotar com a Elevance no WhatsApp</a></div>\n<p class=\"text-sm text-slate-600 mb-4\">Conteúdo informativo, revisado em 26/09/2026. Aceitação, perfil, condutores, usos, limites, franquias, bônus, serviços e exclusões dependem da seguradora, da proposta e das condições contratuais.</p>\n<p class=\"text-sm text-slate-600\">Fonte: <a class=\"underline\" href=\"https://www.gov.br/susep/pt-br/assuntos/meu-futuro-seguro/seguros-previdencia-e-capitalizacao/seguros/seguro-de-automoveis\" target=\"_blank\" rel=\"noopener noreferrer\">Susep — seguro de automóveis</a>.</p>"
  },
