export const postsData = [
  {
    ...
    content: `
      ...
      <h2 class="text-[#1a3a52] font-black mt-8 mb-4 text-2xl">1. O que é o Seguro Auto Tradicional?</h2>
      ...
      <h2 class="text-[#1a3a52] font-black mt-8 mb-4 text-2xl">2. O que é a Proteção Veicular (APVS)?</h2>
      ...
      <h2 class="text-[#1a3a52] font-black mt-8 mb-4 text-2xl">Conclusão: Qual escolher?</h2>
  ...
  ,
  {
    ...
    content: `
      ...
      <h2 class="text-[#1a3a52] font-black mt-8 mb-4 text-2xl">Autônomo pode ter plano de saúde?</h2>
      ...
      <h2 class="text-[#1a3a52] font-black mt-8 mb-4 text-2xl">Individual vs MEI: qual sai mais barato?</h2>
      ...
      <h2 class="text-[#1a3a52] font-black mt-8 mb-4 text-2xl">O que considerar na hora de escolher?</h2>
      ...
      <h2 class="text-[#1a3a52] font-black mt-8 mb-4 text-2xl">Quanto custa um plano para autônomo em SP?</h2>
