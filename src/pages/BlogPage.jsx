  ...
  return (
    ...
    <div className="min-h-screen bg-slate-50 pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-4 text-center mb-16">
        ...
        <h1 className="text-4xl md:text-5xl font-black text-[#0d1f3c] italic">Blog Elevance</h1>
          ...
          <Link to={`/blog/${post.slug}`} key={post.id}
            ...
            <div className="relative">
              ...
              <div className="absolute bottom-4 left-4 flex gap-2">
                {post.readTime && (
                  <span className="flex items-center gap-1.5 bg-[#0d1f3c]/90 backdrop-blur-sm text-white px-3 py-1.5 rounded-full text-[10px] font-black uppercase tracking-wide">
            ...
            <div className="p-8">
              ...
              <h2 className="text-xl font-black text-[#0d1f3c] mt-1 group-hover:text-blue-600 transition-colors leading-snug italic">{post.title}</h2>
              {post.excerpt && (
