...
const HomePage = () => {
  ...
  return (
    <div className="bg-white overflow-x-hidden">
      ...
      {/* 1. HERO SECTION - Ajustada para camadas corretas e sem sobreposição */}
      <section className="relative pt-6 pb-20 lg:pt-16 lg:pb-32 bg-gradient-to-b from-slate-50 to-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center gap-12 mb-12">
            ...
            {/* Lado Direito: Foto, Legendas e Status (TUDO ORGANIZADO) */}
            <motion.div 
            ...
            >
              <div className="relative group">
                ...
                <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-[40px] overflow-hidden shadow-2xl border-4 border-white rotate-2 group-hover:rotate-0 transition-transform duration-500 bg-slate-200">
                  ...
                  />
                  {/* Legenda: Rodrigo Corretor (No TOPO para não bater no selo) */}
                  <div className="absolute top-0 inset-x-0 bg-gradient-to-b from-black/80 to-transparent p-5 pb-10">
                    <p className="text-white text-lg font-black tracking-tight">Rodrigo</p>
                    <p className="text-blue-300 text-[10px] font-black uppercase tracking-wider">Corretor de Seguros</p>
                  </div>
                </div>

                {/* Selo Online e Estrelas (No RODAPÉ, livre da legenda) */}
                <div className="absolute -bottom-6 -left-4 bg-white p-3 px-4 rounded-2xl shadow-xl z-20 flex flex-col gap-1 items-start border border-slate-50">
              ...
              {/* Elemento Decorativo */}
              <div className="absolute -bottom-10 -right-6 w-32 h-32 bg-blue-600 rounded-[30px] -z-10 opacity-10"></div>
            </motion.div>
          </div>
      ...
      {/* Restante do Site (Serviços, Autoridade, etc) */}
