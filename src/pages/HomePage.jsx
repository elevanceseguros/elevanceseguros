...
const HomePage = () => {
  ...
  return (
    <>
      ...
      {/* 1. HERO */}
      <section className="relative pt-24 pb-16 sm:pt-28 md:pt-36 overflow-hidden bg-[#0d1f3c]">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
            ...
            <div className="w-full lg:w-3/5 space-y-7 text-center lg:text-left">
              ...
              <div className="flex flex-row items-center lg:items-center gap-5">
                <div className="relative shrink-0">
                  ...
                  <div className="absolute -bottom-1 -right-1 bg-green-400 w-6 h-6 rounded-full border-4 border-[#0d1f3c] animate-pulse shadow-lg"></div>
                </div>
            ...
            <div className="w-full lg:w-2/5">
              <div className="bg-white rounded-[40px] shadow-[0_30px_80px_rgba(0,0,0,0.25)] p-8 md:p-10 relative min-h-[340px] flex flex-col justify-center">
                {!sent ? (
                  <>
                    <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-[#0d1f3c] text-white px-6 py-2 rounded-full text-[10px] font-black uppercase tracking-widest flex items-center gap-2 whitespace-nowrap z-10 shadow-lg">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            {[
              ...
              <div key={i} className={`${item.bg} rounded-[40px] p-8 border border-slate-100 group hover:bg-[#0d1f3c] transition-all duration-500 flex flex-col`}>
                <div className={`${item.cor} mb-5 group-hover:text-blue-400 transition-colors`}>{item.icon}</div>
                <h3 className="text-xl font-black text-[#0d1f3c] group-hover:text-white italic mb-2 transition-colors">{item.title}</h3>
                ...
                <div className="flex items-center justify-between">
                  <Link to={item.path} className="bg-white text-[#0d1f3c] font-black py-3 px-5 rounded-2xl text-[10px] uppercase tracking-widest group-hover:bg-blue-600 group-hover:text-white transition-all shadow-sm">{item.btn}</Link>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-end justify-between mb-10">
            <div>
              <span className="inline-block bg-[#0d1f3c]/10 text-[#0d1f3c] px-4 py-1 rounded-full text-[10px] font-black uppercase tracking-widest mb-3">Blog</span>
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 italic leading-tight">Conteúdo que <span className="text-[#0d1f3c]">educa e protege</span></h2>
            </div>
            <a href="/blog" className="hidden md:flex items-center gap-2 text-[#0d1f3c] font-black text-sm hover:underline shrink-0">
              ...
              <a key={post.id} href={`/blog/${post.slug}`}
                ...
                <div className="relative overflow-hidden h-44">
                  <img
                   ...
                   loading="lazy" />
                  <span className="absolute top-3 left-3 bg-[#0d1f3c] text-white text-[9px] font-black uppercase tracking-widest px-3 py-1 rounded-full">
                    {post.category}
                  </span>
                </div>
                <div className="p-5 space-y-2">
                  ...
                  <h3 className="font-black text-slate-900 text-sm leading-snug group-hover:text-[#0d1f3c] transition-colors line-clamp-2">
                    {post.title}
                  </h3>
                  <p className="text-slate-500 text-xs leading-relaxed line-clamp-2">{post.excerpt}</p>
                  <span className="inline-block text-[#0d1f3c] font-black text-xs mt-1 group-hover:underline">Ler artigo →</span>
                </div>
              </a>
            ))}
          </div>
          ...
          <div className="text-center mt-8 md:hidden">
            <a href="/blog" className="inline-flex items-center gap-2 text-[#0d1f3c] font-black text-sm hover:underline">
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="bg-[#0d1f3c] rounded-[50px] py-16 px-8 md:px-16 text-white flex flex-col lg:flex-row items-center gap-12 relative overflow-hidden">
