{/* 1. HERO SECTION - Ajustada para não cobrir o menu e com legendas */}
  ...
  <div className="max-w-7xl mx-auto px-4">
    <div className="flex flex-col lg:flex-row items-center gap-12 mb-12">
      ...
      <motion.div 
        ...
        className="relative order-1 lg:order-2 z-10" // z-10 garante que fique abaixo do header z-100
      >
        <div className="relative group">
          {/* Container da Foto */}
          <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-[40px] overflow-hidden shadow-2xl border-4 border-white rotate-2 group-hover:rotate-0 transition-transform duration-500">
            <img 
              src="/preview.webp" 
              alt="Rodrigo - Corretor de Seguros" 
              className="w-full h-full object-cover"
            />
            {/* Overlay de Legenda na própria foto */}
          ...
          {/* Selo Online e Estrelas (Fora da foto) */}
