...
import { ShieldCheck, Zap, Building2, CheckCircle2, MessageCircle, PartyPopper, ArrowRight, Star, Scale } from 'lucide-react';
...
export default function ResponsabilidadeCivilPage() {
  ...
  const handleSubmit = (e) => {
    ...
    const mensagem = encodeURIComponent(`Olá Rodrigo! Me chamo ${nome}. Vi o site da Elevance Seguros e gostaria de cotar um Seguro de Responsabilidade Civil. Meu WhatsApp é: ${whatsapp}`);
  ...
  return (
    <>
      <Helmet>
        ...
        <script type="application/ld+json">{"@context":"https://schema.org","@type":"Service","serviceType":"Seguro Responsabilidade Civil","provider":{"@type":"InsuranceAgency","name":"Elevance Seguros","telephone":"(11) 92014-4864","url":"https://elevanceseguros.com"},"areaServed":{"@type":"Country","name":"Brasil"},"name":"Seguro Responsabilidade Civil"}</script>
      </Helmet>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl font-black text-[#1a3a52] italic text-center mb-12">Modalidades disponíveis</h2>
