...
export default function SeguroResidencialPage() {
  ...
  const handleSubmit = (e) => {
    ...
    const mensagem = encodeURIComponent(`Olá Rodrigo! Me chamo ${nome}. Vi o site da Elevance Seguros e gostaria de cotar um Seguro Residencial. Meu WhatsApp é: ${whatsapp}`);
