...
export default function ProtecaoVeicularPage() {
  ...
  const handleSubmit = (e) => {
    ...
    const msg = encodeURIComponent("Olá Rodrigo! Me chamo " + nome + ". Vim pelo site e gostaria de cotar Proteção Veicular APVS. Meu WhatsApp é: " + whatsapp);
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Proteção veicular APVS em São Paulo. Sem análise de perfil, rastreador grátis. Cotação gratuita via WhatsApp." />
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="w-full lg:w-3/5 space-y-6 text-center lg:text-left">
              ...
              <h1 className="text-3xl md:text-5xl font-black text-[#114d8e] leading-tight italic">
                Proteção Veicular <span className="text-blue-600">sem burocracia.</span>
              </h1>
              <p className="text-slate-600 text-base md:text-lg max-w-xl mx-auto lg:mx-0 font-medium italic">
                Comparamos as <span className="text-blue-600 font-black uppercase">maior rede de proteção veicular</span> e encontramos a melhor cobertura pelo menor preço para você.
              </p>
